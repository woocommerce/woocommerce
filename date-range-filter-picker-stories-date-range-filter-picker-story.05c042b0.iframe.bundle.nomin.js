...
const getDayAriaLabelFormat = () => (0,build_module.__)(/* translators: Moment.js format for the date a screen reader reads out on a calendar day. Keep the moment tokens (dddd, MMMM, D, YYYY) and reorder them to suit the locale. */
'dddd, MMMM D, YYYY', 'woocommerce');
