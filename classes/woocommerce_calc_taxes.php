...
class woocommerce_product {
	...
	function is_taxable() {
		if ($this->get_tax_status()=='taxable' && get_option('woocommerce_calc_taxes')=='yes') return true;
		return false;
	}
	
	/** Returns whether or not the product shipping is taxable */
	function is_shipping_taxable() {
		if ($this->get_tax_status()=='taxable' || $this->get_tax_status()=='shipping') return true;
		return false;
	}
