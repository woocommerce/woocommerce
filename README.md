...
![WooCommerce](woocommerce.com/wp-content/themes/woo/images/logo-woocommerce@2x.png)
...
-   If you have a problem, you may want to start with the [self help guide](woocommerce.com/document/woocommerce-self-service-guide/).
-   The [WooCommerce.com premium support portal](woocommerce.com/contact-us/) for customers who have purchased themes or extensions.
...
-   For customizations, you may want to check our list of [WooExperts](woocommerce.com/experts/) or [Codeable](https://codeable.io/).

NOTE: Unfortunately, we are unable to honor support requests in issues on this repository; as a result, any requests submitted in this manner will be closed.

## Community

For peer to peer support, real-time announcements, and office hours, please [join our slack community](woocommerce.com/community-slack/)!

## Contributing to WooCommerce

As an open source project, we rely on community contributions to continue to improve WooCommerce. To contribute, please follow the pre-requisites above and visit our [Contributing to Woo](https://developer.woocommerce.com/docs/category/contributing/) doc for more links and contribution guidelines.
