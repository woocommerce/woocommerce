...
-   [PHP 7.3+](https://www.php.net/manual/en/install.php): WooCommerce Core currently features a minimum PHP version of 7.3. It is also needed to run Composer and various project build scripts.
