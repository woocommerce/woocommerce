		...
		<>
			...
			{ shortDescriptionGenerated && (
				<InfoModal
					...
					message="The short description was automatically generated by AI using the long description. This normally appears at the top of your product pages."
					title="Short Description Generated"
				/>
			) }
		</>
	);
