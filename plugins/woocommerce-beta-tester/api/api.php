<?php
/**
 * REST API routes for the WooCommerce Admin Test Helper.
 *
 * @package WC_Beta_Tester
 */

/**
 * Register a REST route handler.
 *
 *  @param string   $route The base URL for route you are adding.
 *  @param function $callback The handler for the route.
 *  @param array    $additional_options An array of options for the endpoint.
 */
