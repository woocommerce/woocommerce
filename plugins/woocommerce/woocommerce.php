...
add_action(
	...
	function() {
		woocommerce_blocks_register_checkout_field(
			array(
				'id'       => 'plugin-namespace/some-new-billing-field',
				'label'    => __( 'Custom address field', 'woocommerce' ),
				'location' => 'address',
				'type'     => 'text',
			),
		);
		...
		woocommerce_blocks_register_checkout_field(
			array(
				'id'       => 'plugin-namespace/some-new-contact-field',
				'label'    => __( 'Custom new contact field', 'woocommerce' ),
				'location' => 'contact',
				'type'     => 'text',
			),
		);
