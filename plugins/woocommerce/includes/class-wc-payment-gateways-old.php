...
class WC_Payment_Gateways_Old {
	 ...
	 *
	 * @var WC_Payment_Gateways_Old
	 * @since 2.1.0
	 */
	protected static $_instance = null;

	/**
	 * Main WC_Payment_Gateways_Old Instance.
	 *
	 * Ensures only one instance of WC_Payment_Gateways_Old is loaded or can be loaded.
	 *
	 * @since 2.1
	 * @return WC_Payment_Gateways_Old Main instance
	 */
