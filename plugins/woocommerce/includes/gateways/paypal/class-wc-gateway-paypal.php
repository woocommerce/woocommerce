	...
	public function process_payment( $order_id ) {
		...
		if ( $this->should_use_orders_v2() ) {
			...
			if ( isset( $paypal_order['localized_error_message'] ) ) {
				throw new Exception( $paypal_order['localized_error_message'] ); // phpcs:ignore WordPress.Security.EscapeOutput.ExceptionNotEscaped -- 'localized_error_message' is already escaped.
			}
