 ...
 * one request. Rather than rescheduling on every write, product IDs are handed to
 * {@see SaleEventSchedulingDeferrer}, which reschedules each of them once.
 *
 * @since 10.8.0
...
function wc_maybe_schedule_sale_events_on_meta_change( $meta_id, $object_id, $meta_key ): void { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
	...
	wc_get_container()->get( SaleEventSchedulingDeferrer::class )->queue_product( (int) $object_id );
}
