...
final class WooCommerce {
	...
	public function add_woocommerce_tracker_send_event_wrapper() {
		...
		/**
		 * Fires when WooCommerce requests a usage-tracking snapshot.
		 *
		 * @since 2.3.0
		 * @since 11.2.0 Added the response-aware delivery argument.
		 *
		 * @param string $override     Empty string preserving the legacy no-argument hook behavior.
		 * @param bool $response_aware Whether to enqueue a response-aware delivery cycle.
		 */
		do_action( 'woocommerce_tracker_send_event', '', true );
	}
