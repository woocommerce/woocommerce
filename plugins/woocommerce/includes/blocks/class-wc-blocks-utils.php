...
class WC_Blocks_Utils {
	 ...
	 *
	 * @deprecated 10.4.0 Use WordPress core has_block() instead for better performance.
	...
	public static function has_block_in_page( $page, $block_name ) {
		wc_deprecated_function( __METHOD__, '10.4.0', 'WordPress core has_block() function' );
		...
		return has_block( $block_name, $page_to_check );
	}
}
