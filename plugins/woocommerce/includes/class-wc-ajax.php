	...
	public static function update_api_key() {
		...
		try {
			...
			if ( 0 < $key_id ) {
				...
				$response['revoke_url']      = '<a style="color: #cc1818; text-decoration: none;" href="' . esc_url( wp_nonce_url( add_query_arg( array( 'revoke-key' => $key_id ), admin_url( 'admin.php?page=wc-settings&tab=advanced&section=keys' ) ), 'revoke' ) ) . '">' . __( 'Revoke key', 'woocommerce' ) . '</a>';
			}
		} catch ( Exception $e ) {
