...
class WC_Admin_Webhooks_Table_List extends WP_List_Table {
	...
	public function process_bulk_action() {
		...
		$webhooks = isset( $_REQUEST['webhook'] ) ? array_map( 'absint', (array) $_REQUEST['webhook'] ) : array(); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
	...
	public function prepare_items() {
		...
		if ( ! empty( $_REQUEST['status'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			$args['status'] = sanitize_key( wp_unslash( $_REQUEST['status'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
		}
		...
		if ( ! empty( $_REQUEST['s'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			$args['search'] = sanitize_text_field( wp_unslash( $_REQUEST['s'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
		}
