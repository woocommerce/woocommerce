	...
	private function query_report_data() {
		...
		$this->report_data->refunded_order_items = absint(
			$this->get_order_report_data(
				array(
					...
					'filter_range' => true,
					'order_types'  => wc_get_order_types( 'order-count' ),
					'order_status' => array( WC_Order::STATUS_REFUNDED ),
				)
			)
		);
		...
		$this->report_data->partial_refunds = (array) $this->get_order_report_data(
			array(
				...
				'filter_range'        => true,
				'order_status'        => false,
				'parent_order_status' => array( WC_Order::STATUS_COMPLETED, WC_Order::STATUS_PROCESSING, WC_Order::STATUS_ON_HOLD ),
			)
		);
		...
		$this->report_data->refund_lines = (array) $this->get_order_report_data(
			array(
				...
				'filter_range'        => true,
				'order_status'        => false,
				'parent_order_status' => array( WC_Order::STATUS_COMPLETED, WC_Order::STATUS_PROCESSING, WC_Order::STATUS_ON_HOLD, WC_Order::STATUS_REFUNDED ),
			)
		);
