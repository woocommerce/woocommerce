...
class WC_Admin_Post_Types {
	...
	public function post_updated_messages( $messages ) {
		...
		$messages['product'] = array(
			...
			1  => sprintf( __( 'Product updated. <a id="view-product-link" href="%s">View Product</a>', 'woocommerce' ), esc_url( get_permalink( $post->ID ) ) ),
			...
			6  => sprintf( __( 'Product published. <a id="view-product-link" href="%s">View Product</a>', 'woocommerce' ), esc_url( get_permalink( $post->ID ) ) ),
