...
<?php echo wc_back_header( esc_html( $zone->get_zone_name() ? $zone->get_zone_name() : __( 'Add zone', 'woocommerce' ) ), esc_html( __( 'Return to shipping', 'woocommerce' ) ), esc_url( admin_url( 'admin.php?page=wc-settings&tab=shipping' ) ) ); ?>
