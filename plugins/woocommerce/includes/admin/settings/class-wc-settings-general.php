	...
	protected function get_settings_for_default_section() {
		...
		try {
			...
			if ( ! $address_autocomplete_available ) {
				...
				$address_autocomplete_setting_desc_tip .= ' ' . sprintf( __( 'Requires a plugin with predictive address search support (e.g. <a href="%s">WooPayments</a>).', 'woocommerce' ), 'https://woocommerce.com/products/woocommerce-payments/' );
			}
