	...
	public static function save( $post_id, $post ) {
		...
		$errors = $product->set_props(
			array(
				...
				'customs_commodity_code'    => isset( $_POST['_customs_commodity_code'] ) ? wp_unslash( $_POST['_customs_commodity_code'] ) : null, // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Validated by the customs setters.
				'customs_country_of_origin' => isset( $_POST['_customs_country_of_origin'] ) ? wp_unslash( $_POST['_customs_country_of_origin'] ) : null, // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Validated by the customs setters.
				'customs_description'       => isset( $_POST['_customs_description'] ) ? wp_unslash( $_POST['_customs_description'] ) : null, // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Validated by the customs setters.
			...
			for ( $i = 0; $i <= $max_loop; $i++ ) {
				...
				$errors = $variation->set_props(
					array(
						...
						'customs_commodity_code'    => isset( $_POST['variable_customs_commodity_code'][ $i ] ) ? wp_unslash( $_POST['variable_customs_commodity_code'][ $i ] ) : null, // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Validated by the customs setters.
						'customs_country_of_origin' => isset( $_POST['variable_customs_country_of_origin'][ $i ] ) ? wp_unslash( $_POST['variable_customs_country_of_origin'][ $i ] ) : null, // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Validated by the customs setters.
						'customs_description'       => isset( $_POST['variable_customs_description'][ $i ] ) ? wp_unslash( $_POST['variable_customs_description'][ $i ] ) : null, // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Validated by the customs setters.
