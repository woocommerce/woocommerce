...
class WC_Admin_API_Keys {
	...
	public function allow_save_settings( $allow ) {
		if ( ! isset( $_GET['create-key'], $_GET['edit-key'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			return false;
		}
	...
	private function is_api_keys_settings_page() {
		return isset( $_GET['page'], $_GET['tab'], $_GET['section'] ) && 'wc-settings' === $_GET['page'] && 'advanced' === $_GET['tab'] && 'keys' === $_GET['section']; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
	}
	...
	public static function page_output() {
		...
		if ( isset( $_GET['create-key'] ) || isset( $_GET['edit-key'] ) ) {
			$key_id   = isset( $_GET['edit-key'] ) ? absint( $_GET['edit-key'] ) : 0; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
	...
	public function screen_option() {
		...
		if ( ! isset( $_GET['create-key'] ) && ! isset( $_GET['edit-key'] ) && $this->is_api_keys_settings_page() ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
	...
	public function actions() {
		if ( $this->is_api_keys_settings_page() ) {
			// Revoke key.
			if ( isset( $_REQUEST['revoke-key'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
				$this->revoke_key();
			}

			// Bulk actions.
			if ( isset( $_REQUEST['action'] ) && isset( $_REQUEST['key'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
				$this->bulk_actions();
			}
		}
	}
	...
	public static function notices() {
		if ( isset( $_GET['revoked'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			$revoked = absint( $_GET['revoked'] ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
	...
	private function revoke_key() {
		...
		if ( isset( $_REQUEST['revoke-key'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			$key_id  = absint( $_REQUEST['revoke-key'] ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
	...
	private function bulk_actions() {
		...
		if ( isset( $_REQUEST['action'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			$action = sanitize_text_field( wp_unslash( $_REQUEST['action'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			$keys   = isset( $_REQUEST['key'] ) ? array_map( 'absint', (array) $_REQUEST['key'] ) : array(); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
