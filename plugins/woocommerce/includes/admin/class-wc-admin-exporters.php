...
class WC_Admin_Exporters {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_woocommerce_do_ajax_product_json_export', array( $this, 'do_ajax_product_json_export' ) );
	...
	public function admin_scripts() {
		...
		$version = Constants::get_constant( 'WC_VERSION' ) . '-json-export-' . time();
	...
	public function download_export_file() {
		...
		if ( isset( $_GET['action'], $_GET['nonce'] ) && wp_verify_nonce( wp_unslash( $_GET['nonce'] ), 'product-json' ) && 'download_product_json' === wp_unslash( $_GET['action'] ) ) { // WPCS: input var ok, sanitization ok.
			include_once WC_ABSPATH . 'includes/export/class-wc-product-json-exporter.php';
	...
	/**
	 * AJAX callback for doing the actual export to the JSON file.
	 */
	public function do_ajax_product_json_export() {
