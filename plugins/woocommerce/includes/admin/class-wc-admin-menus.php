...
class WC_Admin_Menus {
	...
	public function settings_page_init() {
		...
		if ( ! empty( $_GET['wc_error'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			WC_Admin_Settings::add_error( wp_kses_post( wp_unslash( $_GET['wc_error'] ) ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
		}

		if ( ! empty( $_GET['wc_message'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
			WC_Admin_Settings::add_message( wp_kses_post( wp_unslash( $_GET['wc_message'] ) ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
		}
	...
	public function save_settings() {
		...
		$current_tab     = empty( $_GET['tab'] ) ? 'general' : sanitize_title( wp_unslash( $_GET['tab'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended
		$current_section = empty( $_REQUEST['section'] ) ? '' : sanitize_title( wp_unslash( $_REQUEST['section'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Recommended

		// Save settings if data has been posted.
		if ( '' !== $current_section && apply_filters( "woocommerce_save_settings_{$current_tab}_{$current_section}", ! empty( $_POST['save'] ) ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Missing
			WC_Admin_Settings::save();
		} elseif ( '' === $current_section && apply_filters( "woocommerce_save_settings_{$current_tab}", ! empty( $_POST['save'] ) ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitizeday, WordPress.Security.NonceVerification.Missing
			WC_Admin_Settings::save();
		}
	}
