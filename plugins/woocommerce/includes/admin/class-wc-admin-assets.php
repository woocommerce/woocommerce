...
if ( ! class_exists( 'WC_Admin_Assets', false ) ) :
	...
	class WC_Admin_Assets {
		...
		public function admin_scripts() {
			...
			// store customize page.
			if (
				isset( $_GET['page'] ) &&
				'wc-admin' === $_GET['page'] &&
				isset( $_GET['path'] ) &&
				'/store-customize' === $_GET['path']
			) {
				// Ref: https://github.com/WordPress/WordPress/blob/master/wp-admin/site-editor.php

				if ( ! wp_is_block_theme() ) {
					wp_die( __( 'The theme you are currently using is not compatible.' ) );
				}
