		...
		public function admin_scripts() {
			...
			if ( in_array( str_replace( 'edit-', '', $screen_id ), array( 'shop_coupon', 'product' ), true ) || $this->is_order_meta_box_screen( $screen_id ) ) {
				...
				$params = array(
					...
					'i18n_product_gpt_title'             => __( 'Write a description', 'woocommerce' ),
					'i18n_product_gpt_input_title'       => __( 'ABOUT YOUR PRODUCT', 'woocommerce' ),
					'i18n_product_gpt_input_placeholder' => __( 'e.g. organic and sustainable skin cleanser for women', 'woocommerce' ),
					'i18n_product_gpt_buttons_title'     => __( 'TONE OF VOICE', 'woocommerce' ),
					'i18n_product_gpt_button_casual'     => __( 'Casual', 'woocommerce' ),
					'i18n_product_gpt_button_formal'     => __( 'Formal', 'woocommerce' ),
					'i18n_product_gpt_button_flowery'     => __( 'Flowery', 'woocommerce' ),
					'i18n_product_gpt_button_convincing' => __( 'Convincing', 'woocommerce' ),
					'i18n_product_gpt_button_accept'     => __( 'Accept', 'woocommerce' ),
					'i18n_product_gpt_desc_casual'       => __( 'Relaxed, informal, conversational tone. Like chatting with a friend.', 'woocommerce' ),
					'i18n_product_gpt_desc_formal'       => __( 'A polished, well-structured product description, adhering to professional standards.', 'woocommerce' ),
					'i18n_product_gpt_desc_flowery'       => __( 'Ornate, elaborate, poetic tone. Rich in descriptive language.', 'woocommerce' ),
					'i18n_product_gpt_desc_convincing'   => __( 'A persuasive, compelling product description, designed to influence decisions and drive action.', 'woocommerce' ),
					'i18n_product_open_gpt_button'       => __( 'Write it for me', 'woocommerce' ),
