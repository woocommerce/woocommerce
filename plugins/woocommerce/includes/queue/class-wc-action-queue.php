...
class WC_Action_Queue implements QueueFifoInterface, QueueWithPrioritiesInterface {
	...
	public function add( $hook, $args = array(), $group = '' ) {
		return $this->add_with_priority( (string) $hook, (array) $args, (string) $group );
	}
	 ...
	 * @return string The action ID
	 */
	public function add_with_priority( string $hook, array $args = array(), string $group = '', int $priority = ActionQueuePriority::NORMAL ) {
	...
	public function schedule_single( $timestamp, $hook, $args = array(), $group = '' ) {
		return $this->schedule_single_with_priority( (int) $timestamp, (string) $hook, (array) $args, (string) $group );
	}
	 ...
	 * @return string The action ID
	 */
	public function schedule_single_with_priority( int $timestamp, string $hook, array $args = array(), string $group = '', int $priority = ActionQueuePriority::NORMAL ) {
	...
	public function schedule_recurring( $timestamp, $interval_in_seconds, $hook, $args = array(), $group = '' ) {
		return $this->schedule_recurring_with_priority( (int) $timestamp, (int) $interval_in_seconds, (string) $hook, (array) $args, (string) $group );
	}
	 ...
	 * @return string The action ID
	 */
	public function schedule_recurring_with_priority( int $timestamp, int $interval_in_seconds, string $hook, array $args = array(), string $group = '', int $priority = ActionQueuePriority::NORMAL ) {
	...
	public function schedule_cron( $timestamp, $cron_schedule, $hook, $args = array(), $group = '' ) {
		return $this->schedule_cron_with_priority( (int) $timestamp, (string) $cron_schedule, (string) $hook, (array) $args, (string) $group );
	}
