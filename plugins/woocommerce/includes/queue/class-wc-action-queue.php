...
class WC_Action_Queue implements QueueFifoInterface, QueueWithPrioritiesInterface {
	...
	public function schedule_recurring( $timestamp, $interval_in_seconds, $hook, $args = array(), $group = '' ) {
		return $this->schedule_recurring_with_priority( (int) $timestamp, (int) $interval_in_seconds, (string) $hook, $args, (string) $group );
	}
	...
	public function schedule_cron( $timestamp, $cron_schedule, $hook, $args = array(), $group = '' ) {
		return $this->schedule_cron_with_priority( (int) $timestamp, (string) $cron_schedule, (string) $hook, $args, (string) $group );
	}
	 ...
	 * @return string The action ID
	 */
	public function schedule_cron_with_priority( int $timestamp, string $cron_schedule, string $hook, $args = array(), string $group = '', int $priority = ActionQueuePriority::NORMAL ) {
