...
class WC_Product_Trait_Variable extends WC_Product_Trait {
	...
	public function __construct( $product ) {
		...
		$mixin = $this->get_trait_methods();
		$product::add_trait( $mixin );
		// $product::add_method('getName', function() {
		// 	return $this->get_name();
		// } );

	}

	public function get_trait_methods() {
		return new class() {
			/**
			 * Array of children variation IDs. Determined by children.
			 *
			 ...
			 * @return string
			 */
			public function get_variation_default_attribute() {
				return function( $attribute_name ) {
			 ...
			 */
			public function get_variation_prices() {
				return function( $for_display = false ) {
			 ...
			 * @return string
			 */
			public function get_variation_regular_price() {
				return function( $min_or_max = 'min', $for_display = false ) {
			 ...
			 * @return string
			 */
			public function get_variation_sale_price() {
				return function( $min_or_max = 'min', $for_display = false ) {
					$prices = $this->get_variation_prices( $for_display );
			 ...
			 */
			private function variation_is_available() {
				return function( WC_Product_Variation $variation ) {
					// Hide out of stock variations if 'Hide out of stock items from the catalog' is checked.
					if ( ! $variation || ! $variation->exists() || ( 'yes' === get_option( 'woocommerce_hide_out_of_stock_items' ) && ! $variation->is_in_stock() ) ) {
						return false;
					}
			...
			*/
			...
			public function set_variation_attributes() {
				return function( $variation_attributes ) {
			 ...
			 */
			public function set_visible_children() {
				return function( $visible_children ) {
			 ...
			 * @return array
			 */
			protected function sort_variation_prices() {
