...
abstract class WC_Payment_Gateway extends WC_Settings_API {
	...
	public function get_tokens() {
		...
		if ( is_user_logged_in() && $this->supports( PaymentGatewaySupportedFeatures::TOKENIZATION ) ) {
	...
	public function payment_fields() {
		...
		if ( $this->supports( PaymentGatewaySupportedFeatures::DEFAULT_CREDIT_CARD_FORM ) ) {
	...
	public function can_refund_order( $order ) {
		return $order && $this->supports( PaymentGatewaySupportedFeatures::REFUNDS );
	}
