...
/**
 * Add custom index to the usermeta table for better SQL performance searching users by metas.
 *
 * @return void
 */
function wc_update_1030_add_key_value_index_to_usermeta_table() {
	global $wpdb;
