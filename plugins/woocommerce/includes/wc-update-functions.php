 ...
 *
 * The counts used to include rows mirroring another row's stock, such as a variable parent
 * standing in for its variations. Dropping the transients makes the report recalculate them.
 *
 * @since 11.2.0
 *
 * @return void
