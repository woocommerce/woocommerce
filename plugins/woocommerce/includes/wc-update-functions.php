 ...
 */
function wc_update_1111_cleanup_inherited_variation_images() {
	global $wpdb;

	$state_option     = 'woocommerce_update_1111_cleanup_state';
	$completed_option = 'woocommerce_update_1111_completed_at';
	$batch_size       = 250;
	...
	if ( '' !== $wpdb->last_error ) {
		wc_get_logger()->error(
			...
			array( 'source' => 'wc_update_1111_cleanup_inherited_variation_images' )
		);
