 ...
 * This updater copies legacy values into `_product_image_gallery` once and marks each
 ...
 * deleted by this updater. Third-party code (custom themes, exporters, integrations) may
...
function wc_update_1090_migrate_legacy_variation_gallery_meta(): bool {
	...
	$variation_ids = $select_variation_ids( $batch_size );
