							...
							array(
								...
								array(
									...
									array(
										...
										'description' => sprintf(
											__( 'Drag images, upload new ones or select files from your library. For best results, use JPEG files that are 1000 by 1000 pixels or larger. %sHow to prepare images?%s.', 'woocommerce' ),
