...
abstract class WC_CSV_Batch_Exporter extends WC_CSV_Exporter {
	...
	public function get_file() {
		...
		if ( @file_exists( $this->get_file_path() ) ) { // phpcs:ignore Generic.PHP.NoSilencedErrors.Discouraged
			...
			@chmod( $this->get_file_path(), 0o664 ); // phpcs:ignore WordPress.VIP.FileSystemWritesDisallow.chmod_chmod, WordPress.WP.AlternativeFunctions.file_system_read_file_put_contents, Generic.PHP.NoSilencedErrors.Discouraged
		}
		return $file;
	}
