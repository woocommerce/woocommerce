...
class WC_Order extends WC_Abstract_Order {
	...
	*/
	...
	/**
	 * Removes a coupon from the order and recalculates totals.
	 *
	 * Coupons affect line item totals, but there is no relationship between coupon and line total,
	 * so to remove a coupon we need to work from the line subtotal (price before discount) and re-apply all
	...
	public function remove_coupon( $coupon_code ) {
		...
		foreach ( $coupon_items as $item_id => $coupon_item ) {
			...
			$coupon->decrease_usage_count( $this->get_customer_id() );
