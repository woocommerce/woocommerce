...
class WC_Order extends WC_Abstract_Order {
	...
	*/
	 ...
	 * @return bool
	 */
	public function email_is_valid( $supplied_email = null, $context = 'view' ) {
		 ...
		 */
		$verification_grace_period = (int) apply_filters( 'woocommerce_order_email_verification_grace_period', 10 * MINUTE_IN_SECONDS, $this, $context );
		 ...
		 */
		return ! (bool) apply_filters( 'woocommerce_order_email_verification_required', $email_verification_required, $this, $context );
	}
