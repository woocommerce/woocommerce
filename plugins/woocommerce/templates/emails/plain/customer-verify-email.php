...
echo sprintf(
	...
	esc_html__( 'Confirm that %s is your email address and we will link any past orders placed with it to your account. Visit the link below to confirm:', 'woocommerce' ),
	esc_html( $user_email )
) . "\n\n";
