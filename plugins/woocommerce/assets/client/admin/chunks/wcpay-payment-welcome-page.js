(window["__wcAdmin_webpackJsonp"] = window["__wcAdmin_webpackJsonp"] || []).push([[55],{
...
/* harmony default export */ var strings = ({
  button: Object(external_wp_i18n_["__"])('Install', 'woocommerce-admin'),
  nothanks: Object(external_wp_i18n_["__"])('No thanks', 'woocommerce-admin'),
  ...
  surveyIntro: Object(external_wp_element_["createInterpolateElement"])( // Note: \xa0 is used to create a non-breaking space.
  Object(external_wp_i18n_["__"])('Please take a moment to tell us why you’d like to remove WooCommerce Payments. This will remove WooCommerce\xa0Payments from the navigation. You can enable it again in <strong>WooCommerce\xa0Settings\xa0>\xa0Payments</strong>, however the promotion will not apply.', 'woocommerce-admin'), {
    strong: Object(external_wp_element_["createElement"])("strong", null)
  }),
  surveyQuestion: Object(external_wp_i18n_["__"])('What made you disable the new payments experience?', 'woocommerce-admin'),
  surveyHappyLabel: Object(external_wp_i18n_["__"])('I’m already happy with my payments setup', 'woocommerce-admin'),
  surveyInstallLabel: Object(external_wp_i18n_["__"])('I don’t want to install another plugin', 'woocommerce-admin'),
  surveyMoreInfoLabel: Object(external_wp_i18n_["__"])('I need more information about WooCommerce Payments', 'woocommerce-admin'),
  surveyAnotherTimeLabel: Object(external_wp_i18n_["__"])('I’m open to installing it another time', 'woocommerce-admin'),
  surveySomethingElseLabel: Object(external_wp_i18n_["__"])('It’s something else (Please share below)', 'woocommerce-admin'),
  surveyCommentsLabel: Object(external_wp_i18n_["__"])('Comments (Optional)', 'woocommerce-admin'),
  surveyCancelButton: Object(external_wp_i18n_["__"])('Just remove WooCommerce Payments', 'woocommerce-admin'),
  surveySubmitButton: Object(external_wp_i18n_["__"])('Remove and send feedback', 'woocommerce-admin'),
  terms: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('By clicking "Install", you agree to the <a>Terms of Service</a>', 'woocommerce-admin'), {
  ...
  faq: {
    faqHeader: Object(external_wp_i18n_["__"])('Frequently asked questions', 'woocommerce-admin'),
    question1: Object(external_wp_i18n_["__"])('What is WooCommerce Payments?', 'woocommerce-admin'),
    question1Answer1: Object(external_wp_i18n_["__"])('WooCommerce Payments is an integrated payment solution, built by WooCommerce, for WooCommerce. Use WooCommerce Payments to manage your payments, track cash flow, and manage revenue from your dashboard.', 'woocommerce-admin'),
    question1Answer2: Object(external_wp_i18n_["__"])('You can securely accept credit and debit card payments, Apple Pay, bank transfers, recurring revenue, accelerated checkout, and more - in over 100+ currencies with WooCommerce Payments.', 'woocommerce-admin'),
    question2: Object(external_wp_i18n_["__"])('Can I use WooCommerce Payments alongside other payment gateways?', 'woocommerce-admin'),
    question2Answer1: Object(external_wp_i18n_["__"])('Yes. WooCommerce Payments works alongside other payment service providers, including Stripe, PayPal, and all others. We’ve built it with this flexibility in mind so that you can ensure your store is working to meet your business needs.', 'woocommerce-admin'),
    question3: Object(external_wp_i18n_["__"])('Why should I choose WCPay over other payment gateways?', 'woocommerce-admin'),
    question3Answer1: Object(external_wp_i18n_["__"])("Native dashboard: track cash flow from the same WordPress dashboard you're already using to manage product catalogue, inventory, orders, fulfilment, and otherwise run your online storefront.", 'woocommerce-admin'),
    question3Answer2: Object(external_wp_i18n_["__"])('In-person payments: the only payment method that helps you sell online and offline with the official WooCommerce mobile app instead of a paid POS solution.', 'woocommerce-admin'),
    question3Answer3: Object(external_wp_i18n_["__"])('Subscription functionality: offer customers a recurring option for your inventory without purchasing an additional extension.', 'woocommerce-admin'),
    question3Answer4: Object(external_wp_i18n_["__"])('Native multi-currency: increase sales by making it easier for customers outside your country to purchase from your store, without an extension.', 'woocommerce-admin'),
    question4: Object(external_wp_i18n_["__"])('How will I save money using WooCommerce Payments?', 'woocommerce-admin'),
    // eslint-disable-next-line @wordpress/i18n-translator-comments
    question4Answer1: Object(external_wp_i18n_["__"])('Stores accepted into the promotional program will receive a 100% discount on transaction fees (excluding currency conversion fees) for the first $25,000 in payments, or 3 months, whichever comes first. Simply install the extension and if eligible you’ll be entered into the promotional offer.', 'woocommerce-admin'),
    question4Answer2: Object(external_wp_i18n_["__"])('To be eligible for this promotional offer, your store must: (1) meet the WooCommerce Payments usage requirements; (2) be a U.S.-based business; (3) not have processed payments through WooCommerce Payments before; and (4) be accepted into the promotional program.', 'woocommerce-admin'),
    question5: Object(external_wp_i18n_["__"])('What are the fees for WooCommerce Payments?', 'woocommerce-admin'),
    question5Answer1: Object(external_wp_i18n_["__"])('WooCommerce Payments uses a pay-as-you-go pricing model. You pay only for activity on the account. No setup fee or monthly fee. Fees differ based on the country of your account and country of your customer’s card.', 'woocommerce-admin'),
    question5Answer2: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('<a>View all fees</a>', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
    ...
    question5Answer7: Object(external_wp_element_["createInterpolateElement"])( // eslint-disable-next-line @wordpress/i18n-translator-comments
    Object(external_wp_i18n_["__"])('1.5% fee on the payout amount for <a>instant deposits</a>', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
    ...
    question5Answer8: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('<a>View all fees</a>', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
        href: "https://docs.woocommerce.com/document/payments/faq/fees/",
        target: "_blank",
    ...
    question6: Object(external_wp_i18n_["__"])('When will I receive deposits for my WooCommerce Payments account balance?', 'woocommerce-admin'),
    question6Answer1: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('For most accounts, <a>WooCommerce Payments</a> automatically pays out your available account balance into your nominated account daily after a standard pending period.', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
    ...
    question6Answer2: Object(external_wp_i18n_["__"])('Payments received each day become part of the pending balance. That pending balance will become available after a pending period. On the day it becomes available, it will be automatically paid out to your bank account. The pending period is based on the country of the account.', 'woocommerce-admin'),
    question6Answer3: Object(external_wp_i18n_["__"])('For example, a business based in New Zealand has a pending period of 4 business days. Payments made to this account on Wednesday will be paid out on the next Tuesday.', 'woocommerce-admin'),
    question6Answer4: Object(external_wp_i18n_["__"])('Most banks will reflect the deposit in your account as soon as they receive the transfer from WooCommerce Payments. Some may take a few extra days to make the balance available to you.', 'woocommerce-admin'),
    question6Answer5: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('<a>All deposits details</a>', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
    ...
    question7: Object(external_wp_i18n_["__"])('What products are not permitted on my store when accepting payments with WooCommerce Payments?', 'woocommerce-admin'),
    question7Answer1: Object(external_wp_i18n_["__"])('Due to restrictions from card networks, our payment service providers, and their financial service providers, some businesses and product types that are not allowed to transact using WooCommerce Payments, including but not limited to:', 'woocommerce-admin'),
    question7Answer2: Object(external_wp_i18n_["__"])('Virtual currency, including video game or virtual world credits', 'woocommerce-admin'),
    question7Answer3: Object(external_wp_i18n_["__"])('Counterfeit goods', 'woocommerce-admin'),
    question7Answer4: Object(external_wp_i18n_["__"])('Adult content and services', 'woocommerce-admin'),
    question7Answer5: Object(external_wp_i18n_["__"])('Drug paraphernalia (including e-cigarette, vapes and nutraceuticals)', 'woocommerce-admin'),
    question7Answer6: Object(external_wp_i18n_["__"])('Multi-level marketing', 'woocommerce-admin'),
    question7Answer7: Object(external_wp_i18n_["__"])('Pseudo pharmaceuticals', 'woocommerce-admin'),
    question7Answer8: Object(external_wp_i18n_["__"])('Social media activity, like Twitter followers, Facebook likes, YouTube views', 'woocommerce-admin'),
    question7Answer9: Object(external_wp_i18n_["__"])('Substances designed to mimic illegal drugs', 'woocommerce-admin'),
    question7Answer10: Object(external_wp_i18n_["__"])('Firearms, ammunition', 'woocommerce-admin'),
    question7Answer11: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('The full list of these businesses can be found in <a>Stripe’s Restricted Businesses list</a>.', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
    ...
    question7Answer12: Object(external_wp_i18n_["__"])('By signing up to use WooCommerce Payments, you agree not to accept payments in connection with these restricted activities, practices or products. We also work to ensure that no prohibited activity is conducted on WooCommerce Payments.', 'woocommerce-admin'),
    question7Answer13: Object(external_wp_i18n_["__"])('If we become aware of prohibited activity, we may restrict or shutdown the account responsible.', 'woocommerce-admin'),
    question8: Object(external_wp_i18n_["__"])('Can WooCommerce Payments support Subscriptions and recurring payment options?', 'woocommerce-admin'),
    question8Answer1: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('WooCommerce Payments supports charging automatic recurring payments via the <a>WooCommerce Subscriptions</a> plugin.', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
    ...
    question8Answer2: Object(external_wp_i18n_["__"])('WooCommerce Payments offers full compatibility with WooCommerce Subscriptions’ features, including:', 'woocommerce-admin'),
    question8Answer3: Object(external_wp_i18n_["__"])('Subscription suspension', 'woocommerce-admin'),
    question8Answer4: Object(external_wp_i18n_["__"])('Subscription cancellation', 'woocommerce-admin'),
    question8Answer5: Object(external_wp_i18n_["__"])('Subscription reactivation', 'woocommerce-admin'),
    question8Answer6: Object(external_wp_i18n_["__"])('Multiple subscriptions', 'woocommerce-admin'),
    question8Answer7: Object(external_wp_i18n_["__"])('Recurring total changes', 'woocommerce-admin'),
    question8Answer8: Object(external_wp_i18n_["__"])('Payment date changes', 'woocommerce-admin'),
    question8Answer9: Object(external_wp_i18n_["__"])('Customer & Store Manager payment method changes', 'woocommerce-admin'),
    question8Answer10: Object(external_wp_element_["createInterpolateElement"])(Object(external_wp_i18n_["__"])('For more details on the subscription features that WooCommerce Payments offers, refer to the <a>subscription section of the WooCommerce Payments start up guide</a>.', 'woocommerce-admin'), {
      a: // eslint-disable-next-line jsx-a11y/anchor-has-content
      Object(external_wp_element_["createElement"])("a", {
    ...
    haveMoreQuestions: Object(external_wp_i18n_["__"])('Have more questions?', 'woocommerce-admin'),
    getInTouch: Object(external_wp_i18n_["__"])('Get in touch', 'woocommerce-admin')
  }
});
// CONCATENATED MODULE: ./client/payments-welcome/flag.js


/* harmony default export */ var flag = (props => Object(external_wp_element_["createElement"])("svg", extends_default()({
  width: "14",
  height: "14",
  viewBox: "0 0 14 14",
  fill: "none",
...
const Banner = () => {
  ...
  }, Object(external_wp_element_["createElement"])(flag, {
    className: "flag-icon"
  }), strings.limitedTimeOffer, ": ", strings.bannerCopy), Object(external_wp_element_["createElement"])("p", {
...
var style = __webpack_require__(631);
...
var help = __webpack_require__(534);
...
const PanelBody = props => {
  return Object(external_wp_element_["createElement"])(external_wp_components_["PanelBody"], extends_default()({
    initialOpen: false
  }, props));
};
...
const FrequentlyAskedQuestions = () => {
  return Object(external_wp_element_["createElement"])("div", {
    className: "faq__card"
  }, Object(external_wp_element_["createElement"])("h3", null, strings.faq.faqHeader), Object(external_wp_element_["createElement"])(external_wp_components_["Panel"], null, Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question1
  }, Object(external_wp_element_["createElement"])("p", null, strings.faq.question1Answer1), Object(external_wp_element_["createElement"])("p", null, strings.faq.question1Answer2)), Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question2
  }, Object(external_wp_element_["createElement"])("p", null, strings.faq.question2Answer1)), Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question3
  }, Object(external_wp_element_["createElement"])("ul", null, Object(external_wp_element_["createElement"])("li", null, strings.faq.question3Answer1), Object(external_wp_element_["createElement"])("li", null, strings.faq.question3Answer2), Object(external_wp_element_["createElement"])("li", null, strings.faq.question3Answer3), Object(external_wp_element_["createElement"])("li", null, strings.faq.question3Answer4))), Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question4
  }, Object(external_wp_element_["createElement"])("p", null, strings.faq.question4Answer1), Object(external_wp_element_["createElement"])("p", null, strings.faq.question4Answer2)), Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question5
  }, Object(external_wp_element_["createElement"])("p", null, strings.faq.question5Answer1), Object(external_wp_element_["createElement"])("p", null, strings.faq.question5Answer2)), Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question6
  }, Object(external_wp_element_["createElement"])("p", null, strings.faq.question6Answer1), Object(external_wp_element_["createElement"])("p", null, strings.faq.question6Answer2), Object(external_wp_element_["createElement"])("p", null, strings.faq.question6Answer3), Object(external_wp_element_["createElement"])("p", null, strings.faq.question6Answer4), Object(external_wp_element_["createElement"])("p", null, strings.faq.question6Answer5)), Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question7
  }, Object(external_wp_element_["createElement"])("p", null, strings.faq.question7Answer1), Object(external_wp_element_["createElement"])("ul", null, Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer2), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer3), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer4), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer5), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer6), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer7), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer8), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer9), Object(external_wp_element_["createElement"])("li", null, strings.faq.question7Answer10)), Object(external_wp_element_["createElement"])("p", null, strings.faq.question7Answer11), Object(external_wp_element_["createElement"])("p", null, strings.faq.question7Answer12), Object(external_wp_element_["createElement"])("p", null, strings.faq.question7Answer13)), Object(external_wp_element_["createElement"])(PanelBody, {
    title: strings.faq.question8
  }, Object(external_wp_element_["createElement"])("p", null, strings.faq.question8Answer1), Object(external_wp_element_["createElement"])("p", null, strings.faq.question8Answer2), Object(external_wp_element_["createElement"])("ul", null, Object(external_wp_element_["createElement"])("li", null, strings.faq.question8Answer3), Object(external_wp_element_["createElement"])("li", null, strings.faq.question8Answer4), Object(external_wp_element_["createElement"])("li", null, strings.faq.question8Answer5), Object(external_wp_element_["createElement"])("li", null, strings.faq.question8Answer6), Object(external_wp_element_["createElement"])("li", null, strings.faq.question8Answer7), Object(external_wp_element_["createElement"])("li", null, strings.faq.question8Answer8), Object(external_wp_element_["createElement"])("li", null, strings.faq.question8Answer9)), Object(external_wp_element_["createElement"])("p", null, strings.faq.question8Answer10))), Object(external_wp_element_["createElement"])("div", {
    className: "help-section"
  }, Object(external_wp_element_["createElement"])(icon["a" /* default */], {
    icon: help["a" /* default */]
  }), Object(external_wp_element_["createElement"])("span", null, strings.faq.haveMoreQuestions), Object(external_wp_element_["createElement"])("a", {
...
function ExitSurveyModal(_ref) {
  ...
  const [isMoreInfoChecked, setMoreInfoChecked] = Object(external_wp_element_["useState"])(false);
  const [isAnotherTimeChecked, setAnotherTimeChecked] = Object(external_wp_element_["useState"])(false);
  const [isSomethingElseChecked, setSomethingElseChecked] = Object(external_wp_element_["useState"])(false);
  ...
  const sendFeedback = () => {
    Object(external_wc_tracks_["recordEvent"])('wcpay_exit_survey', {
  ...
  return Object(external_wp_element_["createElement"])(external_wp_components_["Modal"], {
  ...
  }, strings.surveyIntro), Object(external_wp_element_["createElement"])("p", {
    className: "wc-calypso-bridge-payments-welcome-survey__question"
  }, strings.surveyQuestion), Object(external_wp_element_["createElement"])("div", {
    ...
    name: "cancel"
  }, strings.surveyCancelButton), Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
    isSecondary: true,
...
const LearnMore = () => {
  const handleClick = () => {
    Object(external_wc_tracks_["recordEvent"])('wcpay_welcome_learn_more', {});
  };
...
const PaymentMethods = () => Object(external_wp_element_["createElement"])("div", {
...
const TermsOfService = () => Object(external_wp_element_["createElement"])("span", {
...
const ConnectPageOnboarding = _ref2 => {
  ...
  const handleSetup = async () => {
    setSubmitted(true);
    Object(external_wc_tracks_["recordEvent"])('wcpay_connect_account_clicked', {
  ...
  }, Object(external_wp_element_["createElement"])(external_wp_components_["CardHeader"], null, Object(external_wp_element_["createElement"])("div", null, Object(external_wp_element_["createElement"])("h1", {
    className: "banner-heading-copy"
  }, strings.bannerHeading), Object(external_wp_element_["createElement"])(TermsOfService, null)), Object(external_wp_element_["createElement"])("div", {
  ...
  }, strings.nothanks), Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
    isPrimary: true,
    isBusy: isSubmitted,
    disabled: isSubmitted,
    onClick: handleSetup,
    className: "btn-install"
  }, strings.button), isExitSurveyModalOpen && Object(external_wp_element_["createElement"])(exit_survey_modal, {
    setExitSurveyModalOpen: setExitSurveyModalOpen
  }))), Object(external_wp_element_["createElement"])(external_wp_components_["CardBody"], null, Object(external_wp_element_["createElement"])("div", {
    className: "content"
  }, Object(external_wp_element_["createElement"])("p", {
    className: "onboarding-description"
  }, strings.onboarding.description, Object(external_wp_element_["createElement"])("br", null), Object(external_wp_element_["createElement"])(LearnMore, null)), Object(external_wp_element_["createElement"])("h3", {
    className: "accepted-payment-methods"
  }, strings.paymentMethodsHeading), Object(external_wp_element_["createElement"])(PaymentMethods, null))));
};

const ConnectAccountPage = () => {
  const [errorMessage, setErrorMessage] = Object(external_wp_element_["useState"])('');
  const {
    isJetpackConnected,
    connectUrl,
  ...
  Object(external_wp_element_["useEffect"])(() => {
    Object(external_wc_tracks_["recordEvent"])('page_view', {
  ...
  const {
    installAndActivatePlugins
  } = Object(external_wp_data_["useDispatch"])('wc/admin/plugins');
  ...
  }, Object(external_wp_element_["createElement"])(ConnectPageError, {
    errorMessage: errorMessage
  }), Object(external_wp_element_["createElement"])(ConnectPageOnboarding, extends_default()({}, onboardingProps, {
    setErrorMessage: setErrorMessage
  })), Object(external_wp_element_["createElement"])(banner, null), Object(external_wp_element_["createElement"])(faq, null)));
};

/* harmony default export */ var payments_welcome = __webpack_exports__["default"] = (ConnectAccountPage);
