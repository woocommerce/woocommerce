 ...
 */
__webpack_require__(473);var f=__webpack_require__(6),g=60103;exports.Fragment=60107;if("function"===typeof Symbol&&Symbol.for){var h=Symbol.for;g=h("react.element");exports.Fragment=h("react.fragment")}var m=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,n=Object.prototype.hasOwnProperty,p={key:!0,ref:!0,__self:!0,__source:!0};
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/timing.js
...
function timeoutPromise(promise, timeoutMilliseconds) {
    return Promise.race([
        promise,
        new Promise((_res, rej) => setTimeout(() => rej(new Error(`Promise has timed-out after ${timeoutMilliseconds}ms.`)), timeoutMilliseconds)),
    ]);
}
/**
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/experiment-assignments.js
 ...
 */
const createFallbackExperimentAssignment = (experimentName, ttl = minimumTtl) => ({
...
//# sourceMappingURL=experiment-assignments.js.map
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/local-storage.js
/**
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/validations.js
function isObject(x) {
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/experiment-assignment-store.js
 ...
 * Exported for testing purposes only.
 */
const localStorageExperimentAssignmentKey = (experimentName) => `${localStorageExperimentAssignmentKeyPrefix}-${experimentName}`;
/**
...
function storeExperimentAssignment(experimentAssignment) {
    ...
    const previousExperimentAssignment = retrieveExperimentAssignment(experimentAssignment.experimentName);
...
function retrieveExperimentAssignment(experimentName) {
    const maybeExperimentAssignmentJson = local_storage.getItem(localStorageExperimentAssignmentKey(experimentName));
...
function getAllLocalStorageKeys() {
    return range(local_storage.length).map((i) => local_storage.key(i));
}
/**
 * Exported for testing purposes only.
 */
function isLocalStorageExperimentAssignmentKey(key) {
    return key.startsWith(localStorageExperimentAssignmentKeyPrefix);
}
/**
 * Exported for testing purposes only.
 */
function experimentNameFromLocalStorageExperimentAssignmentKey(key) {
 ...
 */
function removeExpiredExperimentAssignments() {
    getAllLocalStorageKeys()
        ...
        try {
            if (isAlive(retrieveExperimentAssignment(experimentName)))
                return false;
        }
        catch (_) { }
        return true;
        ...
        .map((key) => local_storage.removeItem(key));
}
//# sourceMappingURL=experiment-assignment-store.js.map
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/requests.js
 ...
 */
const localStorageCachedGetAnonId = async (getAnonId) => {
    ...
    const maybeStoredAnonId = local_storage.getItem(localStorageLastAnonIdKey);
    const maybeStoredRetrievalTime = local_storage.getItem(localStorageLastAnonIdRetrievalTimeKey);
 ...
 */
async function fetchExperimentAssignment(config, experimentName) {
    const retrievedTimestamp = monotonicNow();
    const { variations, ttl: responseTtl } = validateFetchExperimentAssignmentResponse(await config.fetchExperimentAssignment({
        anonId: await localStorageCachedGetAnonId(config.getAnonId),
        experimentName,
    }));
    const ttl = Math.max(minimumTtl, responseTtl);
    ...
    if (fetchedExperimentAssignments.length === 0) {
        return createFallbackExperimentAssignment(experimentName, ttl);
    }
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/create-explat-client.js
...
class MissingExperimentAssignmentError extends Error {
    constructor(message) {
        super(message);
...
function createExPlatClient(config) {
     ...
     */
    const createWrappedExperimentAssignmentFetchAndStore = (experimentName) => asyncOneAtATime(async () => {
        const fetchedExperimentAssignment = await fetchExperimentAssignment(config, experimentName);
        storeExperimentAssignment(fetchedExperimentAssignment);
        return fetchedExperimentAssignment;
    });
    const experimentNameToWrappedExperimentAssignmentFetchAndStore = {};
    ...
    return {
        loadExperimentAssignment: async (experimentName) => {
            try {
                ...
                const fetchedExperimentAssignment = await timeoutPromise(experimentNameToWrappedExperimentAssignmentFetchAndStore[experimentName](), experimentFetchTimeout);
        ...
        dangerouslyGetExperimentAssignment: (experimentName) => {
            try {
                if (!isName(experimentName)) {
                    throw new Error(`Invalid experimentName: ${experimentName}`);
                }
...
//# sourceMappingURL=create-explat-client.js.map
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/index.js

const esm_createExPlatClient = typeof window === 'undefined' ? createSsrSafeDummyExPlatClient : createExPlatClient;

//# sourceMappingURL=index.js.map
// EXTERNAL MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/react@17.0.2/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(90);

// EXTERNAL MODULE: external "React"
var external_React_ = __webpack_require__(6);

// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/@automattic+explat-client-react-helpers@0.0.3/node_modules/@automattic/explat-client-react-helpers/dist/esm/index.js
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/packages/js/explat/build-module/utils.js
/**
 * Boolean determining if environment is development.
 */
const isDevelopmentMode = "production" === 'development';
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/packages/js/explat/build-module/error.js
/**
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/packages/js/explat/build-module/assignment.js
/**
...
// EXTERNAL MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/node_modules/.pnpm/cookie@0.4.2/node_modules/cookie/index.js
var cookie = __webpack_require__(294);
var cookie_default = /*#__PURE__*/__webpack_require__.n(cookie);

// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/packages/js/explat/build-module/anon.js
/**
 * External dependencies
 */
...
// CONCATENATED MODULE: /Users/obliviousharmony/Code/WooCommerce/Monorepo/packages/js/explat/build-module/index.js
/**
 * External dependencies
 */
