# Product Category TreeSelect Feedback Notes

## Purpose

This draft PR is for early feedback on the product-category follow-up to the first TreeSelect breakout. It is not a production-ready component proposal yet.

PR #64732 focused on the shipping-first TreeSelect direction. This pass focuses on how the TreeSelect pattern could fit into the current WooCommerce product editor category panel, and how it relates to the primary category / storefront breadcrumb decision.

## What Changed Since The Shipping-First Pass
...
This pass is a bridge between component exploration and product editor fit:
