...
- Enhancement - Add migration for moving order operational data to the custom table. ([#32054](https://github.com/woocommerce/woocommerce/pull/32054))
- Enhancement - Add migration for moving shipping addresses to the custom address table. ([#32053](https://github.com/woocommerce/woocommerce/pull/32053))
- Enhancement - Add migration for moving billing addresses to custom address table. ([#32052](https://github.com/woocommerce/woocommerce/pull/32052))
