...
class WebhookFailureCheck {
	...
	public function get_label(): string {
		return __( 'Woo: WooCommerce webhook deliveries', 'woocommerce' );
	}
	...
	public function run(): array {
		...
		if ( $count > $threshold ) {
			return $this->finish( array(
				'label'       => __( 'Woo: WooCommerce has failed webhook deliveries', 'woocommerce' ),
				'status'      => 'recommended',
		...
		return $this->finish( array(
			'label'       => __( 'Woo: WooCommerce webhook deliveries are healthy', 'woocommerce' ),
			'status'      => 'good',
