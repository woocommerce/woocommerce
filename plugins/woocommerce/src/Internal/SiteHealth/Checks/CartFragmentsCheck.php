...
class CartFragmentsCheck {
	...
	public function get_label(): string {
		return __( 'Woo: WooCommerce cart fragments load policy', 'woocommerce' );
	}
	...
	public function run(): array {
		...
		if ( is_wp_error( $response ) ) {
			...
			return $this->finish( array(
				'label'       => __( 'Woo: WooCommerce could not run the cart fragments check', 'woocommerce' ),
				'status'      => 'recommended',
		...
		if ( $loaded ) {
			return $this->finish( array(
				'label'       => __( 'Woo: WooCommerce cart fragments are loaded on the home page', 'woocommerce' ),
				'status'      => 'recommended',
		...
		return $this->finish( array(
			'label'       => __( 'Woo: WooCommerce cart fragments are not loaded site-wide', 'woocommerce' ),
			'status'      => 'good',
