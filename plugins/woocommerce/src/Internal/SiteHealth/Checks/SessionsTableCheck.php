...
class SessionsTableCheck {
	...
	public function get_label(): string {
		return __( 'Woo: WooCommerce sessions table size', 'woocommerce' );
	}
	...
	public function run(): array {
		...
		if ( $count > $threshold ) {
			return $this->finish( array(
				'label'       => __( 'Woo: WooCommerce sessions table is large', 'woocommerce' ),
				'status'      => 'recommended',
		...
		return $this->finish( array(
			'label'       => __( 'Woo: WooCommerce sessions table size is healthy', 'woocommerce' ),
			'status'      => 'good',
