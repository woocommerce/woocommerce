...
class TemplateOverrideScanner {
	...
	public function get_label(): string {
		return __( 'Woo: template overrides', 'woocommerce' );
	}
	...
	public function run(): array {
		...
		if ( ! empty( $outdated ) ) {
			...
			return $this->finish( array(
				'label'       => __( 'Woo: has outdated template overrides', 'woocommerce' ),
				'status'      => 'recommended',
		...
		return $this->finish( array(
			'label'       => __( 'Woo: template overrides are up to date', 'woocommerce' ),
			'status'      => 'good',
	...
	private function error_result( \Throwable $e ): array {
		...
		return $this->finish( array(
			'label'       => __( 'Woo: could not run the template overrides check', 'woocommerce' ),
			'status'      => 'recommended',
