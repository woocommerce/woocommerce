...
class SessionClearanceManager {
	...
	public function get_session_id(): string {
		...
		$fraud_customer_session_id = WC()->session->get( '_fraud_protection_guest_session_id' );
		if ( ! $fraud_customer_session_id ) {
			$fraud_customer_session_id = WC()->call_function( 'wc_rand_hash', 'customer_', 30 );
			WC()->session->set( '_fraud_protection_guest_session_id', $fraud_customer_session_id );
		}
