...
class PushTokenRestController extends RestApiControllerBase {
	 ...
	 * along with the username and email of the account each one belongs to.
	 *
	 * @since 10.8.0
	 *
	 ...
	 * {@see PushToken::to_wpcom_format()}, because that method is also the
	 * per-token payload the dispatcher POSTs to the WPCOM send endpoint.
	 *
