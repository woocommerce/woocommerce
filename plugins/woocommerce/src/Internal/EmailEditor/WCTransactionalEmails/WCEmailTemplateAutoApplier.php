...
class WCEmailTemplateAutoApplier {
	 ...
	 * action is unique, which guards against double-enqueueing when the
	 * detector sweep runs twice in one request: once on `woocommerce_updated`,
	 * once on `BACKFILL_COMPLETE_ACTION`.
	 *
	 * @since 10.8.0
	 */
