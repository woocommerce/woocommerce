...
abstract class AbstractAutomatticAddressProvider extends WC_Address_Provider {
	...
	public function __construct() {
		...
		$this->branding_html = '<div class="mock-address-provider-branding" style="display: flex; align-items: center;">Powered by <svg style="margin-left: 4px; margin-bottom: -1px;" width="43" height="15" viewBox="0 0 43 15" fill="none" xmlns="http://www.w3.org/2000/svg">
