...
class Homescreen {
	...
	public function maybe_set_default_shipping_options_on_home( $settings ) {
		...
		if (
			...
			||
			( ! in_array( $country_code, array( 'US', 'CA', 'AU', 'GB', 'ES' , 'IT' , 'DE' , 'FR' , 'MX' , 'CO' , 'CL' , 'AR' , 'PE' , 'BR' , 'UY' , 'GT' , 'NL' , 'AT' , 'BE' ), true ) ) // TODO: should make a constant that is shared with Shipping.php
			||
