...
#[SidebarPath('Tests')]
#[DescriptionTitle('Miscellaneous tests')]
#[AboutTitle('About the tests controller')]
#[AboutText( 'This controller is used for testing purposes, it doesn\'t really provide any WooCommerce related functionality.' )]
class TestController extends ControllerBase {

	#[RestApiEndpoint( 'GET', 'admins_only' )]
	#[AllowedRoles( 'administrator' )]
	#[DescriptionTitle( 'Administrators-only endpoint' )]
	...
	#[DescriptionTitle( 'Unauthenticated-friendly endpoint' )]
	...
	#[RestApiEndpoint( 'GET', '' )]
	#[DescriptionTitle( 'Root endpoint' )]
	...
	#[DescriptionTitle( 'Echo endpoint' )]
