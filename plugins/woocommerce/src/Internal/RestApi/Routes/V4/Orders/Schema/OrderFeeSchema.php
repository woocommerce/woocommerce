...
class OrderFeeSchema extends AbstractLineItemSchema {
	...
	public function get_item_schema_properties(): array {
		$schema = array(
			...
			'can_be_refunded' => array(
				'description' => __( 'Whether the fee line has remaining refundable amount.', 'woocommerce' ),
				'type'        => 'boolean',
				'context'     => self::VIEW_EDIT_EMBED_CONTEXT,
				'readonly'    => true,
			),
	...
	public function get_item_response( $order_item, WP_REST_Request $request, array $include_fields = array() ): array {
		...
		$data = array(
			...
			'can_be_refunded' => $this->calculate_line_item_can_be_refunded( $order_item, 'fee' ),
		);
