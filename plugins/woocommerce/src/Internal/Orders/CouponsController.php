...
class CouponsController {
	...
	public function add_coupon_discount( array $post_variables ): object {
		...
		$code   = wc_format_coupon_code_without_lower( wp_unslash( $coupon ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
