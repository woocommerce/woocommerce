...
use Automattic\WooCommerce\Internal\Api\Autogenerated\ApiClassesServiceProvider; // !!!AutogeneratedMock
...
final class Container {
	...
	private $service_providers = array(
		ApiClassesServiceProvider::class,
	...
	public function __construct() {
		...
		$service_providers = array_merge( $this->service_providers, ApiMain::get_extra_service_providers() );
		foreach ( $service_providers as $service_provider_class ) {
