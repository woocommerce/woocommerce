...
use Automattic\WooCommerce\Internal\DependencyManagement\ServiceProviders\WordPressCompatibilityServiceProvider;
...
final class Container {
	...
	private $service_providers = array(
		...
		WordPressCompatibilityServiceProvider::class,
	);
