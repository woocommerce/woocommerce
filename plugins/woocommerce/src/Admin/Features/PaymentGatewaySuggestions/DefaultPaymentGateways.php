...
class DefaultPaymentGateways {
	...
	private static function get_recommendation_priority( $gateway_id, $country_code ) {
		$recommendation_priority_map = array(
			...
			'BG' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'HR' => [ 'woocommerce_payments', 'ppcp-gateway' ],
			'CH' => [
				'woocommerce_payments',
				'stripe',
				'ppcp-gateway',
			...
			'CY' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway', 'amazon_payments_advanced' ],
			'CZ' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'DK' => [
				'woocommerce_payments',
				'stripe',
				'ppcp-gateway',
			...
			'EE' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'ES' => [
				'woocommerce_payments',
				'stripe',
				'ppcp-gateway',
			...
			'GR' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'HU' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway', 'amazon_payments_advanced' ],
			'IE' => [
				'woocommerce_payments',
				'stripe',
				'ppcp-gateway',
			...
			'LV' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'LT' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'LU' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway', 'amazon_payments_advanced' ],
			'MT' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'NL' => [
				'woocommerce_payments',
				'stripe',
				'ppcp-gateway',
			...
			'NO' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway', 'kco', 'klarna_payments' ],
			'PL' => [
				'woocommerce_payments',
				'stripe',
				'ppcp-gateway',
			...
			'RO' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'SK' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway' ],
			'SL' => [ 'woocommerce_payments', 'stripe', 'ppcp-gateway', 'amazon_payments_advanced' ],
			'SE' => [
				'woocommerce_payments',
				'stripe',
				'ppcp-gateway',
