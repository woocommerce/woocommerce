...
class SimpleProductTemplate extends AbstractBlockTemplate {
	...
	private function add_pricing_group_blocks()
	{
		...
		$product_pricing_section->add_columns([
	...
	private function add_inventory_group_blocks()
	{
		...
		$product_inventory_inner_section->add_conditional_block([
			'mustMatch' => array(
		...
		$product_inventory_section->add_conditional_block([
			'mustMatch' => array(
		...
		$product_inventory_advanced_wrapper->add_conditional_block([
			'mustMatch' => array(
				'manage_stock' => array( true ),
			)
		], [
