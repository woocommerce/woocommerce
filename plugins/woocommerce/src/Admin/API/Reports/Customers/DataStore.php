...
class DataStore extends ReportsDataStore implements DataStoreInterface {
	...
	protected function assign_report_columns() {
		...
		$this->report_columns = array(
			...
			'date_last_active' => "IF( date_last_active <= '0000-00-00 00:00:00', NULL, date_last_active ) AS date_last_active", // Changed IF clause from Double Quotes to Single Quotes with sql_mode=ANSI_QUOTES
