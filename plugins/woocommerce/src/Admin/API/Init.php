...
class Init {
	...
	public static function add_data_stores( $data_stores ) {
		return array_merge(
			$data_stores,
			array(
				'reports/revenue/stats'    => 'Automattic\WooCommerce\Admin\API\Reports\Orders\Stats\DataStore',
				'reports/orders'           => 'Automattic\WooCommerce\Admin\API\Reports\Orders\DataStore',
				'reports/orders/stats'     => 'Automattic\WooCommerce\Admin\API\Reports\Orders\Stats\DataStore',
				'reports/products'         => 'Automattic\WooCommerce\Admin\API\Reports\Products\DataStore',
				'reports/variations'       => 'Automattic\WooCommerce\Admin\API\Reports\Variations\DataStore',
				'reports/products/stats'   => 'Automattic\WooCommerce\Admin\API\Reports\Products\Stats\DataStore',
				'reports/variations/stats' => 'Automattic\WooCommerce\Admin\API\Reports\Variations\Stats\DataStore',
				'reports/categories'       => 'Automattic\WooCommerce\Admin\API\Reports\Categories\DataStore',
				'reports/taxes'            => 'Automattic\WooCommerce\Admin\API\Reports\Taxes\DataStore',
				'reports/taxes/stats'      => 'Automattic\WooCommerce\Admin\API\Reports\Taxes\Stats\DataStore',
				'reports/coupons'          => 'Automattic\WooCommerce\Admin\API\Reports\Coupons\DataStore',
				'reports/coupons/stats'    => 'Automattic\WooCommerce\Admin\API\Reports\Coupons\Stats\DataStore',
				'reports/downloads'        => 'Automattic\WooCommerce\Admin\API\Reports\Downloads\DataStore',
				'reports/downloads/stats'  => 'Automattic\WooCommerce\Admin\API\Reports\Downloads\Stats\DataStore',
				'admin-note'              => 'Automattic\WooCommerce\Admin\Notes\DataStore',
				'reports/customers'        => 'Automattic\WooCommerce\Admin\API\Reports\Customers\DataStore',
				'reports/customers/stats'  => 'Automattic\WooCommerce\Admin\API\Reports\Customers\Stats\DataStore',
				'reports/stock/stats'      => 'Automattic\WooCommerce\Admin\API\Reports\Stock\Stats\DataStore',
			)
		);
	}
