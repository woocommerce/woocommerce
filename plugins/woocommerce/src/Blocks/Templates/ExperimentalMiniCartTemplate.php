...
/**
 * ExperimentalMiniCartTemplate class.
 *
 * @internal
 */
class ExperimentalMiniCartTemplate extends AbstractTemplatePart {
	 ...
	 * @var string
	 */
	const SLUG = 'experimental-iapi-mini-cart';
	...
	public function get_template_title() {
		return _x( 'Experimental Mini-Cart', 'Template name', 'woocommerce' );
	}
	...
	public function get_template_description() {
		return __( 'Template used to display the Experimental Mini-Cart drawer.', 'woocommerce' );
	}
	...
	public function register_mini_cart_template_part_area( $default_area_definitions ) {
		$mini_cart_template_part_area = array(
			'area'        => 'mini-cart',
			'label'       => __( 'Experimental Mini-Cart', 'woocommerce' ),
