...
class QuantitySelector extends AbstractBlock {
	...
	protected function render( $attributes, $content, $block ) {
		...
		if ( $product->is_type( ProductType::VARIABLE ) ) {
			...
			$input_attributes['data-wp-bind--min']      = 'woocommerce/product-context::state.productInContext.add_to_cart.minimum';
			$input_attributes['data-wp-bind--max']      = 'woocommerce/product-context::state.productInContext.add_to_cart.maximum';
			$input_attributes['data-wp-bind--step']     = 'woocommerce/product-context::state.productInContext.add_to_cart.multiple_of';
