 ...
 */
class AddToCartWithOptions extends AbstractAddToCartWithOptionsBlock {
	...
	protected function render( $attributes, $content, $block ) {
		...
		if ( is_string( $template_part_path ) && file_exists( $template_part_path ) ) {
			...
			*/
			...
			add_filter( 'render_block_context', array( Utils::class, 'set_is_descendant_of_add_to_cart_with_options_context' ), 10, 2 );
			$template_part_blocks = do_blocks( $template_part_contents );
			remove_filter( 'render_block_context', array( Utils::class, 'set_is_descendant_of_add_to_cart_with_options_context' ) );
