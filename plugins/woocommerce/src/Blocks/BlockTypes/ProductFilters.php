...
class ProductFilters extends AbstractBlock {
	...
	protected function enqueue_data( array $attributes = [] ) {
		...
		if (
			...
			$theme_slug = BlockTemplateUtils::theme_has_template_part( 'product-filters' ) ? wp_get_theme()->get_stylesheet() : BlockTemplateUtils::PLUGIN_SLUG;
			...
			$template_part_edit_uri = esc_url_raw(
				add_query_arg(
					array(
						'postId'   => sprintf( '%s//%s', $theme_slug, 'product-filters' ),
