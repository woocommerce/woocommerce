...
class EmptyMiniCartContentsBlock extends AbstractInnerBlock {
	...
	protected function render_experimental_filled_mini_cart_contents( $attributes, $content, $block ) {
		ob_start();
		?>
		<div data-wp-bind--hidden="woocommerce/mini-cart::!state.cartIsEmpty" data-wp-interactive="woocommerce/empty-mini-cart-contents" class="wp-block-woocommerce-empty-mini-cart-contents-block">
			<?php
