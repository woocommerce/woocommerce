...
class MiniCart extends AbstractBlock {
	...
	public function register_auto_insert( $hooked_blocks, $position, $anchor_block, $context ) {
		 ...
		 * @since $VID:$
		 */
		$theme_include_list = apply_filters( 'woocommerce_blocks_mini_cart_auto_insert_theme_include_list', array( 'Twenty Twenty-Four', 'Twenty Twenty-Three', 'Twenty Twenty-Two', 'Thriving Artist' ) );
