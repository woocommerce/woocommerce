	...
	protected function render( $attributes, $content, $block ) {
		...
		if ( $cart ) {
			...
			<div
				...
				data-wp-on-document--wc-blocks_added_to_cart="woocommerce/cart::actions.refreshCartItems"
				data-wp-on-document--wc-blocks_removed_from_cart="woocommerce/cart::actions.refreshCartItems"
