...
final class QueryFilters {
	...
	public function init() {
		wc_deprecated_function( 'QueryFilters::init', '8.6.0' );
	}
	...
	public function main_query_filter( $args, $wp_query ) {
		wc_deprecated_function( 'QueryFilters::main_query_filter', '8.6.0' );
		if (
	 ...
	 *
	 * @deprecated 8.6.0 Use FilterClausesGenerator::add_query_clauses instead.
	 * @param array     $args     Query args.
	 * @param \WP_Query $wp_query WP_Query object.
	 * @return array
	 */
	public function add_query_clauses( $args, $wp_query ) {
		wc_deprecated_function( 'QueryFilters::add_query_clauses', '8.6.0', 'FilterClausesGenerator::add_query_clauses' );
	 ...
	 *
	 * @deprecated 8.6.0 Use FilterDataProvider::get_filtered_price instead.
	 ...
	 *
	 * @deprecated 8.6.0 Use FilterDataProvider::get_stock_status_counts instead.
	 * @param array $query_vars The WP_Query arguments.
	 * @return array status=>count pairs.
	 */
	public function get_stock_status_counts( $query_vars ) {
		wc_deprecated_function( 'QueryFilters::get_stock_status_counts', '8.6.0', 'FilterDataProvider::get_stock_status_counts' );
	 ...
	 *
	 * @deprecated 8.6.0 Use FilterDataProvider::get_rating_counts instead.
	 * @param array $query_vars The WP_Query arguments.
	 ...
	 *
	 * @deprecated 8.6.0 Use FilterDataProvider::get_attribute_counts instead.
	 * @param array  $query_vars         The WP_Query arguments.
	...
	public function get_attribute_counts( $query_vars, $attribute_to_count ) {
		wc_deprecated_function( 'QueryFilters::get_attribute_counts', '8.6.0', 'FilterDataProvider::get_attribute_counts' );
