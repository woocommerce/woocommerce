		...
		<div class="wp-block-columns is-not-stacked-on-mobile" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
			...
			<div class="wp-block-column" style="padding-top:0;padding-right:var(--wp--preset--spacing--20);padding-bottom:0;padding-left:0;flex-basis:15%">
				...
				<div class="wp-block-group">
					...
					<figure class="wp-block-image size-thumbnail has-custom-border is-resized">
						<img src="<?php echo esc_url( plugins_url( 'assets/images/pattern-placeholders/desk-table-wood-chair-floor-home-square.png', dirname( __FILE__ ) ) ); ?>" alt="<?php esc_attr_e( 'Placeholder image used to represent a product being showcased in a product gallery. Secondary image - 1 out of 3.', 'woo-gutenberg-products-block' ); ?>" class="has-border-color" style="border-color:#dddddd;border-width:1px;border-radius:5px"/>
					</figure>
					<!-- /wp:image -->

					<!-- wp:image {"sizeSlug":"thumbnail","linkDestination":"none","style":{"border":{"color":"#dddddd","width":"1px","radius":"5px"}},"className":"is-resized"} -->
					<figure class="wp-block-image size-thumbnail has-custom-border is-resized">
						<img src="<?php echo esc_url( plugins_url( 'assets/images/pattern-placeholders/table-floor-interior-atmosphere-living-room-furniture-square.png', dirname( __FILE__ ) ) ); ?>" alt="<?php esc_attr_e( 'Placeholder image used to represent a product being showcased in a product gallery. Secondary image - 2 out of 3.', 'woo-gutenberg-products-block' ); ?>" class="has-border-color" style="border-color:#dddddd;border-width:1px;border-radius:5px"/>
					</figure>
					<!-- /wp:image -->
			...
			<div class="wp-block-column" style="flex-basis:85%">
				...
				<figure class="wp-block-image size-full">
					<img src="<?php echo esc_url( plugins_url( 'assets/images/pattern-placeholders/table-wood-chair-floor-living-room-furniture-vertical.png', dirname( __FILE__ ) ) ); ?>" alt="<?php esc_attr_e( 'Placeholder image used to represent a product being showcased in a product gallery as a main image', 'woo-gutenberg-products-block' ); ?>"/>
				</figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:column -->
