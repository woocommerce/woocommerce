...
<h1 class="wp-block-heading alignwide has-text-align-center woocommerce-coming-soon-banner"><?php echo esc_html_x( 'Pardon our dust! We\'re working on something amazing -- check back soon!', 'woocommerce' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
