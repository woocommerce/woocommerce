...
return array(
	...
	'SN' => array( // Regions of Senegal. Ref: https://en.wikipedia.org/wiki/ISO_3166-2:JM.
		'SN-DK' => __( 'Dakar', 'woocommerce' ),
		'SN-DB' => __( 'Diourbel', 'woocommerce' ),
		'SN-FK' => __( 'Fatick', 'woocommerce' ),
		'SN-KA' => __( 'Kaffrine', 'woocommerce' ),
		'SN-KL' => __( 'Kaolack', 'woocommerce' ),
		'SN-KE' => __( 'Kédougou', 'woocommerce' ),
		'SN-KD' => __( 'Kolda', 'woocommerce' ),
		'SN-LG' => __( 'Louga', 'woocommerce' ),
		'SN-MT' => __( 'Matam', 'woocommerce' ),
		'SN-SL' => __( 'Saint-Louis', 'woocommerce' ),
		'SN-SE' => __( 'Sédhiou', 'woocommerce' ),
		'SN-TC' => __( 'Tambacounda', 'woocommerce' ),
		'SN-TH' => __( 'Thiès', 'woocommerce' ),
		'SN-ZG' => __( 'Ziguinchor', 'woocommerce' ),
	),
	'SG' => array(),
	'SK' => array(),
	'SI' => array(),
