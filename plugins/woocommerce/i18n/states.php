...
return array(
	...
	'VN' => array(
		'vnct' => __( 'Cần Thơ', 'woocommerce' ),
		'vndn' => __( 'Đà Nẵng', 'woocommerce' ),
		'vnhn' => __( 'Hà Nội', 'woocommerce' ),
		'vnhp' => __( 'Hải Phòng', 'woocommerce' ),
		'vnsg' => __( 'Thành phố Hồ Chí Minh', 'woocommerce' ),
		'vn01' => __( 'Lai Châu', 'woocommerce' ),
		'vn02' => __( 'Lào Cai', 'woocommerce' ),
		'vn03' => __( 'Hà Giang', 'woocommerce' ),
		'vn04' => __( 'Cao Bằng', 'woocommerce' ),
		'vn05' => __( 'Sơn La', 'woocommerce' ),
		'vn06' => __( 'Yên Bái', 'woocommerce' ),
		'vn07' => __( 'Tuyên Quang', 'woocommerce' ),
		'vn09' => __( 'Lạng Sơn', 'woocommerce' ),
		'vn13' => __( 'Quảng Ninh', 'woocommerce' ),
		'vn14' => __( 'Hòa Bình', 'woocommerce' ),
		'vn18' => __( 'Ninh Bình', 'woocommerce' ),
		'vn20' => __( 'Thái Bình', 'woocommerce' ),
		'vn21' => __( 'Thanh Hóa', 'woocommerce' ),
		'vn22' => __( 'Nghệ An', 'woocommerce' ),
		'vn23' => __( 'Hà Tĩnh', 'woocommerce' ),
		'vn24' => __( 'Quảng Bình', 'woocommerce' ),
		'vn25' => __( 'Quảng Trị', 'woocommerce' ),
		'vn26' => __( 'Thừa Thiên–Huế', 'woocommerce' ),
		'vn27' => __( 'Quảng Nam', 'woocommerce' ),
		'vn28' => __( 'Kon Tum', 'woocommerce' ),
		'vn29' => __( 'Quảng Ngãi', 'woocommerce' ),
		'vn30' => __( 'Gia Lai', 'woocommerce' ),
		'vn31' => __( 'Bình Định', 'woocommerce' ),
		'vn32' => __( 'Phú Yên', 'woocommerce' ),
		'vn33' => __( 'Đắk Lắk', 'woocommerce' ),
		'vn34' => __( 'Khánh Hòa', 'woocommerce' ),
		'vn35' => __( 'Lâm Đồng', 'woocommerce' ),
		'vn36' => __( 'Ninh Thuận', 'woocommerce' ),
		'vn37' => __( 'Tây Ninh', 'woocommerce' ),
		'vn39' => __( 'Đồng Nai', 'woocommerce' ),
		'vn40' => __( 'Bình Thuận', 'woocommerce' ),
		'vn41' => __( 'Long An', 'woocommerce' ),
		'vn43' => __( 'Bà Rịa–Vũng Tàu', 'woocommerce' ),
		'vn44' => __( 'An Giang', 'woocommerce' ),
		'vn45' => __( 'Đồng Tháp', 'woocommerce' ),
		'vn46' => __( 'Tiền Giang', 'woocommerce' ),
		'vn47' => __( 'Kiên Giang', 'woocommerce' ),
		'vn49' => __( 'Vĩnh Long', 'woocommerce' ),
		'vn50' => __( 'Bến Tre', 'woocommerce' ),
		'vn51' => __( 'Trà Vinh', 'woocommerce' ),
		'vn52' => __( 'Sóc Trăng', 'woocommerce' ),
		'vn53' => __( 'Bắc Kạn', 'woocommerce' ),
		'vn54' => __( 'Bắc Giang', 'woocommerce' ),
		'vn55' => __( 'Bạc Liêu', 'woocommerce' ),
		'vn56' => __( 'Bắc Ninh', 'woocommerce' ),
		'vn57' => __( 'Bình Dương', 'woocommerce' ),
		'vn58' => __( 'Bình Phước', 'woocommerce' ),
		'vn59' => __( 'Cà Mau', 'woocommerce' ),
		'vn61' => __( 'Hải Dương', 'woocommerce' ),
		'vn63' => __( 'Hà Nam', 'woocommerce' ),
		'vn66' => __( 'Hưng Yên', 'woocommerce' ),
		'vn67' => __( 'Nam Định', 'woocommerce' ),
		'vn68' => __( 'Phú Thọ', 'woocommerce' ),
		'vn69' => __( 'Thái Nguyên', 'woocommerce' ),
		'vn70' => __( 'Vĩnh Phúc', 'woocommerce' ),
		'vn71' => __( 'Điện Biên', 'woocommerce' ),
		'vn72' => __( 'Đắk Nông', 'woocommerce' ),
		'vn73' => __( 'Hậu Giang', 'woocommerce' ),
	),
	'YT' => array(),
