...
return array(
	...
	'NL' => array(),
	'NO' => array(),
	// Nepalese provinces (per ISO 3166-2:NP).
	'NP' => array(
		'P1' => __( 'Koshi', 'woocommerce' ),
		'P2' => __( 'Madhesh', 'woocommerce' ),
		'P3' => __( 'Bagmati', 'woocommerce' ),
		'P4' => __( 'Gandaki', 'woocommerce' ),
		'P5' => __( 'Lumbini', 'woocommerce' ),
		'P6' => __( 'Karnali', 'woocommerce' ),
		'P7' => __( 'Sudurpashchim', 'woocommerce' ),
	),
