...
return array(
	...
	'VN' => array( // Ref: https://www.gso.gov.vn/phuong-phap-thong-ke/danh-muc/don-vi-hanh-chinh/
		...
		'BAC-KAN'         => __( 'Bac Kan', 'woocommerce' ),
		'BAC-GIANG'       => __( 'Bac Giang', 'woocommerce' ),
		'BAC-NINH'        => __( 'Bac Ninh', 'woocommerce' ),
		'BEN-TRE'         => __( 'Ben Tre', 'woocommerce' ),
		'BINH-DUONG'      => __( 'Binh Duong', 'woocommerce' ),
		'BINH-DINH'       => __( 'Binh Dinh', 'woocommerce' ),
		'BINH-PHUOC'      => __( 'Binh Phuoc', 'woocommerce' ),
		'BINH-THUAN'      => __( 'Binh Thuan', 'woocommerce' ),
		'CA-MAU'          => __( 'Ca Mau', 'woocommerce' ),
		'CAO-BANG'        => __( 'Cao Bang', 'woocommerce' ),
		'CAN-THO'         => __( 'Can Tho', 'woocommerce' ),
		'DA-NANG'         => __( 'Da Nang', 'woocommerce' ),
		'DAK-LAK'         => __( 'Dak Lak', 'woocommerce' ),
		'DAK-NONG'        => __( 'Dak Nong', 'woocommerce' ),
		'DONG-NAI'        => __( 'Dong Nai', 'woocommerce' ),
		'DONG-THAP'       => __( 'Dong Thap', 'woocommerce' ),
		'DIEN-BIEN'       => __( 'Dien Bien', 'woocommerce' ),
		'GIA-LAI'         => __( 'Gia Lai', 'woocommerce' ),
		'HA-GIANG'        => __( 'Ha Giang', 'woocommerce' ),
		'HA-NAM'          => __( 'Ha Nam', 'woocommerce' ),
		'HA-NOI'          => __( 'Ha Noi', 'woocommerce' ),
		'HA-TINH'         => __( 'Ha Tinh', 'woocommerce' ),
		'HAI-DUONG'       => __( 'Hai Duong', 'woocommerce' ),
		'HAI-PHONG'       => __( 'Hai Phong', 'woocommerce' ),
		'HOA-BINH'        => __( 'Hoa Binh', 'woocommerce' ),
		'HAU-GIANG'       => __( 'Hau Giang', 'woocommerce' ),
		'HUNG-YEN'        => __( 'Hung Yen', 'woocommerce' ),
		'HO-CHI-MINH'     => __( 'Ho Chi Minh', 'woocommerce' ),
		'KHANH-HOA'       => __( 'Khanh Hoa', 'woocommerce' ),
		'KIEN-GIANG'      => __( 'Kien Giang', 'woocommerce' ),
		'KON-TUM'         => __( 'Kon Tum', 'woocommerce' ),
		'LAI-CHAU'        => __( 'Lai Chau', 'woocommerce' ),
		'LAO-CAI'         => __( 'Lao Cai', 'woocommerce' ),
		'LANG-SON'        => __( 'Lang Son', 'woocommerce' ),
		'LAM-DONG'        => __( 'Lam Dong', 'woocommerce' ),
		'LONG-AN'         => __( 'Long An', 'woocommerce' ),
		'NAM-DINH'        => __( 'Nam Dinh', 'woocommerce' ),
		'NGHE-AN'         => __( 'Nghe An', 'woocommerce' ),
		'NINH-BINH'       => __( 'Ninh Binh', 'woocommerce' ),
		'NINH-THUAN'      => __( 'Ninh Thuan', 'woocommerce' ),
		'PHU-THO'         => __( 'Phu Tho', 'woocommerce' ),
		'PHU-YEN'         => __( 'Phu Yen', 'woocommerce' ),
		'QUANG-BINH'      => __( 'Quang Binh', 'woocommerce' ),
		'QUANG-NAM'       => __( 'Quang Nam', 'woocommerce' ),
		'QUANG-NGAI'      => __( 'Quang Ngai', 'woocommerce' ),
		'QUANG-NINH'      => __( 'Quang Ninh', 'woocommerce' ),
		'QUANG-TRI'       => __( 'Quang Tri', 'woocommerce' ),
		'SOC-TRANG'       => __( 'Soc Trang', 'woocommerce' ),
		'SON-LA'          => __( 'Son La', 'woocommerce' ),
		'TAY-NINH'        => __( 'Tay Ninh', 'woocommerce' ),
		'THAI-BINH'       => __( 'Thai Binh', 'woocommerce' ),
		'THAI-NGUYEN'     => __( 'Thai Nguyen', 'woocommerce' ),
		'THANH-HOA'       => __( 'Thanh Hoa', 'woocommerce' ),
		'THUA-THIEN-HUE'  => __( 'Thua Thien - Hue', 'woocommerce' ),
		'TIEN-GIANG'      => __( 'Tien Giang', 'woocommerce' ),
		'TRA-VINH'        => __( 'Tra Vinh', 'woocommerce' ),
		'TUYEN-QUANG'     => __( 'Tuyen Quang', 'woocommerce' ),
		'VINH-LONG'       => __( 'Vinh Long', 'woocommerce' ),
		'VINH-PHUC'       => __( 'Vinh Phuc', 'woocommerce' ),
		'YEN-BAI'         => __( 'Yen Bai', 'woocommerce' ),
	),
	'YT' => array(),
