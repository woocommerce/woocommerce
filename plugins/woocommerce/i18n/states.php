...
return array(
	...
	'SV' => array( // El Salvador states.
		'SV-AH' => __( 'Alba', 'woocommerce' ),
		'SV-CA' => __( 'Arad', 'woocommerce' ),
		'SV-CH' => __( 'Argeș', 'woocommerce' ),
		'SV-CU' => __( 'Bacău', 'woocommerce' ),
		'SV-LI' => __( 'Bihor', 'woocommerce' ),
		'SV-MO' => __( 'Brăila', 'woocommerce' ),
		'SV-PA' => __( 'Bistrița-Năsăud', 'woocommerce' ),
		'SV-SA' => __( 'Călărași', 'woocommerce' ),
		'SV-SM' => __( 'Brașov', 'woocommerce' ),
		'SV-SO' => __( 'Caraș-Severin', 'woocommerce' ),
		'SV-SS'  => __( 'București', 'woocommerce' ),
		'SV-SV' => __( 'Buzău', 'woocommerce' ),
		'SV-UN' => __( 'Botoșani', 'woocommerce' ),
		'SV-US' => __( 'Cluj', 'woocommerce' ),
	),
