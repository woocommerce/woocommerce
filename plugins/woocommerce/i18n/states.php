...
return array(
	...
	'CO' => array( // Colombian Republic.
		...
		'ANT' => __( 'Antioquia', 'woocommerce' ),
		'ARA' => __( 'Arauca', 'woocommerce' ),
		'ATL' => __( 'Atlántico', 'woocommerce' ),
		'BOL' => __( 'Bolívar', 'woocommerce' ),
		'BOY' => __( 'Boyacá', 'woocommerce' ),
		'CAL' => __( 'Caldas', 'woocommerce' ),
		'CAQ' => __( 'Caquetá', 'woocommerce' ),
		'CAS' => __( 'Casanare', 'woocommerce' ),
		'CAU' => __( 'Cauca', 'woocommerce' ),
		'CES' => __( 'Cesar', 'woocommerce' ),
		'CHO' => __( 'Chocó', 'woocommerce' ),
		'CUN' => __( 'Cundinamarca', 'woocommerce' ),
		'COR' => __( 'Córdoba', 'woocommerce' ),
		'DC' => __( 'Distrito Capital de Bogotá	Distrito Capital', 'woocommerce' ),
		'GUA' => __( 'Guainía', 'woocommerce' ),
		'GUV' => __( 'Guaviare', 'woocommerce' ),
		'HUI' => __( 'Huila', 'woocommerce' ),
		'LAG' => __( 'La Guajira', 'woocommerce' ),
		'MAG' => __( 'Magdalena', 'woocommerce' ),
		'MET' => __( 'Meta', 'woocommerce' ),
		'NAR' => __( 'Nariño', 'woocommerce' ),
		'NSA' => __( 'Norte de Santander', 'woocommerce' ),
		'PUT' => __( 'Putumayo', 'woocommerce' ),
		'QUI' => __( 'Quindío', 'woocommerce' ),
		'RIS' => __( 'Risaralda', 'woocommerce' ),
		'SAP' => __( 'San Andrés, Providencia y Santa Catalina	San Andrés', 'woocommerce' ),
		'SAN' => __( 'Santander', 'woocommerce' ),
		'SUC' => __( 'Sucre', 'woocommerce' ),
		'TOL' => __( 'Tolima', 'woocommerce' ),
		'VAC' => __( 'Valle del Cauca	Valle', 'woocommerce' ),
		'VAU' => __( 'Vaupés', 'woocommerce' ),
		'VID' => __( 'Vichada', 'woocommerce' )
	),
	'CZ' => array(),
	'DE' => array(),
	'DK' => array(),
