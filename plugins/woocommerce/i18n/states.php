...
return array(
	...
	'XK' => array( // Kosovo states.
		'XK-01' => __( 'Prishtina', 'woocommerce' ),
		'XK-09' => __( 'Mitrovicë', 'woocommerce' ),
		'XK-02' => __( 'Prizren', 'woocommerce' ),
		'XK-03' => __( 'Ferizaj', 'woocommerce' ),
		'XK-04' => __( 'Pejë', 'woocommerce' ),
		'XK-05' => __( 'Gjakovë', 'woocommerce' ),
		'XK-06' => __( 'Gjilan', 'woocommerce' ),
		'XK-07' => __( 'Podujeva', 'woocommerce' ),
		'XK-08' => __( 'Vushtrri', 'woocommerce' ),
		'XK-10' => __( 'Suharekë', 'woocommerce' ),
		'XK-11' => __( 'Rahovec', 'woocommerce' ),
		'XK-12' => __( 'Drenas', 'woocommerce' ),
		'XK-13' => __( 'Lipjan', 'woocommerce' ),
		'XK-14' => __( 'Malishevë', 'woocommerce' ),
		'XK-15' => __( 'Kamenicë', 'woocommerce' ),
		'XK-16' => __( 'Viti', 'woocommerce' ),
		'XK-17' => __( 'Deçan', 'woocommerce' ),
		'XK-18' => __( 'Istog', 'woocommerce' ),
		'XK-19' => __( 'Klinë', 'woocommerce' ),
		'XK-20' => __( 'Skenderaj', 'woocommerce' ),
		'XK-21' => __( 'Dragash', 'woocommerce' ),
		'XK-22' => __( 'Fushë Kosovë', 'woocommerce' ),
		'XK-23' => __( 'Kaçanik', 'woocommerce' ),
		'XK-24' => __( 'Mitrovica Veriore', 'woocommerce' ),
		'XK-25' => __( 'Shtime', 'woocommerce' ),
		'XK-26' => __( 'Obiliq', 'woocommerce' ),
		'XK-27' => __( 'Leposaviq', 'woocommerce' ),
		'XK-28' => __( 'Graçanicë', 'woocommerce' ),
		'XK-29' => __( 'Han i Elezit', 'woocommerce' ),
		'XK-30' => __( 'Zveçan', 'woocommerce' ),
		'XK-31' => __( 'Shtërpcë', 'woocommerce' ),
		'XK-32' => __( 'Novobërdë', 'woocommerce' ),
		'XK-33' => __( 'Zubin Potok', 'woocommerce' ),
		'XK-34' => __( 'Junik', 'woocommerce' ),
		'XK-35' => __( 'Mamusha', 'woocommerce' ),
		'XK-36' => __( 'Ranillug', 'woocommerce' ),
		'XK-37' => __( 'Kllokotë', 'woocommerce' ),
		'XK-38' => __( 'Parteshi', 'woocommerce' ),
	),
