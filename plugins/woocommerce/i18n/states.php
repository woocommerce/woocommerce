...
return array(
	...
	'MA' => array( // Moroccan regions.
			'ma01'  => __( 'Tangier-Tétouan', 'woocommerce' ),
			'ma02'  => __( 'Gharb-Chrarda-Béni Hssen', 'woocommerce' ),
			'ma03'  => __( 'Taza-Al Hoceima-Taounate', 'woocommerce' ),  
			'ma04'  => __( 'Oriental', 'woocommerce' ),
			'ma05'  => __( 'Fès-Boulemane', 'woocommerce' ),
			'ma06'  => __( 'Meknès-Tafilalet', 'woocommerce' ),
			'ma07'  => __( 'Rabat-Salé-Zemmour-Zaer', 'woocommerce' ),
			'ma08'  => __( 'Grand Casablanca', 'woocommerce' ),
			'ma09'  => __( 'Chaouia-Ouardigha', 'woocommerce' ),
			'ma10'  => __( 'Doukkala-Abda', 'woocommerce' ),
			'ma11'  => __( 'Marrakesh-Tensift-El Haouz', 'woocommerce' ),
			'ma12'  => __( 'Tadla-Azilal', 'woocommerce' ),
			'ma13'  => __( 'Souss-Massa-Drâa', 'woocommerce' ),
			'ma14'  => __( 'Guelmim-Es Semara', 'woocommerce' ),
			'ma15'  => __( 'Laâyoune-Boujdour-Sakia El Hamra', 'woocommerce' ),
			'ma16'  => __( 'Oued Ed-Dahab-Lagouira', 'woocommerce' ),
			'maagd' => __( 'Agadir-Ida Ou Tanane', 'woocommerce' ),
			'maaou' => __( 'Aousserd', 'woocommerce' ),
			'maasz' => __( 'Assa-Zag', 'woocommerce' ),
			...
			'maesi' => __( 'Essaouira', 'woocommerce' ),
			'maesm' => __( 'Es Semara', 'woocommerce' ),
