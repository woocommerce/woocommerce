...
class WC_Tests_Formatting_Functions extends WC_Unit_Test_Case {
	...
	public function test_wc_price() {
		...
		// Aria hidden option.
		$this->assertEquals( '<span class="woocommerce-Price-amount amount" aria-hidden="true"><bdi>-<span class="woocommerce-Price-currencySymbol">&#36;</span>1.17</bdi></span>', wc_price( -1.17, array( 'aria_hidden' => true ) ) );
