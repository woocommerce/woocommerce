...
export const base_url = __ENV.URL || 'https://wcnightlysmoketest.wpcomstaging.com';
export const base_host = __ENV.HOST || 'wcnightlysmoketest.wpcomstaging.com';

export const admin_username = __ENV.A_USER || 'smoketest';
export const admin_password = __ENV.A_PW || 'y$!zBaI6cq2aQsuY^XCGTCv4';
export const admin_acc_login = __ENV.A_ACC_LOGIN || false;

export const customer_username =
	__ENV.C_USER || 'tam.mullen+wcnightcustomer@automattic.com';
export const customer_password = __ENV.C_PW || 'bcpXR5xvSXL)iOI%b%h*FGrq';
export const customer_user_id = __ENV.C_UID || '2';

//export const cot_status = __ENV.COT || false;
export const cot_status = __ENV.COT === 'true';
...
export const product_id = __ENV.P_ID || '22733';
