				...
				expect.objectContaining( {
					...
					settings: {
						...
						enable_for_methods: expect.objectContaining( {
							...
							description:
								'If Direct bank transfer is only available for certain methods, set it up here. Leave blank to enable for all methods.',
							type: 'multiselect',
							value: '',
							default: '',
						} ),
				...
				expect.objectContaining( {
					...
					settings: {
						...
						enable_for_methods: expect.objectContaining( {
							...
							label: 'Enable for shipping methods',
							description:
								'If Check payments is only available for certain methods, set it up here. Leave blank to enable for all methods.',
							type: 'multiselect',
							value: '',
							default: '',
						} ),
