...
import CheckoutActionsBlock from '../../client/blocks/assets/js/blocks/checkout/inner-blocks/checkout-actions-block/block';
...
describe( 'CheckoutActionsBlock', () => {
	...
	it( 'renders custom payment method place order button when provided', () => {
		const CustomPlaceOrderButton = ( props ) => (
			<button data-testid="custom-place-order-button" { ...props }>
				Custom Place Order
			</button>
		);
