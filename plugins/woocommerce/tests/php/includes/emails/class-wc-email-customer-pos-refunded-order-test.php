...
class WC_Email_Customer_POS_Refunded_Order_Test extends \WC_Unit_Test_Case {
	...
	/**
	 * @testdox POS refunded email displays unit price in the quantity column.
	 */
	public function test_pos_email_displays_unit_price_in_quantity_column() {
		...
		// When getting content from POS refunded and regular emails.
		$pos_email     = new WC_Email_Customer_POS_Refunded_Order();
		$regular_email = new WC_Email_Customer_Refunded_Order();
	...
	/**
	 * @testdox POS refunded email displays unit price below the product name without email improvements.
	 */
