...
class WC_Email_Customer_Checkout_Recovery_Test extends \WC_Unit_Test_Case {
	...
	public function test_trigger_records_sent_at_meta(): void {
		...
		$saved = $fresh->get_meta( WC_Email_Customer_Checkout_Recovery::META_KEY_SENT_AT );
	...
	public function test_trigger_bails_when_recipient_unsubscribed(): void {
		...
		$repository->mark_unsubscribed( $order->get_billing_email(), 'customer_checkout_recovery' );
