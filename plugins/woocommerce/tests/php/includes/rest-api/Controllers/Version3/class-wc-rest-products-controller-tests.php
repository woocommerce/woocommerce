...
class WC_REST_Products_Controller_Tests extends WC_Unit_Test_Case {
	...
	/**
	 * @testdox Creating a product with a custom attribute using a reserved structural key name is rejected.
	 */
	public function test_create_product_blocks_reserved_custom_attribute_name() {
		$request = new WP_REST_Request( 'POST', '/wc/v3/products' );
		$request->set_body_params(
			array(
				'name'       => 'Reserved Attribute Product',
				'type'       => 'variable',
				'attributes' => array(
					array(
						'name'      => 'Variation',
	...
	/**
	 * @testdox Updating a product that already has a reserved custom attribute name is allowed (grandfathered).
	 */
