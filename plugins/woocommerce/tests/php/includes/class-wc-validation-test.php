...
class WC_Validation_Test extends \WC_Unit_Test_Case {
	...
	public function data_provider_test_is_postcode(): array {
		...
		$prefix = array(
			...
			array( true, '2640', 'AI' ),
			array( true, 'AI-2640', 'AI' ),
			array( false, 'AIAI2640', 'AI' ),
			array( false, 'AI-AI-2640', 'AI' ),
			array( true, '00100', 'FI' ),
			array( true, 'FI-00100', 'FI' ),
			array( false, 'FIFI00100', 'FI' ),
			array( false, 'FI-FI-00100', 'FI' ),
			array( true, '10000', 'HR' ),
			array( true, 'HR-10000', 'HR' ),
			array( false, 'HRHR10000', 'HR' ),
			array( false, 'HR-HR-10000', 'HR' ),
			array( true, '12345', 'SE' ),
			array( true, 'SE-12345', 'SE' ),
			array( false, 'SESE12345', 'SE' ),
			array( false, 'SE-SE-12345', 'SE' ),
			array( true, '01100', 'LT' ),
			array( true, 'LT-01100', 'LT' ),
			array( false, 'LTLT01100', 'LT' ),
			array( false, 'LT-LT-01100', 'LT' ),
			array( true, 'AD500', 'AD' ),
			array( false, 'ADAD500', 'AD' ),
			array( true, 'BB11000', 'BB' ),
			array( false, 'BBBB11000', 'BB' ),
			array( true, 'IM11AA', 'IM' ),
			array( false, 'IMIM11AA', 'IM' ),
			array( true, 'JE11AA', 'JE' ),
			array( false, 'JEJE11AA', 'JE' ),
			array( true, 'KY11200', 'KY' ),
			array( false, 'KYKY11200', 'KY' ),
			array( true, 'VC0100', 'VC' ),
			array( false, 'VCVC0100', 'VC' ),
			array( true, 'VG1110', 'VG' ),
			array( false, 'VGVG1110', 'VG' ),
			array( false, 'FIAX22100', 'FI' ),
			array( false, 'AXAX22100', 'FI' ),
			array( false, 'LVLV1050', 'LV' ),
			array( false, 'SISI1000', 'SI' ),
		);
