...
/**
 * Tests for free shipping coupon functionality on manual orders.
 * 
 * Tests the specific functionality where free shipping coupons should be applied
 * to manually created orders, reducing shipping costs to zero when applied.
 * 
 * Created for: https://github.com/woocommerce/woocommerce/issues/24081
 *
 * @package WooCommerce\Tests
 */
class WC_Free_Shipping_Coupon_Manual_Order_Test extends WC_Unit_Test_Case {

	/**
	 * Test that free shipping coupon is applied correctly to manual orders.
	 * 
	 * This test validates the core issue reported in GitHub issue #24081:
	 * Free shipping coupons should reduce shipping costs to zero when applied
	 * to manually created orders in the admin interface.
	 */
	 ...
	 * 
	 * This simulates the exact scenario from the GitHub issue where shipping
	 * is manually added to an order via the admin interface.
	 */
