...
class AgenticCheckoutUtilsTest extends \WC_Unit_Test_Case {
	...
	/**
	 * Test validate_jetpack_request returns error when Jetpack class is not available.
	 */
	public function test_validate_jetpack_request_returns_error_without_jetpack() {
		// Test validation without Jetpack (class not available or method returns false).
