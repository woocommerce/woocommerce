...
class MockShopifyData {
			...
			$products[] = (object) array(
				'node' => (object) array(
					...
					'featuredMedia'   => (object) array(
						...
						'image' => (object) array(
							'url'     => "https://cdn.shopify.com/test-image-{$i}-featured.jpg",
						...
						'edges' => array(
							(object) array(
								'node' => (object) array(
									'id'    => "gid://shopify/MediaImage/{$i}1",
									'image' => (object) array(
										'url'     => "https://cdn.shopify.com/test-image-{$i}-1.jpg",
							...
							(object) array(
								'node' => (object) array(
									...
									'image' => (object) array(
										'url'     => "https://cdn.shopify.com/test-image-{$i}-2.jpg",
						...
						'edges' => array(
							(object) array(
								'node' => (object) array(
									...
									'image' => (object) array(
										'url'     => "https://cdn.shopify.com/test-variant-{$product_id}-{$v}.jpg",
	...
	public static function get_mock_wc_product_data( int $product_id = 1 ): array {
		return array(
			...
			'images'             => array(
				array(
					'src' => "https://cdn.shopify.com/test-image-{$product_id}-featured.jpg",
					'alt' => "Test Product {$product_id} Featured Image",
				),
				array(
					'src' => "https://cdn.shopify.com/test-image-{$product_id}-1.jpg",
