...
/**
 * Test cases for SetupCommand.
 */
class SetupCommandTest extends \WC_Unit_Test_Case {

	/**
	 * The SetupCommand instance under test.
	 *
	 * @var SetupCommand
	 */
	...
	/**
	 * Test that SetupCommand can be instantiated.
	 */
	public function test_setup_command_instantiation() {
		$this->assertInstanceOf( SetupCommand::class, $this->command );
	}
