...
class TaxDebugTest extends \WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		// Override any leaked constants from other tests (e.g., coupon tests define WOOCOMMERCE_CHECKOUT).
		// Constants::set_constant() takes precedence over native define() when checking via Constants::is_defined().
		Constants::set_constant( 'WOOCOMMERCE_CHECKOUT', false );
		Constants::set_constant( 'WC_DOING_AJAX', false );

		// Remove any existing TaxDebug hooks to prevent interference from container instance.
