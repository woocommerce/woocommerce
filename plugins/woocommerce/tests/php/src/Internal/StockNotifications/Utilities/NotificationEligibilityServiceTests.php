 ...
 */
class NotificationEligibilityServiceTests extends \WC_Unit_Test_Case {

	/**
	 * @var NotificationEligibilityServiceTests
	 */
	private $sut;
	...
	public function setUp(): void {
		...
		$this->sut               = new NotificationEligibilityService();
	...
	public function test_should_skip_notification(): void {
		...
		// Less than threshold.
		$notification->set_date_notified( time() - NotificationEligibilityService::SPAM_THRESHOLD - 1 );
		$this->assertFalse( $this->sut->should_skip_notification( $notification, $product ) );
