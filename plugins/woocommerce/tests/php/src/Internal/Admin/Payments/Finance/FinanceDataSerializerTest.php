...
class FinanceDataSerializerTest extends WC_Unit_Test_Case {
	...
	public function test_serializes_page_envelope(): void {
		$page = new FinanceDataPage( array( new Balance( 'USD', '1.00' ) ), true, 'next-cursor', 'prev-cursor' );
	...
	public function test_serializes_balance_with_optionals(): void {
		$balance = ( new Balance( 'usd', '1234.56' ) )
	...
	public function test_serializes_balance_without_optionals(): void {
		$this->assertSame(
			...
			$this->sut->serialize_balance( new Balance( 'EUR', '-5.00' ) )
		);
	}
	...
	public function test_serializes_payout_with_optionals(): void {
		$payout = ( new Payout( 'po_1', 'gbp', '250.00', PayoutStatus::COMPLETE, new \DateTimeImmutable( '2026-09-01T12:00:00+00:00' ), new \DateTimeImmutable( '2026-09-03T00:00:00+00:00' ), 'paid' ) )
	...
	public function test_serializes_payout_without_optionals(): void {
		$payout = new Payout( 'po_2', 'USD', '10.00', PayoutStatus::PENDING, new \DateTimeImmutable( '2026-09-01T12:00:00+00:00' ) );
	...
	public function test_serializes_dates_in_utc( \DateTimeInterface $date, string $expected ): void {
		$payout = new Payout( 'po_1', 'USD', '1.00', PayoutStatus::PENDING, $date );
