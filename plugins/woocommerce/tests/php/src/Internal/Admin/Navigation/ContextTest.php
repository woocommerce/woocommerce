...
// phpcs:disable WordPress.WP.GlobalVariablesOverride.Prohibited, Squiz.Commenting.FunctionComment.Missing, Squiz.Commenting.InlineComment.InvalidEndChar -- Test sets WP globals for fixtures; setUp/tearDown self-document.
...
class ContextTest extends \WC_Unit_Test_Case {
	...
	public function test_taxonomy_page_matches_full_url_slug() {
		...
		$tree               = array(
			...
			'edit-tags.php?taxonomy=product_brand&post_type=product' => array(
