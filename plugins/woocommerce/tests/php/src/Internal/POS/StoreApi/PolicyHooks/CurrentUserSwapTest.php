...
class CurrentUserSwapTest extends WC_Unit_Test_Case {
	...
	public function test_register_skips_filter_outside_pos_context(): void {
		...
		$this->assertFalse( has_filter( 'rest_dispatch_request', array( $this->sut, 'swap_to_guest' ) ) );
	}

	/**
	 * @testdox swap_to_guest sets current_user to 0.
	 */
	public function test_swaps_to_guest(): void {
