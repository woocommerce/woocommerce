...
use Automattic\WooCommerce\Fulfillments\FulfillmentsSettings;
use WC_Order;
...
class FulfillmentsSettingsTest extends WC_Unit_Test_Case {
	...
	public function test_auto_fulfill_items_on_completed_calls_hook_with_item_and_setting_combinations() {
		$mock_sut = $this->getMockBuilder( \Automattic\WooCommerce\Fulfillments\FulfillmentsSettings::class )
