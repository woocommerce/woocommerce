...
- What the `allure-results` and `allure-report` folders are, and how they're different
...
If you're on WSL however, you might get this message right after running the `allure open` command:
```
Starting web server...
