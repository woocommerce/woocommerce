const ar_AR = {
    ...
    '/Adjusted stock: Product with Stock \(10→8\)/': /Adjusted stock: Product with Stock \(10→8\)/,
        ...
        arrExpectedSections: [ 'المخططات والرسوم البيانية', 'لوحات الصدارة', 'الأداء' ],
        'Attributes': 'السمات',
    ...
    'expectedGroupProductsAddedMessage': 'تم إضافة “Simple single product 1” و “Simple single product 2” إلى سلة مشترياتك.',
    ...
    '/Item #\d+ stock increased from 8 to 10./': /كمية العنصر #\d+ ازداد من 8 إلى 10./,
    ...
    '/Stock levels reduced: Product with stock \(#\d+\) 10→8/': /انخفاض مستويات المخزون: Product with stock \(#\d+\) 10→8/,
        ...
        'What type of products will be listed?': 'ما نوع المنتجات التي سيتم إدراجها؟',
        'Width': 'العرض',
