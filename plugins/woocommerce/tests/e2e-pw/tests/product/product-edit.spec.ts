...
async function saveProductChanges( page: Page ): Promise< void > {
	await page
...
async function saveBulkProductChanges( page: Page ): Promise< void > {
...
async function selectProduct( page: Page, product: Product ): Promise< void > {
	await page
...
test( 'can edit a product and save the changes', async ( {
	...
	const newProduct = getFakeProduct() as FakeProduct;
