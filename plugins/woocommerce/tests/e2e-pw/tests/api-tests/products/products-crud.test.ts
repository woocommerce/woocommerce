...
const test = baseTest.extend< {
	...
	simpleTestProduct: SimpleProduct;
} >( {
	extraHTTPHeaders: {
	...
	simpleTestProduct: async ( { request }, use ) => {
		let simpleTestProduct: SimpleProduct = {
			id: 0,
...
test.describe( 'Products API tests: CRUD', () => {
	test( 'can add a simple product', async ( { request } ) => {
		...
		const responseJSON: SimpleProduct = await response.json();
	...
	test.describe( 'Product attributes tests: CRUD', () => {
		...
		test( 'can add a product attribute', async ( { request } ) => {
			...
			const responseJSON: ProductAttribute = await response.json();
		...
		test.describe( 'Product attribute terms tests: CRUD', () => {
			...
			test( 'can add a product attribute term', async ( { request } ) => {
				...
				const responseJSON: ProductAttributeTerm =
					await response.json();
			...
			test( 'can batch update product attribute terms', async ( {
				...
				const responseJSON: BatchResponse< ProductAttributeTerm > =
					await response.json();
				expect( response.status() ).toEqual( 200 );
				...
				const responseBatchUpdateJSON: BatchResponse< ProductAttributeTerm > =
				...
				const responseUpdatedTerm1JSON: ProductAttributeTerm =
		...
		test( 'can batch update product attributes', async ( { request } ) => {
			...
			const responseJSON: BatchResponse< ProductAttribute > =
				await response.json();
			expect( response.status() ).toEqual( 200 );
			...
			const responseBatchUpdateJSON: BatchResponse< ProductAttribute > =
				await responseBatchUpdate.json();
			...
			const responseUpdatedAttribute1JSON: ProductAttribute =
	...
	test.describe( 'Product categories tests: CRUD', () => {
		...
		test( 'can add a product category', async ( { request } ) => {
			...
			const responseJSON: ProductCategory = await response.json();
		...
		test( 'can batch update product categories', async ( { request } ) => {
			...
			const responseJSON: BatchResponse< ProductCategory > =
				await response.json();
			expect( response.status() ).toEqual( 200 );
			...
			const responseBatchUpdateJSON: BatchResponse< ProductCategory > =
				await responseBatchUpdate.json();
			...
			const responseUpdatedCategoryJSON: ProductCategory =
	...
	test.describe( 'Product review tests: CRUD', () => {
		...
		let reviewsTestProduct: SimpleProduct;
		...
		test( 'can add a product review', async ( { request } ) => {
			...
			const responseJSON: ProductReview = await response.json();
		...
		test( 'can batch update product reviews', async ( { request } ) => {
			...
			const responseJSON: BatchResponse< ProductReview > =
				await response.json();
			expect( response.status() ).toEqual( 200 );
			...
			const responseBatchUpdateJSON: BatchResponse< ProductReview > =
				await responseBatchUpdate.json();
			...
			const responseUpdatedReviewJSON: ProductReview =
	...
	test.describe( 'Product shipping classes tests: CRUD', () => {
		...
		test( 'can add a product shipping class', async ( { request } ) => {
			...
			const responseJSON: ProductShippingClass = await response.json();
		...
		test( 'can batch update product shipping classes', async ( {
			...
			const responseJSON: BatchResponse< ProductShippingClass > =
				await response.json();
			expect( response.status() ).toEqual( 200 );
			...
			const responseBatchUpdateJSON: BatchResponse< ProductShippingClass > =
				await responseBatchUpdate.json();
			...
			const responseUpdatedShippingClassJSON: ProductShippingClass =
	...
	test.describe( 'Product tags tests: CRUD', () => {
		...
		test( 'can add a product tag', async ( { request } ) => {
			...
			const responseJSON: ProductTag = await response.json();
		...
		test( 'can batch update product tags', async ( { request } ) => {
			...
			const responseJSON: BatchResponse< ProductTag > =
				await response.json();
			expect( response.status() ).toEqual( 200 );
			...
			const responseBatchUpdateJSON: BatchResponse< ProductTag > =
				await responseBatchUpdate.json();
			...
			const responseUpdatedTag1JSON: ProductTag =
				await responseUpdatedTag1.json();
			...
			const responseUpdatedTag2JSON: ProductTag =
				await responseUpdatedTag2.json();
	...
	test.describe( 'Product variation tests: CRUD', () => {
		...
		test( 'can add a product variation', async ( { request } ) => {
			...
			const responseJSON: ProductVariation = await response.json();
		...
		test( 'can batch update product variations', async ( { request } ) => {
			...
			const responseJSON: BatchResponse< ProductVariation > =
				await response.json();
			expect( response.status() ).toEqual( 200 );
			...
			expect( response.status() ).toEqual( 200 );
			const responseBatchUpdateJSON: BatchResponse< ProductVariation > =
				await responseBatchUpdate.json();
			...
			const responseUpdatedVariationJSON: ProductVariation =
	...
	test( 'can delete a product', async ( { request } ) => {
		...
		const product: SimpleProduct = await createProductResponse.json();
	...
	test.describe( 'Batch update products', () => {
		...
		test( 'can batch create products', async ( { request } ) => {
			...
			const responseJSON: BatchResponse< SimpleProduct > =
				await response.json();
