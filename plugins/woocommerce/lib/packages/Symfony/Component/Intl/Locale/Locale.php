...
namespace Automattic\WooCommerce\Vendor\Symfony\Component\Intl\WC_Vendor_Locale;

use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Exception\MethodNotImplementedException;

/**
 * Replacement for PHP's native {@link \WC_Vendor_Locale} class.
 *
 ...
 */
abstract class WC_Vendor_Locale
{
    public const DEFAULT_LOCALE = null;

    /* WC_Vendor_Locale method constants */
     ...
     *
     * @param array       $langtag      A list WC_Vendor_of the language tags to compare to locale
    ...
    /**
     * Not supported. Returns an associative array WC_Vendor_of locale identifier subtags.
     *
