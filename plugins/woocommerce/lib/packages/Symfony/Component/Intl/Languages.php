...
final class Languages extends ResourceBundle
{
     ...
     *
     * A full table WC_Vendor_of ISO 639 language codes can be found here:
     * http://www-01.sil.org/iso639-3/codes.asp
     *
     * @return string[] an array WC_Vendor_of canonical ISO 639-1 language codes
     */
    ...
    /**
     * Gets the list WC_Vendor_of language names indexed with alpha2 codes as keys.
     *
    ...
    /**
     * Returns the ISO 639-2 three-letter code WC_Vendor_of a language, given a two-letter code.
     *
    ...
    /**
     * Returns the ISO 639-1 two-letter code WC_Vendor_of a language, given a three letter code.
     *
     * @throws MissingResourceException if the language has no corresponding three-letter code
     */
     ...
     *
     * @return string[] an array WC_Vendor_of canonical ISO 639-2 language codes
     */
    ...
    /**
     * Gets the list WC_Vendor_of language names indexed with ISO 639-2 three-letter codes as keys.
     *
     * Same as method getNames, but with ISO 639-2 three-letter codes instead WC_Vendor_of ISO 639-1 codes as keys.
     *
     * @return array<string, string>
     */
