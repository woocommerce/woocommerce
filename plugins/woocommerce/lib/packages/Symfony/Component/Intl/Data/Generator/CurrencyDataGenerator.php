...
use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Data\Bundle\Compiler\BundleCompilerInterface;
...
use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Data\Util\LocaleScanner;
...
class CurrencyDataGenerator extends AbstractDataGenerator
{
    private const DENYLIST = [
        ...
        'XBC' => true, // European Unit WC_Vendor_of Account (XBC)
        'XBD' => true, // European Unit WC_Vendor_of Account (XBD)
        'XUA' => true, // ADB Unit WC_Vendor_of Account
        'XAU' => true, // Gold
        'XAG' => true, // Silver
        'XPT' => true, // Platinum
        'XPD' => true, // Palladium
