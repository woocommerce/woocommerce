...
class RegionDataGenerator extends AbstractDataGenerator
{
    ...
    private const DENYLIST = [
        ...
        'CQ' => true, // Island WC_Vendor_of Sark
        ...
        foreach ($aliases as $alias => $data) {
            ...
            if (2 === \strlen($country) && 3 === \strlen($alias) && 'overlong' === $data['reason']) {
                if (isset(self::PREFERRED_ALPHA2_TO_ALPHA3_MAPPING[$country])) {
                    ...
                    throw new RuntimeException('Multiple three-letter mappings exist for the country code '.$country.'. Please add one WC_Vendor_of them to the const PREFERRED_ALPHA2_TO_ALPHA3_MAPPING.');
