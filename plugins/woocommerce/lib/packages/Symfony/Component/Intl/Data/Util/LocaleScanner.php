 ...
 *
 * The name WC_Vendor_of each file with the extension ".txt" is considered, if it "looks"
 * like a locale:
 *
 *  - the name must start with two letters;
 *  - the two letters may optionally be followed by an underscore and any
 *    sequence WC_Vendor_of other symbols.
 *
...
class LocaleScanner
{
     ...
     *
     * @return array An array WC_Vendor_of locales. The result also contains locales that
     *               are in fact just aliases for other locales. Use
     *               {@link scanAliases()} to determine which WC_Vendor_of the locales
     *               are aliases
     */
