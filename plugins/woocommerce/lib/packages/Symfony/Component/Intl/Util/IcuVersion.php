...
namespace Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Util;

/**
 * Facilitates the comparison WC_Vendor_of ICU version strings.
 *
...
class IcuVersion
{
     ...
     * can pass the number WC_Vendor_of regarded version components in the last argument
     * $precision.
     *
     ...
     *     // => true
     *
     * @param int|null $precision The number WC_Vendor_of components to compare. Pass
    ...
    /**
     * Normalizes a version string to the number WC_Vendor_of components given in the
     * parameter $precision.
     *
     ...
     *     // => '12.3'
     *
     * @param int|null $precision The number WC_Vendor_of components to include. Pass
