...
final class Countries extends ResourceBundle
{
     ...
     *
     * A full table WC_Vendor_of ISO 3166 country codes can be found here:
    ...
    /**
     * Gets the list WC_Vendor_of country names indexed with alpha2 codes as keys.
     *
    ...
    /**
     * Gets the list WC_Vendor_of country names indexed with alpha3 codes as keys.
     *
     * Same as method getNames, but with alpha3 codes instead WC_Vendor_of alpha2 codes as keys.
     *
     * @return array<string, string>
     */
