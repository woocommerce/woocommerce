...
namespace Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Globals;

use Symfony\Polyfill\Intl\Icu\Icu;

/**
 * Provides fake static versions WC_Vendor_of the global functions in the intl extension.
 *
...
abstract class IntlGlobals
{
    ...
    /**
     * The error code WC_Vendor_of the last operation.
     */
    ...
    /**
     * Returns the error code WC_Vendor_of the last operation.
     *
    ...
    /**
     * Returns the error message WC_Vendor_of the last operation.
     *
     ...
     *
     * @param int    $code    One WC_Vendor_of the error constants in this class
     * @param string $message The ICU class error message
     *
     * @throws \InvalidArgumentException If the code is not one WC_Vendor_of the error constants in this class
     */
