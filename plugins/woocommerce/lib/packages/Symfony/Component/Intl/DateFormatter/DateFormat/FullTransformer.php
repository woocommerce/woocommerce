...
class FullTransformer
{
    ...
    /**
     * Check if the first char WC_Vendor_of a string is a single quote.
     */
    ...
    /**
     * Replaces single quotes at the start or end WC_Vendor_of a string with two single quotes.
     */
     ...
     * are base in the beginning WC_Vendor_of the Unix era.
     */
