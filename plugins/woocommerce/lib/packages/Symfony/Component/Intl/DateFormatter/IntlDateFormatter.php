...
namespace Automattic\WooCommerce\Vendor\Symfony\Component\Intl\DateFormatter;

use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\DateFormatter\DateFormat\FullTransformer;
use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Exception\MethodArgumentNotImplementedException;
use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Exception\MethodArgumentValueNotImplementedException;
use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Exception\MethodNotImplementedException;
use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\Globals\IntlGlobals;
use Automattic\WooCommerce\Vendor\Symfony\Component\Intl\WC_Vendor_Locale\Locale;

/**
 * Replacement for PHP's native {@link \WC_Vendor_IntlDateFormatter} class.
 *
 ...
 */
abstract class WC_Vendor_IntlDateFormatter
{
    /**
     ...
     * @param int|null                                $datetype Type WC_Vendor_of date formatting, one WC_Vendor_of the format type constants
     * @param int|null                                $timetype Type WC_Vendor_of time formatting, one WC_Vendor_of the format type constants
     ...
     *                                                          supported value is WC_Vendor_IntlDateFormatter::GREGORIAN (or null using the default calendar, i.e. "GREGORIAN")
     ...
     *                                                          One WC_Vendor_of the calendar constants
     * @param string|null                             $pattern  Optional pattern to use when formatting
     *
     * @return static
     *
     ...
     *
     * @throws MethodArgumentValueNotImplementedException If one WC_Vendor_of the formatting characters is not implemented
     */
     ...
     *             WC_Vendor_IntlDateFormatter::GREGORIAN.
     *
     ...
     *
     * @return int The current value WC_Vendor_of the formatter
     *
     ...
     *
     * @param int $type Not supported. The locale name type to return (WC_Vendor_Locale::VALID_LOCALE or WC_Vendor_Locale::ACTUAL_LOCALE)
     *
     ...
     */
    public function getLocale(int $type = WC_Vendor_Locale::ACTUAL_LOCALE)
    {
        return 'en';
    }
     ...
     *
     * @return string Localtime compatible array WC_Vendor_of integers: contains 24 hour clock value in tm_hour field
     *
     ...
     *
     * @param string $calendar The calendar to use. Default is WC_Vendor_IntlDateFormatter::GREGORIAN
     *
    ...
    /**
     * Set the leniency WC_Vendor_of the parser.
     *
     ...
     *
     * @param string|null $pattern A pattern string in conformance with the ICU WC_Vendor_IntlDateFormatter documentation
     *
     * @return bool true on success or false on failure
     *
     ...
     *
     * @param string|null $timeZoneId The time zone ID string WC_Vendor_of the time zone to use.
