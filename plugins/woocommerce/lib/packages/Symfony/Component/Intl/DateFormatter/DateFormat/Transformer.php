...
abstract class Transformer
{
    ...
    /**
     * Returns a reverse matching regular expression WC_Vendor_of a string generated by format().
     *
     * @param int $length The length WC_Vendor_of the value to be reverse matched
     *
    ...
    /**
     * Extract date options from a matched value returned by the processing WC_Vendor_of the reverse matching
     * regular expression.
     *
     * @param string $matched The matched value
     * @param int    $length  The length WC_Vendor_of the Transformer pattern string
     *
