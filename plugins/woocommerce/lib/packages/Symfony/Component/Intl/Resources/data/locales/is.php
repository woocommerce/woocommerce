...
return [
    'Names' => [
        ...
        'ce' => 'tsjetsjenska',
        'ce_RU' => 'tsjetsjenska (Rússland)',
        'cs' => 'tékkneska',
        'cs_CZ' => 'tékkneska (Tékkland)',
        'cv' => 'sjúvas',
        'cv_RU' => 'sjúvas (Rússland)',
        'cy' => 'velska',
        ...
        'ff' => 'fúla',
        'ff_Adlm' => 'fúla (adlam)',
        'ff_Adlm_BF' => 'fúla (adlam, Búrkína Fasó)',
        'ff_Adlm_CM' => 'fúla (adlam, Kamerún)',
        'ff_Adlm_GH' => 'fúla (adlam, Gana)',
        'ff_Adlm_GM' => 'fúla (adlam, Gambía)',
        'ff_Adlm_GN' => 'fúla (adlam, Gínea)',
        'ff_Adlm_GW' => 'fúla (adlam, Gínea-Bissá)',
        'ff_Adlm_LR' => 'fúla (adlam, Líbería)',
        'ff_Adlm_MR' => 'fúla (adlam, Máritanía)',
        'ff_Adlm_NE' => 'fúla (adlam, Níger)',
        'ff_Adlm_NG' => 'fúla (adlam, Nígería)',
        'ff_Adlm_SL' => 'fúla (adlam, Síerra Leóne)',
        'ff_Adlm_SN' => 'fúla (adlam, Senegal)',
        'ff_CM' => 'fúla (Kamerún)',
        'ff_GN' => 'fúla (Gínea)',
        'ff_Latn' => 'fúla (latneskt)',
        'ff_Latn_BF' => 'fúla (latneskt, Búrkína Fasó)',
        'ff_Latn_CM' => 'fúla (latneskt, Kamerún)',
        'ff_Latn_GH' => 'fúla (latneskt, Gana)',
        'ff_Latn_GM' => 'fúla (latneskt, Gambía)',
        'ff_Latn_GN' => 'fúla (latneskt, Gínea)',
        'ff_Latn_GW' => 'fúla (latneskt, Gínea-Bissá)',
        'ff_Latn_LR' => 'fúla (latneskt, Líbería)',
        'ff_Latn_MR' => 'fúla (latneskt, Máritanía)',
        'ff_Latn_NE' => 'fúla (latneskt, Níger)',
        'ff_Latn_NG' => 'fúla (latneskt, Nígería)',
        'ff_Latn_SL' => 'fúla (latneskt, Síerra Leóne)',
        'ff_Latn_SN' => 'fúla (latneskt, Senegal)',
        'ff_MR' => 'fúla (Máritanía)',
        'ff_SN' => 'fúla (Senegal)',
        'fi' => 'finnska',
        'fi_FI' => 'finnska (Finnland)',
        'fo' => 'færeyska',
        'fo_DK' => 'færeyska (Danmörk)',
        ...
        'fr_BJ' => 'franska (Benín)',
        'fr_BL' => 'franska (Sankti Bartólómeusareyjar)',
        ...
        'ga' => 'írska',
        'ga_GB' => 'írska (Bretland)',
        'ga_IE' => 'írska (Írland)',
        'gd' => 'skosk gelíska',
        'gd_GB' => 'skosk gelíska (Bretland)',
        'gl' => 'galisíska',
        'gl_ES' => 'galisíska (Spánn)',
        'gu' => 'gújaratí',
        ...
        'hi' => 'hindí',
        'hi_IN' => 'hindí (Indland)',
        'hi_Latn' => 'hindí (latneskt)',
        'hi_Latn_IN' => 'hindí (latneskt, Indland)',
        'hr' => 'króatíska',
        ...
        'it_VA' => 'ítalska (Vatíkanið)',
        'ja' => 'japanska',
        'ja_JP' => 'japanska (Japan)',
        'jv' => 'javanska',
        'jv_ID' => 'javanska (Indónesía)',
        'ka' => 'georgíska',
        ...
        'ps_PK' => 'pastú (Pakistan)',
        'pt' => 'portúgalska',
        'pt_AO' => 'portúgalska (Angóla)',
        'pt_BR' => 'portúgalska (Brasilía)',
        'pt_CH' => 'portúgalska (Sviss)',
        'pt_CV' => 'portúgalska (Grænhöfðaeyjar)',
        'pt_GQ' => 'portúgalska (Miðbaugs-Gínea)',
        'pt_GW' => 'portúgalska (Gínea-Bissá)',
        'pt_LU' => 'portúgalska (Lúxemborg)',
        'pt_MO' => 'portúgalska (sérstjórnarsvæðið Makaó)',
        ...
        'sd_Deva' => 'sindí (devanagari)',
        'sd_Deva_IN' => 'sindí (devanagari, Indland)',
        'sd_IN' => 'sindí (Indland)',
        'sd_PK' => 'sindí (Pakistan)',
        'se' => 'norðursamíska',
        ...
        'sq_MK' => 'albanska (Norður-Makedónía)',
        'sr' => 'serbneska',
        ...
        'su_Latn_ID' => 'súndanska (latneskt, Indónesía)',
        'sv' => 'sænska',
        'sv_AX' => 'sænska (Álandseyjar)',
        'sv_FI' => 'sænska (Finnland)',
        'sv_SE' => 'sænska (Svíþjóð)',
        'sw' => 'svahílí',
        'sw_CD' => 'svahílí (Kongó-Kinshasa)',
        'sw_KE' => 'svahílí (Kenía)',
