...
return [
    'Names' => [
        ...
        'ce' => 'tchétchène',
        'ce_RU' => 'tchétchène (Russie)',
        'cs' => 'tchèque',
        'cs_CZ' => 'tchèque (Tchéquie)',
        'cv' => 'tchouvache',
        'cv_RU' => 'tchouvache (Russie)',
        'cy' => 'gallois',
        ...
        'ff' => 'peul',
        'ff_Adlm' => 'peul (adlam)',
        'ff_Adlm_BF' => 'peul (adlam, Burkina Faso)',
        'ff_Adlm_CM' => 'peul (adlam, Cameroun)',
        'ff_Adlm_GH' => 'peul (adlam, Ghana)',
        'ff_Adlm_GM' => 'peul (adlam, Gambie)',
        'ff_Adlm_GN' => 'peul (adlam, Guinée)',
        'ff_Adlm_GW' => 'peul (adlam, Guinée-Bissau)',
        'ff_Adlm_LR' => 'peul (adlam, Liberia)',
        'ff_Adlm_MR' => 'peul (adlam, Mauritanie)',
        'ff_Adlm_NE' => 'peul (adlam, Niger)',
        'ff_Adlm_NG' => 'peul (adlam, Nigeria)',
        'ff_Adlm_SL' => 'peul (adlam, Sierra Leone)',
        'ff_Adlm_SN' => 'peul (adlam, Sénégal)',
        'ff_CM' => 'peul (Cameroun)',
        'ff_GN' => 'peul (Guinée)',
        'ff_Latn' => 'peul (latin)',
        'ff_Latn_BF' => 'peul (latin, Burkina Faso)',
        'ff_Latn_CM' => 'peul (latin, Cameroun)',
        'ff_Latn_GH' => 'peul (latin, Ghana)',
        'ff_Latn_GM' => 'peul (latin, Gambie)',
        'ff_Latn_GN' => 'peul (latin, Guinée)',
        'ff_Latn_GW' => 'peul (latin, Guinée-Bissau)',
        'ff_Latn_LR' => 'peul (latin, Liberia)',
        'ff_Latn_MR' => 'peul (latin, Mauritanie)',
        'ff_Latn_NE' => 'peul (latin, Niger)',
        'ff_Latn_NG' => 'peul (latin, Nigeria)',
        'ff_Latn_SL' => 'peul (latin, Sierra Leone)',
        'ff_Latn_SN' => 'peul (latin, Sénégal)',
        'ff_MR' => 'peul (Mauritanie)',
        'ff_SN' => 'peul (Sénégal)',
        'fi' => 'finnois',
        'fi_FI' => 'finnois (Finlande)',
        'fo' => 'féroïen',
        'fo_DK' => 'féroïen (Danemark)',
        ...
        'gv' => 'mannois',
        'gv_IM' => 'mannois (Île de Man)',
        'ha' => 'haoussa',
        'ha_GH' => 'haoussa (Ghana)',
        'ha_NE' => 'haoussa (Niger)',
        'ha_NG' => 'haoussa (Nigeria)',
        'he' => 'hébreu',
        'he_IL' => 'hébreu (Israël)',
        'hi' => 'hindi',
        'hi_IN' => 'hindi (Inde)',
        'hi_Latn' => 'hindi (latin)',
        'hi_Latn_IN' => 'hindi (latin, Inde)',
        'hr' => 'croate',
        ...
        'it_VA' => 'italien (État de la Cité du Vatican)',
        'ja' => 'japonais',
        'ja_JP' => 'japonais (Japon)',
        'jv' => 'javanais',
        'jv_ID' => 'javanais (Indonésie)',
        'ka' => 'géorgien',
        ...
        'ks' => 'cachemiri',
        'ks_Arab' => 'cachemiri (arabe)',
        'ks_Arab_IN' => 'cachemiri (arabe, Inde)',
        'ks_Deva' => 'cachemiri (dévanagari)',
        ...
        'lu_CD' => 'luba-katanga [kiluba] (Congo-Kinshasa)',
        'lv' => 'letton',
        'lv_LV' => 'letton (Lettonie)',
        'mg' => 'malgache',
        'mg_MG' => 'malgache (Madagascar)',
        'mi' => 'maori',
        'mi_NZ' => 'maori (Nouvelle-Zélande)',
        'mk' => 'macédonien',
        ...
        'pt_CH' => 'portugais (Suisse)',
        'pt_CV' => 'portugais (Cap-Vert)',
        'pt_GQ' => 'portugais (Guinée équatoriale)',
        'pt_GW' => 'portugais (Guinée-Bissau)',
        'pt_LU' => 'portugais (Luxembourg)',
        ...
        'sd_Deva_IN' => 'sindhi (dévanagari, Inde)',
        'sd_IN' => 'sindhi (Inde)',
        ...
        'sq_MK' => 'albanais (Macédoine du Nord)',
        'sr' => 'serbe',
        ...
        'su_Latn_ID' => 'soundanais (latin, Indonésie)',
        'sv' => 'suédois',
