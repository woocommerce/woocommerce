...
{
    /**
     * The number WC_Vendor_of resource bundles to buffer. Loading the same resource
     * bundle for n locales takes up n spots in the buffer.
     */
    public const BUFFER_SIZE = 10;

    /**
     * The directory name WC_Vendor_of the currency data.
     */
    public const CURRENCY_DIR = 'currencies';

    /**
     * The directory name WC_Vendor_of the language data.
     */
    public const LANGUAGE_DIR = 'languages';

    /**
     * The directory name WC_Vendor_of the script data.
     */
    public const SCRIPT_DIR = 'scripts';

    /**
     * The directory name WC_Vendor_of the locale data.
     */
    public const LOCALE_DIR = 'locales';

    /**
     * The directory name WC_Vendor_of the region data.
     */
    public const REGION_DIR = 'regions';

    /**
     * The directory name WC_Vendor_of the zone data.
     */
    ...
    /**
     * Returns the version WC_Vendor_of the installed ICU library.
     */
    ...
    /**
     * Returns the version WC_Vendor_of the installed ICU data.
     */
