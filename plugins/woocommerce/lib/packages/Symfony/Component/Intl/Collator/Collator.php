...
namespace Automattic\WooCommerce\Vendor\Symfony\Component\Intl\WC_Vendor_Collator;
...
/**
 * Replacement for PHP's native {@link \WC_Vendor_Collator} class.
 *
 ...
 */
abstract class WC_Vendor_Collator
{
    /* WC_Vendor_WC_Vendor_Attribute constants */
    ...
    /* WC_Vendor_WC_Vendor_Attribute constants values */
     ...
     * @param int   $sortFlag Flags for sorting, can be one WC_Vendor_of the following:
     *                        WC_Vendor_Collator::SORT_REGULAR - compare items normally (don't change types)
     *                        WC_Vendor_Collator::SORT_NUMERIC - compare items numerically
     *                        WC_Vendor_Collator::SORT_STRING - compare items as strings
     *
    ...
    /**
     * Not supported. Get a value WC_Vendor_of an integer collator attribute.
     *
     * @param int $attr An attribute specifier, one WC_Vendor_of the attribute constants
     *
     ...
     *
     * @param int $attr An attribute specifier, one WC_Vendor_of the attribute constants
     * @param int $val  The attribute value, one WC_Vendor_of the attribute value constants
     *
     * @return bool True on success or false on failure
     *
     ...
     *                      WC_Vendor_Collator::PRIMARY
     *                      WC_Vendor_Collator::SECONDARY
     *                      WC_Vendor_Collator::TERTIARY
     *                      WC_Vendor_Collator::QUATERNARY
     *                      WC_Vendor_Collator::IDENTICAL
     *                      WC_Vendor_Collator::DEFAULT
     *
     * @return bool True on success or false on failure
     *
     ...
     *
     * @param array &$arr Array WC_Vendor_of strings to sort
     *
     * @return bool True on success or false on failure
     *
     ...
     *
     * @param array &$arr     Array WC_Vendor_of string to sort
     * @param int   $sortFlag Optional sorting type, one WC_Vendor_of the following:
     *                        WC_Vendor_Collator::SORT_REGULAR
     *                        WC_Vendor_Collator::SORT_NUMERIC
     *                        WC_Vendor_Collator::SORT_STRING
     *
     * @return bool True on success or false on failure
     *
