...
( function ( $, window, document ) {
	...
	function getWooPayButtonContent( settings ) {
		var type = settings.type || 'default';
		var prefix = getWooPayButtonPrefix( type );
		var icon = 'dark' === ( settings.theme || 'dark' )
			? wooPayIconDark
			: wooPayIconLight;
	...
	function renderWooPayExpressButton() {
		...
		button.setAttribute( 'aria-label', getWooPayButtonLabel( type ) );
		...
		button.innerHTML = getWooPayButtonContent( settings );
