...
jQuery( function ( $ ) {
	...
	// The order actions "more actions" menu controller lives in the shared
	// `order-actions-menu.js` asset (enqueued as a dependency) so the customer
	// stock-notification screens, which reuse the same markup, can use it too.
