    ...
    methods = {
      ...
      smoothHeight: function(dur) {
        if (!vertical || fade) {
          ...
          (dur) ? $obj.css({"height": slider.slides.eq(slider.animatingTo).innerHeight(), "transition": "height " + dur + "ms"}) : $obj.innerHeight(slider.slides.eq(slider.animatingTo).innerHeight());
        }
      },
