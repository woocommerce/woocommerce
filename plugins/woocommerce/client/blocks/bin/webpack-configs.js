			...
			splitChunks: {
				...
				cacheGroups: {
					...
					base: {
						...
						test: /assets[\\/]js[\\/](settings|previews|base|utils|blocks[\\/]cart-checkout-shared|icons)|packages[\\/]public-api[\\/](block-data|blocks-checkout|blocks-components|settings)[\\/]|product-element-blocks[\\/]utils/,
