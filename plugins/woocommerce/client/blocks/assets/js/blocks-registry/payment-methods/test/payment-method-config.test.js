...
describe( 'PaymentMethodConfig', () => {
	...
	it( 'creates a valid payment method config with minimal required properties', () => {
		...
		expect( config.content ).toStrictEqual( <MockContent /> );
		expect( config.edit ).toStrictEqual( <MockEdit /> );
	...
	it( 'uses provided savedTokenComponent', () => {
		...
		expect( config.savedTokenComponent ).toStrictEqual( <MockSavedToken /> );
	} );
	...
	it( 'validates required properties', () => {
		...
		} ).toThrow( 'The payment method configuration object is missing the following properties:name' );
	} );
