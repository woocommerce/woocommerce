...
| [Editor assets](../enqueueable-packages/README.md) | Explains the shared WooCommerce Blocks editor assets, remaining external packages, and compatibility handles. |
