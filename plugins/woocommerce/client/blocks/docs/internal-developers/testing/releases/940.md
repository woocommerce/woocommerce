...
1. A detailed testing guide exists in [docs/internal-developers/testing/cart-checkout/local-pickup.md](https://github.com/woocommerce/woocommerce/blob/trunk/plugins/woocommerce/client/blocks/docs/internal-developers/testing/cart-checkout/local-pickup.md)
