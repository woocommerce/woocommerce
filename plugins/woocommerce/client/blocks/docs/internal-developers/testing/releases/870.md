...
found [here](https://github.com/woocommerce/woocommerce/blob/trunk/plugins/woocommerce/client/blocks/docs/internal-developers/testing/cart-checkout/data-stores.md)
. At a minimum, we will need to smoke test by trying the
different [stripe failure](https://github.com/woocommerce/woocommerce/blob/trunk/plugins/woocommerce/client/blocks/docs/internal-developers/testing/cart-checkout/data-stores.md#stripe-failures)
modes
