...
const DEFAULT_ATTRIBUTES: Required< ProductCategoriesAttributes > = {
	hasCount: true,
	hasImage: false,
	hasEmpty: false,
	isDropdown: false,
...
const isWidgetEditorPage = ( store: unknown ): boolean => {
	if (
		! store ||
		typeof store !== 'object' ||
		! ( 'getWidgetAreas' in store )
	) {
		return false;
	}
...
const ProductCategoriesBlock = ( {
	...
	const blockAttributes = { ...DEFAULT_ATTRIBUTES, ...attributes };
