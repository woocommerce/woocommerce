...
import { getHasColorClasses, getStyleColorVars } from '../shared/colors';
...
const PriceSliderEdit = ( {
	...
	const { customSliderHandle, customSliderHandleBorder, customSlider } =
		attributes;
	const showInputFields = attributes.showInputFields ?? true;
	const inlineInput = attributes.inlineInput ?? false;
	...
	const formattedMinPrice = formatPreviewPrice( currentMin );
	const formattedMaxPrice = formatPreviewPrice( currentMax );
