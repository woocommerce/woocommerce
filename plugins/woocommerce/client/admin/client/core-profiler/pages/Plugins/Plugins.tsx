...
export const composeListFormatParts = ( part: { type: string; value: string } ) => {
...
export const Plugins = ( {
	...
	>(
		// if plugins installation was attempted and returned with an error
		// otherwise select plugins that are not activated
	...
	console.log( 'sel', selectedPlugins );
