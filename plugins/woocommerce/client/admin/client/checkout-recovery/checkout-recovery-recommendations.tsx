...
import './checkout-recovery-recommendations.scss';

export const CheckoutRecoveryRecommendationsList = ( {
	children,
}: {
	children: React.ReactNode;
} ) => (
	<DismissableList
		className="woocommerce-recommended-checkout-recovery-extensions"
		dismissOptionName="woocommerce_checkout_recovery_recommendations_hidden"
	>
		<DismissableListHeading>
			...
			<Text
				className="woocommerce-recommended-checkout-recovery__header-heading"
				variant="caption"
				as="p"
				size="12"
				lineHeight="16px"
...
const CheckoutRecoveryRecommendations = () => {
	...
	return (
		<CheckoutRecoveryRecommendationsList>
...
export default CheckoutRecoveryRecommendations;
