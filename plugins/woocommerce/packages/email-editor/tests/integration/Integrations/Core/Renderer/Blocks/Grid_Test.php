...
class Grid_Test extends \Email_Editor_Integration_Test_Case {
	...
	/**
	 * Test grid detection from CSS class when attrs.layout.type is missing.
	 *
	 * @testdox Should detect grid layout from is-layout-grid CSS class when layout attribute is missing.
	 */
	public function test_detects_grid_from_css_class(): void {
		$parsed_block = $this->parsed_grid_block;
		unset( $parsed_block['attrs']['layout'] );
