...
4. Go to the templates list within the Site Editor (Dashboard > Appearance > Editor (beta))
...
8. Notice that these templates render in the Site Editor, and on the front-end page as expected with and without customizations.
