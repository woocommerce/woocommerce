...
Zip file for testing: [woocommerce-gutenberg-products-block.zip](https://github.com/woocommerce/woocommerce-blocks/files/12226434/woocommerce-gutenberg-products-block.zip)
...
2. Verify there are no opinionated styles (borders, colors, fonts, etc) and the pattern looks like the screenshot above.
...
| Before | After |
| ------ | ----- |
| <img width="1280" alt="Screenshot 2023-07-20 at 15 26 05" src="https://github.com/woocommerce/woocommerce-blocks/assets/186112/2826ad55-d947-41fa-8ff0-d55009f61123"> | <img width="1284" alt="Screenshot 2023-07-20 at 15 24 44" src="https://github.com/woocommerce/woocommerce-blocks/assets/186112/3801232f-0216-4b50-b66d-7b7056736db9"> |
...
4. Click on the product `View products` button and in the styles tab check it has no colors or other styles.
