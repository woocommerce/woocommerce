...
5. Go to Appearance > Widgets, and open the transform menu for a filter widget. See Filter Wrapper as an option.
6. Hover on the Filter Wrapper, see the preview of corresponding filter blocks.
7. Click the Filter Wrapper, see the widget converted to filter blocks.
