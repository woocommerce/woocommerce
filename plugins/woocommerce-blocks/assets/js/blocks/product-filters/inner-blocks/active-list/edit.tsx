...
const Edit = ( props: EditProps ): JSX.Element => {
	...
	const blockProps = useBlockProps( {
		className: clsx( 'wc-block-product-filter-active-list', {
	...
	return (
		<>
			<div { ...blockProps }>
				<ul className="wc-block-product-filter-active-list__list">
					...
					{ ! isLoading &&
						( isLongList
							...
							<li
								key={ index }
								className="wc-block-product-filter-active-list__item"
							>
								<label
									htmlFor={ `interactive-checkbox-${ index }` }
									className=" wc-block-product-filter-active-list__label"
								>
									<span className="wc-block-interactive-components-checkbox-list__input-wrapper">
										<span className="wc-block-product-filter-active-list__input-wrapper">
											<input
												name={ `interactive-checkbox-${ index }` }
												type="checkbox"
												className="wc-block-product-filter-active-list__input"
												defaultChecked={
													!! item.selected
												}
											/>
											<Icon
												className="wc-block-product-filter-active-list__mark"
												icon={ checkMark }
											/>
										</span>
									</span>
									<span className="wc-block-product-filter-active-list__text">
										{ item.label }
									</span>
								</label>
							</li>
				...
				{ ! isLoading && isLongList && (
					<button className="wc-block-product-filter-active-list__show-more">
