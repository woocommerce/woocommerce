...
For more information on what blocks are available, and how to use them, check out <a href="woocommerce.com/document/woocommerce-blocks/
...
Visit the [WooCommerce server requirements documentation](woocommerce.com/document/server-requirements/) for a detailed list of server requirements.
...
WooCommerce comes with some sample data you can use to populate the products and get started building Products blocks quickly and easily. You can use the core [CSV importer](woocommerce.com/document/product-csv-importer-exporter/) or our [CSV Import Suite plugin](woocommerce.com/products/product-csv-import-suite/) to import sample_products.csv.
