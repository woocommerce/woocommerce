	...
	return [
		{
			...
			link: 'woocommerce.com/my-account/create-a-ticket/?utm_medium=product',
		},
		{
			title: __( 'Home Screen', 'woocommerce' ),
			link: 'woocommerce.com/document/home-screen/?utm_medium=product',
		},
		{
			title: __( 'Inbox', 'woocommerce' ),
			link: 'woocommerce.com/document/home-screen/?utm_medium=product#section-4',
		},
		{
			title: __( 'Stats Overview', 'woocommerce' ),
			link: 'woocommerce.com/document/home-screen/?utm_medium=product#section-5',
		},
		{
			title: __( 'Store Management', 'woocommerce' ),
			link: 'woocommerce.com/document/home-screen/?utm_medium=product#section-10',
		},
		{
			title: __( 'Store Setup Checklist', 'woocommerce' ),
			link: 'woocommerce.com/document/woocommerce-setup-wizard?utm_medium=product#store-setup-checklist',
		},
	];
}
	...
	return [
		{
			...
			link: 'woocommerce.com/document/woocommerce-blocks/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __(
			...
			link: 'woocommerce.com/document/woocommerce-customizer/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __( 'How to choose and change a theme', 'woocommerce' ),
			link: 'woocommerce.com/document/choose-change-theme/?utm_source=help_panel&utm_medium=product',
		},
	];
}
...
function getMarketingItems( props ) {
	...
	return [
		...
		activePlugins.includes( 'google-listings-and-ads' ) && {
			...
			link: 'woocommerce.com/document/google-listings-and-ads/?utm_medium=product#get-started',
		},
		activePlugins.includes( 'pinterest-for-woocommerce' ) && {
			title: __( 'Set up Pinterest for WooCommerce', 'woocommerce' ),
			link: 'woocommerce.com/products/pinterest-for-woocommerce/',
		},
	...
	return [
		{
			...
			link: 'woocommerce.com/document/premium-payment-gateway-extensions/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions.woocommerce_payments && {
			title: __( 'WooPayments Start Up Guide', 'woocommerce' ),
			link: 'woocommerce.com/document/payments/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions.woocommerce_payments && {
			title: __( 'WooPayments FAQs', 'woocommerce' ),
			link: 'woocommerce.com/documentation/woocommerce-payments/woocommerce-payments-faqs/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions.stripe && {
			title: __( 'Stripe Setup and Configuration', 'woocommerce' ),
			link: 'woocommerce.com/document/stripe/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions[ 'ppcp-gateway' ] && {
			...
			link: 'woocommerce.com/document/2-0/woocommerce-paypal-payments/?utm_medium=product#section-3',
		},
		paymentGatewaySuggestions.square_credit_card && {
			title: __( 'Square - Get started', 'woocommerce' ),
			link: 'woocommerce.com/document/woocommerce-square/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions.kco && {
			title: __( 'Klarna - Introduction', 'woocommerce' ),
			link: 'woocommerce.com/document/klarna-checkout/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions.klarna_payments && {
			title: __( 'Klarna - Introduction', 'woocommerce' ),
			link: 'woocommerce.com/document/klarna-payments/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions.payfast && {
			title: __( 'Payfast Setup and Configuration', 'woocommerce' ),
			link: 'woocommerce.com/document/payfast-payment-gateway/?utm_source=help_panel&utm_medium=product',
		},
		paymentGatewaySuggestions.eway && {
			title: __( 'Eway Setup and Configuration', 'woocommerce' ),
			link: 'woocommerce.com/document/eway/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __( 'Direct Bank Transfer (BACS)', 'woocommerce' ),
			link: 'woocommerce.com/document/bacs/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __( 'Cash on Delivery', 'woocommerce' ),
			link: 'woocommerce.com/document/cash-on-delivery/?utm_source=help_panel&utm_medium=product',
		},
	].filter( Boolean );
}
	...
	return [
		{
			...
			link: 'woocommerce.com/document/managing-products/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __(
			...
			link: 'woocommerce.com/document/product-csv-importer-exporter/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __( 'Migrate products using Cart2Cart', 'woocommerce' ),
			link: 'woocommerce.com/products/cart2cart/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __( 'Learn more about setting up products', 'woocommerce' ),
			link: 'woocommerce.com/documentation/plugins/woocommerce/getting-started/setup-products/?utm_source=help_panel&utm_medium=product',
		},
	];
}
	...
	return [
		{
			...
			link: 'woocommerce.com/document/setting-up-shipping-zones/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __( 'Core Shipping Options', 'woocommerce' ),
			link: 'woocommerce.com/documentation/plugins/woocommerce/getting-started/shipping/core-shipping-options/?utm_source=help_panel&utm_medium=product',
		},
		{
			title: __( 'Product Shipping Classes', 'woocommerce' ),
			link: 'woocommerce.com/document/product-shipping-classes/?utm_source=help_panel&utm_medium=product',
		},
		showWCS && {
			title: __(
			...
			link: 'woocommerce.com/document/woocommerce-shipping-and-tax/?utm_source=help_panel&utm_medium=product#section-3',
		},
		{
			title: __(
			...
			link: 'woocommerce.com/document/plugins/woocommerce/getting-started/shipping/?utm_source=help_panel&utm_medium=product',
		},
	].filter( Boolean );
}
	...
	return [
		{
			...
			link: 'woocommerce.com/document/setting-up-taxes-in-woocommerce/?utm_source=help_panel&utm_medium=product',
		},
		showWCS && {
			title: __(
			...
			link: 'woocommerce.com/document/woocommerce-services/?utm_source=help_panel&utm_medium=product#section-10',
		},
	].filter( Boolean );
}
...
function getListItems( props ) {
	...
	const genericDocsLink = {
		...
		link: 'woocommerce.com/documentation/?utm_source=help_panel&utm_medium=product',
	};
