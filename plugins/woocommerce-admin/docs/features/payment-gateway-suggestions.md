...
If a store is opted into marketplace suggestions via `woocommerce_show_marketplace_suggestions` the suggestions by default will be retrieved from `https://woo.com/wp-json/wccom/payment-gateway-suggestions/1.0/suggestions.json`.
