...
export default {
	...
	jumpToPrevMonth: __( 'Move backward to switch to the previous month.', 'woocommerce-admin' ),
	jumpToNextMonth: __( 'Move forward to switch to the next month.', 'woocommerce-admin' ),
	...
	moveFocusByOneDay: __( 'Move backward (left) and forward (right) by one day.', 'woocommerce-admin' ),
	moveFocusByOneWeek: __( 'Move backward (up) and forward (down) by one week.', 'woocommerce-admin' ),
	moveFocusByOneMonth: __( 'Switch months.', 'woocommerce-admin' ),
	moveFocustoStartAndEndOfWeek: __( 'Go to the first or last day of a week.', 'woocommerce-admin' ),
	returnFocusToInput: __( 'Return to the date input field.', 'woocommerce-admin' ),
  ...
  select a date.`,
	...
	chooseAvailableStartDate: ( { date } ) =>
		sprintf( __( 'Select %s as a start date.', 'woocommerce-admin' ), date ),
