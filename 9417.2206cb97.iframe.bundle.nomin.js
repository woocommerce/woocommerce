"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[9417],{

/***/ "../../packages/js/onboarding/build-module/index.js":
...
// UNUSED EXPORTS: Affirm, AfterPay, Amex, ApplePay, ClearPay, Diners, Discover, GooglePay, Ideal, Klarna, MasterCard, RecommendedRibbon, SetupRequired, Visa, WCPayAcceptedMethods, WCPayBanner, WCPayBannerBody, WCPayBannerFooter, WCPayBannerImage, WCPayBannerImageCut, WCPayBannerText, WCPayBenefits, WCPayCard, WCPayCardBody, WCPayCardFooter, WCPayCardHeader, WCPayLogo, Woo, WooOnboardingTask, WooOnboardingTaskListHeader, WooOnboardingTaskListItem, WooPaymentGatewayConfigure, WooPaymentGatewaySetup, WooPaymentMethodsLogos, accessTaskReferralStorage, createStorageUtils
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WCPayAcceptedMethods.js
/**
...
var WCPayAcceptedMethods_WCPayAcceptedMethods = function WCPayAcceptedMethods() {
  return createElement(Fragment, null, createElement(Text, {
    ...
    size: "12",
    lineHeight: "16px"
  }, __('Accepted payment methods', 'woocommerce')), createElement("div", {
    className: "woocommerce-task-payment-wcpay__accepted"
  }, createElement(Visa, null), createElement(MasterCard, null), createElement(Maestro, null), createElement(Amex, null), createElement(DinersClub, null), createElement(CB, null), createElement(Discover, null), createElement(UnionPay, null), createElement(JCB, null), createElement(ApplePay, null)));
};
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/wcpay-logo.js
...
/* harmony default export */ const wcpay_logo = (function (_ref) {
  ...
  }, createElement("title", null, "WooPayments"), createElement("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WCPayCard/WCPayCard.js
...
var WCPayCardBody = function WCPayCardBody(_ref2) {
  ...
  return createElement(CardBody, null, heading && createElement(Text, {
    as: "h2"
  }, heading), createElement(Text, {
    className: "woocommerce-task-payment-wcpay__description",
    as: "p",
    lineHeight: "1.5em"
  }, description, createElement("br", null), createElement(Link, {
    target: "_blank",
    type: "external",
    rel: "noreferrer",
    href: "https://woocommerce.com/payments/?utm_medium=product",
    onClick: onLinkClick
  }, __('Learn more', 'woocommerce'))), createElement(WCPayAcceptedMethods, null));
};
var WCPayCardFooter = function WCPayCardFooter(_ref3) {
  var children = _ref3.children;
  return createElement(CardFooter, null, children);
};
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WCPayCard/index.js
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/cards/visa.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/cards/mastercard.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/cards/amex.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/cards/discover.js
/**
 * External dependencies
 */
...
/* harmony default export */ const discover = (function () {
  return (0,react.createElement)("svg", {
  ...
  })), (0,react.createElement)("clipPath", {
    id: "clip-path-2"
  }, (0,react.createElement)("path", {
    fill: "none",
    ...
    cy: "31.43",
    r: "54.04"
  })), (0,react.createElement)("linearGradient", {
    id: "linear-gradient",
    x1: "50.71",
    y1: "36.53",
    x2: "46.17",
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/cards/applepay.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/cards/googlepay.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/cards/jcb.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/payment-methods/woopay.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/payment-methods/afterpay.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/payment-methods/affirm.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/images/payment-methods/klarna.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooPaymentsMethodsLogos/index.js
...
var PaymentMethods = [{
  name: 'visa',
  component: (0,react.createElement)(visa, {
    key: "visa"
  })
}, {
  name: 'mastercard',
  component: (0,react.createElement)(mastercard, {
    key: "mastercard"
  })
}, {
  name: 'amex',
  component: (0,react.createElement)(amex, {
    key: "amex"
  })
}, {
  name: 'discover',
  component: (0,react.createElement)(discover, {
    key: "discover"
  })
}, {
  name: 'woopay',
  component: (0,react.createElement)(woopay, {
    key: "woopay"
  })
}, {
  name: 'applepay',
  component: (0,react.createElement)(applepay, {
    key: "applepay"
  })
}, {
  name: 'googlepay',
  component: (0,react.createElement)(googlepay, {
    key: "googlepay"
  })
}, {
  name: 'afterpay',
  component: (0,react.createElement)(afterpay, {
    key: "afterpay"
  })
}, {
  name: 'affirm',
  component: (0,react.createElement)(affirm, {
    key: "affirm"
  })
}, {
  name: 'klarna',
  component: (0,react.createElement)(klarna, {
    key: "klarna"
  })
}, {
  name: 'jcb',
  component: (0,react.createElement)(jcb, {
    key: "jcb"
  })
}];
// Maximum number of logos to be displayed on a mobile screen.
var maxElementsMobile = 5;
// Maximum number of logos to be displayed on a tablet screen.
var maxElementsTablet = 7;
// Maximum number of logos to be displayed on a desktop screen.
var maxElementsDesktop = 10;
// Total number of available payment methods from https://woocommerce.com/document/woopayments/payment-methods.
var totalPaymentMethods = 20;
var WooPaymentsMethodsLogos_WooPaymentMethodsLogos = function WooPaymentMethodsLogos(_ref) {
  var _ref$isWooPayEligible = _ref.isWooPayEligible,
    ...
    maxElements = _ref$maxElements === void 0 ? maxElementsDesktop : _ref$maxElements;
  ...
  var getMaxShownElements = function getMaxShownElements(maxElementsNumber, isWooPayAvailable) {
  ...
  }, PaymentMethods.slice(0, getMaxShownElements(maxShownElements, isWooPayEligible)).map(function (pm) {
    if (!isWooPayEligible && pm.name === 'woopay') {
      return null;
    }
    return pm.component;
  }), maxShownElements < totalPaymentMethods && createElement("div", {
    className: "woocommerce-woopayments-payment-methods-logos-count"
  }, "+ ", totalPaymentMethods - maxShownElements)));
};
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WCPayBanner/WCPayBanner.js
/**
 * External dependencies
 */
...
var WCPayBannerFooter = function WCPayBannerFooter(_ref) {
  ...
  return createElement(CardFooter, {
    className: "woocommerce-recommended-payments-banner__footer"
  }, createElement("div", null, createElement(Text, {
    variant: "caption",
    as: "p",
    size: "12",
    lineHeight: "16px"
  }, __('WooPayments is pre-integrated with popular payment options:', 'woocommerce'))), createElement(WooPaymentMethodsLogos, {
...
var WCPayBannerText = function WCPayBannerText(_ref2) {
  ...
  return createElement("div", {
    ...
    lineHeight: "28px",
    padding: "0 20px 0 0"
  }, createInterpolateElement(__('Payments made simple, designed exclusively<br/>for WooCommerce stores.', 'woocommerce'), {
...
var WCPayBannerBody = function WCPayBannerBody(_ref3) {
  var actionButton = _ref3.actionButton,
    ...
    bannerImage = _ref3$bannerImage === void 0 ? createElement(WCPayBannerImage, null) : _ref3$bannerImage,
    isWooPayEligible = _ref3.isWooPayEligible;
  return createElement(CardBody, {
    className: "woocommerce-recommended-payments-banner__body"
  }, textPosition === 'left' ? createElement(Fragment, null, createElement(WCPayBannerText, {
    actionButton: actionButton,
    isWooPayEligible: isWooPayEligible
  }), createElement("div", {
    className: "woocommerce-recommended-payments-banner__image_container"
  }, bannerImage)) : createElement(Fragment, null, createElement("div", {
    className: "woocommerce-recommended-payments-banner__image_container"
  }, bannerImage), createElement(WCPayBannerText, {
    actionButton: actionButton,
    isWooPayEligible: isWooPayEligible
  })));
};
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WCPayBanner/index.js



;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WCPayBenefits/WCPayBenefits.js
/**
 * External dependencies
 */
...
var WCPayBenefits = function WCPayBenefits(_ref) {
  ...
  }, createElement(PaymentCardIcon, null)), createElement(Text, {
    as: "p"
  }, __('Offer your customers card payments, iDeal, and the ability to sell in-person with Woo mobile app.', 'woocommerce'))), createElement(Flex, {
    className: "woocommerce-wcpay-benefits-benefit"
  }, createElement(Flex, {
    className: "woocommerce-wcpay-benefits-benefit-icon-container"
  }, createElement(InternationalMarketIcon, null)), createElement(Text, {
    as: "p"
  }, __('Sell to international markets and accept more than 135 currencies with local payment methods.', 'woocommerce'))), createElement(Flex, {
    className: "woocommerce-wcpay-benefits-benefit"
  }, createElement(Flex, {
    className: "woocommerce-wcpay-benefits-benefit-icon-container"
  }, createElement(EarnManageIcon, null)), createElement(Text, {
    as: "p"
  }, __('Earn and manage recurring revenue and get automatic deposits into your nominated bank account.', 'woocommerce'))), isWooPayEligible && createElement(Flex, {
    className: "woocommerce-wcpay-benefits-benefit"
  }, createElement(Flex, {
    className: "woocommerce-wcpay-benefits-benefit-icon-container"
  }, createElement(WooPayIcon, null)), createElement(Text, {
    as: "p"
  }, __('Boost conversions with WooPay, a new express checkout feature included in WooPayments.', 'woocommerce'))));
};
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WCPayBenefits/index.js

;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/RecommendedRibbon/RecommendedRibbon.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/RecommendedRibbon/index.js
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/SetupRequired.js
/**
 * External dependencies
 */
...
var SetupRequired = function SetupRequired() {
  ...
  }, createElement(NoticeOutlineIcon, null), createElement(Text, {
    variant: "small",
    size: "14",
    lineHeight: "20px"
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+components@19.8.5_@types+react@17.0.71_react-dom@18.3.1_react@17.0.2__react-with-d_2lvt2m6o33cg7sz6nsmi7nf4ga/node_modules/@wordpress/components/build-module/slot-fill/index.js + 9 modules
var slot_fill = __webpack_require__("../../node_modules/.pnpm/@wordpress+components@19.8.5_@types+react@17.0.71_react-dom@18.3.1_react@17.0.2__react-with-d_2lvt2m6o33cg7sz6nsmi7nf4ga/node_modules/@wordpress/components/build-module/slot-fill/index.js");
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooPaymentGatewaySetup/WooPaymentGatewaySetup.js
...
var WooPaymentGatewaySetup = function WooPaymentGatewaySetup(_ref) {
  ...
  return (0,react.createElement)(slot_fill/* Fill */.SQ, _objectSpread({
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooPaymentGatewaySetup/index.js

;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooPaymentGatewayConfigure/WooPaymentGatewayConfigure.js
...
var WooPaymentGatewayConfigure = function WooPaymentGatewayConfigure(_ref) {
  ...
  return (0,react.createElement)(slot_fill/* Fill */.SQ, WooPaymentGatewayConfigure_objectSpread({
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooPaymentGatewayConfigure/index.js
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooOnboardingTaskReferral/index.js
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooOnboardingTaskListItem/WooOnboardingTaskListItem.js
...
var WooOnboardingTaskListItem = function WooOnboardingTaskListItem(_ref) {
  ...
  return (0,react.createElement)(slot_fill/* Fill */.SQ, WooOnboardingTaskListItem_objectSpread({
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooOnboardingTaskListItem/index.js

;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooOnboardingTaskListHeader/WooOnboardingTaskListHeader.js
...
var WooOnboardingTaskListHeader = function WooOnboardingTaskListHeader(_ref) {
  ...
  return (0,react.createElement)(slot_fill/* Fill */.SQ, WooOnboardingTaskListHeader_objectSpread({
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooOnboardingTaskListHeader/index.js
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooOnboardingTask/WooOnboardingTask.js
...
var WooOnboardingTask = function WooOnboardingTask(_ref2) {
  ...
  return (0,react.createElement)(slot_fill/* Fill */.SQ, WooOnboardingTask_objectSpread({
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/WooOnboardingTask/index.js
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/utils/countries/location-mapping.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/utils/countries/index.js
...
var getCountry = function getCountry(countryPossiblyWithState) {
  var _a;
  return (_a = countryPossiblyWithState === null || countryPossiblyWithState === void 0 ? void 0 : countryPossiblyWithState.split(':')[0]) !== null && _a !== void 0 ? _a : undefined;
};
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/Loader/ProgressBar.js
/**
 * External dependencies
 */
...
/* harmony default export */ const Loader_ProgressBar = (ProgressBar);
;
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/Loader/Loader.js
...
;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/components/Loader/index.js

;// CONCATENATED MODULE: ../../packages/js/onboarding/build-module/index.js
