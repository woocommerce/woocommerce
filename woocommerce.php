...
class woocommerce {
	...
	function includes() {
		...
		include( 'woocommerce_templates.php' );				// Loads template files - used in admin and front-end
	...
	function frontend_includes() {
		...
		include( 'woocommerce_template_actions.php' );			// Template actions used on the front-end
	...
	function include_template_functions() {
		include( 'woocommerce_template_functions.php' );
	}
	...
	/*-----------------------------------------------------------------------------------*/ 
		 ...
		 */
		function checkout() { 
			if ( !class_exists('woocommerce_checkout') ) include( 'checkout.class.php' );
		 ...
		 */
		function logger() { 
			if ( !class_exists('woocommerce_logger') ) include( 'woocommerce_logger.class.php' );
