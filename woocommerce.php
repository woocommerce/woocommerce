...
final class WooCommerce {
    ...
    */
	...
	public function init() {
		...
		$this->product_factory = apply_filter( 'woocommerce_instance_product_factory', new WC_Product_Factory() ); // Product Factory to create new product instances
		$this->countries       = apply_filter( 'woocommerce_instance_countries', new WC_Countries() ); // Countries class
		$this->integrations    = apply_filter( 'woocommerce_instance_integrations', new WC_Integrations() ); // Integrations class
		...
		if ( ! is_admin() || defined('DOING_AJAX') ) {
			...
			$this->cart       = apply_filter( 'woocommerce_instance_cart', new WC_Cart() ); // Cart class, stores the cart contents
			$this->customer   = apply_filter( 'woocommerce_instance_customer', new WC_Customer() ); // Customer class, handles data such as customer location
			$this->shortcodes = apply_filter( 'woocommerce_instance_shortcodes', new WC_Shortcodes() ); // Shortcodes class, controls all frontend shortcodes
