...
3. Run the tool via the npm script, e.g. `pnpm run release-post -- "6.8.0" --outputOnly`
4. For more help on individual options, run the help `pnpm run release-post -- --help`
