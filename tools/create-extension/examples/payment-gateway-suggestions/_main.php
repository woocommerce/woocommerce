...
function payment_gateway_suggestions_includes() {
	include_once __DIR__ . '/includes/woocommerce-admin-payment-gateway-suggestions-mock-installer.php';
	include_once __DIR__ . '/includes/class-my-simple-gateway.php';
	include_once __DIR__ . '/includes/class-my-slot-filled-gateway.php';
}
