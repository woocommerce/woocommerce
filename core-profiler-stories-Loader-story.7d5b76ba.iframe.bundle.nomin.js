...
var build_module = __webpack_require__("../../packages/js/onboarding/build-module/index.js");
...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/assets/images/loader-lightbulb.svg
...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/assets/images/loader-developing.svg
...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/assets/images/loader-layout.svg
...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/assets/images/loader-openingthedoors.svg
const loader_openingthedoors_namespaceObject = __webpack_require__.p + "static/media/loader-openingthedoors.bfec8d15.svg";
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/assets/images/loader-hearticon.svg
...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/utils/get-loader-stage-meta.tsx
...
var LightbulbStage = {
  title: (0,i18n_build_module.__)('Turning on the lights', 'woocommerce'),
  image: (0,react.createElement)("img", {
    src: loader_lightbulb_namespaceObject,
    alt: "loader-lightbulb"
  }),
  paragraphs: [{
    label: (0,i18n_build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,i18n_build_module.__)('The Woo team is made up of over 350 talented individuals, distributed across 30+ countries.', 'woocommerce')
  }]
};
var LayoutStage = {
  title: (0,i18n_build_module.__)('Extending your store’s capabilities', 'woocommerce'),
  image: (0,react.createElement)("img", {
  ...
  paragraphs: [{
    label: (0,i18n_build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,i18n_build_module.__)('Did you know that Woo powers almost 4 million stores worldwide? You’re in good company.', 'woocommerce')
  }]
};
var DevelopingStage = {
  title: (0,i18n_build_module.__)('Woo! Let’s get your features ready', 'woocommerce'),
  image: (0,react.createElement)("img", {
  ...
  paragraphs: [{
    label: (0,i18n_build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,i18n_build_module.__)('Did you know that Woo was founded by two South Africans and a Norwegian? Here are three alternative ways to say “store” in those countries – Winkel, ivenkile, and butikk.', 'woocommerce')
  }]
};
var OpeningTheDoorsStage = {
  title: (0,i18n_build_module.__)('Opening the doors', 'woocommerce'),
  image: (0,react.createElement)("img", {
  ...
  paragraphs: [{
    label: (0,i18n_build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,i18n_build_module.__)('Our favorite color is purple ', 'woocommerce'),
    element: (0,react.createElement)("img", {
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../plugins/woocommerce-admin/client/core-profiler/utils/get-loader-stage-meta.tsx#getLoaderStageMeta"] = { docgenInfo: getLoaderStageMeta.__docgenInfo, name: "getLoaderStageMeta", path: "../../plugins/woocommerce-admin/client/core-profiler/utils/get-loader-stage-meta.tsx#getLoaderStageMeta" };
}
catch (__react_docgen_typescript_loader_error) { }
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/components/loader/Loader.tsx
...
var CoreProfilerLoader = function CoreProfilerLoader(_ref) {
  ...
  return (0,react.createElement)(build_module/* Loader */.aH, {
    className: context.loader.className
  }, (0,react.createElement)(build_module/* Loader */.aH.Layout, null, (0,react.createElement)(build_module/* Loader */.aH.Illustration, null, currentStage.image), (0,react.createElement)(build_module/* Loader */.aH.Title, null, currentStage.title), (0,react.createElement)(build_module/* Loader */.aH.ProgressBar, {
  ...
  }), (0,react.createElement)(build_module/* Loader */.aH.Sequence, {
    interval: 3000
  }, currentStage.paragraphs.map(function (paragraph, index) {
    return (0,react.createElement)(build_module/* Loader */.aH.Subtext, {
      key: index
    }, (0,react.createElement)("b", null, paragraph === null || paragraph === void 0 ? void 0 : paragraph.label), paragraph === null || paragraph === void 0 ? void 0 : paragraph.text, paragraph === null || paragraph === void 0 ? void 0 : paragraph.element);
  }))));
};
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../plugins/woocommerce-admin/client/core-profiler/components/loader/Loader.tsx#CoreProfilerLoader"] = { docgenInfo: CoreProfilerLoader.__docgenInfo, name: "CoreProfilerLoader", path: "../../plugins/woocommerce-admin/client/core-profiler/components/loader/Loader.tsx#CoreProfilerLoader" };
}
catch (__react_docgen_typescript_loader_error) { }
...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/stories/Loader.story.tsx
...
var Short = function Short() {
  return (0,react.createElement)(CoreProfilerLoader, {
    context: {
      loader: {
        progress: 10,
