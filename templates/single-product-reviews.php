...
<div id="reviews" class="woocommerce-Reviews">
	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || WC_Order_Product_Lookup_Helper::is_product_purchased( $product->get_id(), get_current_user_id() ) ) : ?>
