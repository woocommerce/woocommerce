...
echo sprintf( __( 'Thanks for creating an account on %1$s. Your username is %2$s', 'woocommerce' ), $blogname, '<strong>' . apply_filters( 'woocommerce_email_customer_new_account_user_login', $user_login ) . '</strong>' ) . "\n\n";
