...
<?php endif; ?>
	...
	<p><?php printf( __( 'You can access your account area to view your orders and change your password here: %s.', 'woocommerce' ), '<a href="' . esc_url( wc_get_page_permalink( 'myaccount' ) ) . '">' . __( 'My Account' ) . '</a>' ); ?></p>
