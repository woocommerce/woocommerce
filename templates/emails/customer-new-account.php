...
<p><?php printf( __( 'You can access your account area to view your orders and change your password here: <a href="%s">My account</a>.', 'woocommerce' ), wc_get_page_permalink( 'myaccount' ) ); ?></p>
