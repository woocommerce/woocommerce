...
<?php if ( ! is_ajax() || ( defined( 'SHOW_ORDER_REVIEW' ) && SHOW_ORDER_REVIEW ) ) : ?><div id="order_review"><?php endif; ?>
...
<?php if ( ! is_ajax() || ( defined( 'SHOW_ORDER_REVIEW' ) && SHOW_ORDER_REVIEW ) ) : ?></div><?php endif; ?>