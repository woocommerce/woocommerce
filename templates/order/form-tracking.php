...
<form action="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" method="post" class="track_order">
	...
	<p><?php _e( 'To track your order, please enter your Order ID below.', 'woocommerce' ); ?></p>
	...
	<p class="form-row"><input type="submit" class="button" name="track" value="<?php esc_attr_e( 'Track Order', 'woocommerce' ); ?>" /></p>
