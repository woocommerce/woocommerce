			...
			foreach ($customer_orders as $customer_order) :
				...
				?><tr class="order">
					...
					<td class="order-actions" style="text-align:right; white-space:nowrap;">
						...
						<a href="<?php echo esc_url( add_query_arg( 'order_again', $order->id, get_permalink( woocommerce_get_page_id( 'myaccount' ) ) ) ); ?>" class="button"><?php _e('Order again', 'woocommerce'); ?></a>
					</td>
				</tr><?php
			endforeach;
		?></tbody>
