...
<?php else : ?>
	...
	<?php wc_print_notice( '<a class="woocommerce-button button" href="' . esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ) . '">' . __( 'Go shop', 'woocommerce' ) . '</a> ' . __( 'No order has been made yet.', 'woocommerce' ), 'notice' ); ?>
