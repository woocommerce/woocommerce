...
describe('SettingService', function () {
    ...
    var service;
    beforeEach(function () {
        repository = jest_mock_extended_1.mock();
        service = new setting_service_1.SettingService(repository);
    });
    it('should update address', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.updateStoreAddress('line1', 'line2', 'New York', 'US:NY', '12345')];
                case 1:
                    result = _a.sent();
