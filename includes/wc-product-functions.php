...
function wc_get_product_ids_on_sale() {
	...
	set_transient( 'wc_products_onsale', $product_ids_on_sale, WC_EXPIRE_YEAR_IN_SECONDS );
...
function wc_get_featured_product_ids() {
	...
	set_transient( 'wc_featured_products', $featured_product_ids, WC_EXPIRE_YEAR_IN_SECONDS );
