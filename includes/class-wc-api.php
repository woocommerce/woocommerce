...
class WC_API extends WC_Legacy_API {
	...
	private function rest_api_includes() {
		...
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-coupons-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-customer-downloads-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-customers-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-orders-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-network-orders-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-order-notes-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-order-refunds-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-product-attribute-terms-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-product-attributes-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-product-categories-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-product-reviews-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-product-shipping-classes-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-product-tags-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-products-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-product-variations-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-report-sales-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-report-top-sellers-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-reports-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-settings-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-setting-options-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-shipping-zones-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-shipping-zone-locations-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-shipping-zone-methods-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-tax-classes-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-taxes-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-webhook-deliveries-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-webhooks-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-system-status-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-system-status-tools-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-shipping-methods-v2-controller.php';
		include_once dirname( __FILE__ ) . '/api/class-wc-rest-payment-gateways-v2-controller.php';
