...
return array(
	...
	'testmode' => array(
		...
		'default'     => 'no',
		'description' => sprintf( __( 'PayPal sandbox can be used to test payments. Sign up for a <a href="%s">developer account</a>.', 'woocommerce' ), esc_url( 'https://developer.paypal.com/' ) ),
	),
	'debug' => array(
	...
	'api_details' => array(
		...
		'type'        => 'title',
		'description' => sprintf( __( 'Enter your PayPal API credentials to process refunds via PayPal. Learn how to access your <a href="%s">PayPal API Credentials</a>.', 'woocommerce' ), esc_url( 'https://developer.paypal.com/webapps/developer/docs/classic/api/apiCredentials/#creating-an-api-signature' ) ),
	),
	'api_username' => array(
