	...
	public function form() {
		...
		$default_fields = array(
			'routing-number' => '<p class="form-row form-row-first">
				...
				<input id="' . esc_attr( $this->id ) . '-routing-number" class="input-text wc-echeck-form-routing-number" type="text" maxlength="9" autocomplete="none" placeholder="•••••••••" name="' . esc_attr( $this->id ) . '-routing-number" />
			</p>',
			'account-number' => '<p class="form-row form-row-wide">
				...
				<input id="' . esc_attr( $this->id ) . '-account-number" class="input-text wc-echeck-form-account-number" type="text" autocomplete="none" name="' . esc_attr( $this->id ) . '-account-number" maxlength="17" />
			</p>',
		);
