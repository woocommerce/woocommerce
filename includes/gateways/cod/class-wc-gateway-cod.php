...
class WC_Gateway_COD extends WC_Payment_Gateway {
	...
	public function is_available() {
		...
		if ( ! empty( $this->enable_for_methods ) && $needs_shipping ) {
			...
			if ( is_object( $order ) && ( $order_shipping_items = $order->get_shipping_methods() ) ) {
				$canonical_rate_ids = $this->get_canonical_order_shipping_item_rate_ids( $order_shipping_items );
			} elseif ( $chosen_package_rate_ids = WC()->session->get( 'chosen_shipping_methods' ) ) {
				$canonical_rate_ids = $this->get_canonical_package_rate_ids( $chosen_package_rate_ids );
			}
