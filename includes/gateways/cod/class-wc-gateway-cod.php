...
class WC_Gateway_COD extends WC_Payment_Gateway {
	 ...
	 * @since 3.4.0
	 *
	 * @param rray $chosen_package_rate_ids Rate IDs as generated by shipping methods. Can be anything if a shipping method doesn't honor WC conventions.
	 * @return array $canonical_rate_ids  Rate IDs in a canonical format.
	 */
	 ...
	 *
	 * @since 3.1.0
	 * @param tring         $status Current order status.
	 * @param nt            $order_id Order ID.
	 * @param C_Order|false $order Order object.
	 * @return string
	 */
