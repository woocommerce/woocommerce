...
function woocommerce_customer_bought_product( $customer_email, $user_id, $product_id ) {
	wc_deprecated_function( __FUNCTION__, '3.0', 'WC_Order_Product_Lookup_Helper::is_product_purchased' );
	return WC_Order_Product_Lookup_Helper::is_product_purchased( $product_id, is_int( $user_id ) ? $user_id : $customer_email );
}
