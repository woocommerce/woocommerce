...
/**
 * A copy of wp_get_update_php_url as per WP 5.1, this is compatibility with sites running WP < 5.1
 *
 * @since 3.6.5
 * @return string
 */
function wc_get_update_php_url() {
	$default_url = 'https://wordpress.org/support/update-php/';
...
/**
 * Get the URL pointing to the upgrading WordPress article.
 *
 * @return string
 */
function wc_get_update_wp_url() {
	$default_url = 'https://wordpress.org/support/article/updating-wordpress/';

	/**
	 * Filters the URL to learn about updating WordPress. Empty urls not allowed.
	 *
	 * @since 3.5.4
	 * @param string $update_url URL to learn more about updating WordPress.
	 */
	$update_url = apply_filters( 'wc_update_wp_url', $default_url );
