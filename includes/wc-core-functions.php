...
/**
 * Returns the number of character necessary to type before doing a request to search for products in the backend
 *
 * @since 3.6.0
 *
 * @param bool $with_variation
 * @param int  $limit
 *
 * @return int
 */
function wc_get_minimum_input_length_for_product_search( $with_variation = true, $limit = 0 ) {
	return intval( apply_filters( 'wc_get_minimum_input_length_for_product_search', 3, $with_variation, $limit ) );
}

/**
 * Returns the number of character necessary to type before doing a request to search categories in the backend
 *
 * @since 3.6.0
 *
 * @return int
 */
function wc_get_minimum_input_length_for_category_search() {
	return intval( apply_filters( 'wc_get_minimum_input_length_for_category_search', 3 ) );
}

/**
 * Returns the number of character necessary to type before doing a request to search customer in the backend
 *
 * @since 3.6.0
 *
 * @return int
 */
function wc_get_minimum_input_length_for_customer_search() {
	return intval( apply_filters( 'wc_get_minimum_input_length_for_customer_search', 3 ) );
}
