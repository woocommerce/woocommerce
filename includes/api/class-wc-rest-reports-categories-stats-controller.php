...
class WC_REST_Reports_Categories_Stats_Controller extends WC_REST_Reports_Controller {
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'woocommerce_rest_prepare_report_categories_stats', $response, $report, $request );
	}
	...
	public function get_item_schema() {
		$totals = array(
			...
			'products_count' => array(
				'description' => __( 'Amount of orders products.', 'woocommerce' ),
				'type'        => 'integer',
				'context'     => array( 'view', 'edit' ),
				'readonly'    => true,
			),
