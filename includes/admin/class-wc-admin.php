...
class WC_Admin {
	...
	public function admin_redirects() {
		...
		if ( get_transient( '_wc_activation_redirect' ) ) {
			...
			if ( ( ! empty( $_GET['page'] ) && in_array( $_GET['page'], array( 'wc-setup' ) ) ) || is_network_admin() || isset( $_GET['activate-multi'] ) || ! current_user_can( 'manage_woocommerce' ) || apply_filters( 'woocommerce_prevent_automatic_wizard_redirect', false ) ) { // WPCS: Sanitization ok.
				return;
			}
