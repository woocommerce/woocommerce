...
<form class="wc-progress-form-content woocommerce-importer" enctype="multipart/form-data" method="post">
	...
	<div class="wc-actions">
		<a href="#" class="woocommerce-importer-toggle-advanced-options" data-hidetext="<?php esc_attr_e( 'Hide advanced options', 'woocommerce' ); ?>" data-showtext="<?php esc_html_e( 'Show advanced options', 'woocommerce' ); ?>"><?php esc_attr_e( 'Show advanced options', 'woocommerce' ); ?></a>
