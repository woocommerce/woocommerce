...
class WC_Admin_List_Table_Orders extends WC_Admin_List_Table {
	...
	protected function render_filters() {
		...
		?>
		<select class="wc-customer-search" name="_customer_user" data-minimum_input_length="<?php wc_get_minimum_input_length_for_customer_search() ?>" data-placeholder="<?php esc_attr_e( 'Filter by registered customer', 'woocommerce' ); ?>" data-allow_clear="true">
