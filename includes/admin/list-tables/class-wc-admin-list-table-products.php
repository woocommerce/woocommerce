...
class WC_Admin_List_Table_Products extends WC_Admin_List_Table {
	...
	protected function render_products_category_filter() {
		...
		if ( $categories_count <= apply_filters( 'woocommerce_product_category_filter_threshold', 100 ) ) {
			...
			?>
			<select class="wc-category-search" name="product_cat" data-minimum_input_length="<?php echo wc_get_minimum_input_length_for_category_search(); ?> data-placeholder="<?php esc_attr_e( 'Filter by category', 'woocommerce' ); ?>" data-allow_clear="true">
