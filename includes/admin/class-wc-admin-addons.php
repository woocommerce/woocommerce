...
class WC_Admin_Addons {
	...
	public static function output_column( $block ) {
		if ( isset( $block->container ) && $block->container === 'column_container_start' ) {
			?>
			<div class="addons-column-section">
			<?php
		}
		if ( $block->module === 'column_start' ) {
			?>
		...
		if ( isset( $block->container ) && $block->container === 'column_container_end' ) {
			?>
			</div>
			<?php
		}
	...
	public static function output_small_light_block( $block ) {
		...
		<div class="addons-small-light-block">
			<img class="addons-img" src="<?php echo esc_attr( $block->image ) ?>" />
	...
	public static function output_button( $url, $text, $theme, $plugin = '' ) {
		$theme = $text === 'Free' ? 'addons-button-outline-green' : $theme;
