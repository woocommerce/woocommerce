...
class WC_Admin_Report {
	 ...
	 *
	 * @param rray  $data array of your data
	 * @param tring $date_key key for the 'date' field. e.g. 'post_date'
	 * @param tring $data_key key for the data you are charting
	 * @param nt    $interval
	 * @param tring $start_date
	 * @param tring $group_by
	 * @return array
	 */
	 ...
	 *
	 * @param nt    $id ID of the product to show. Blank to get all orders.
	 * @param nt    $days Days of stats to get.
	 * @param tring $type Type of sparkline to get. Ignored if ID is not set.
	 * @return string
	 */
	 ...
	 *
	 * @since 3.0.4
	 * @param tring $current_range Current range.
	 */
