...
class WC_Admin_Exporters {
	...
	public function do_ajax_product_export() {
		...
		if ( ! empty( $_POST['export_category'] ) ) {// WPCS: input var ok.
			$exporter->set_product_category_to_export( wp_unslash( $_POST['export_category'] ) ); // WPCS: input var ok, sanitization ok.
		}
