	...
	public function status_widget() {
		...
		<ul class="wc_status_list">
			...
			<li class="processing-orders">
				<a href="<?php echo admin_url( 'edit.php?s&post_status=wc-processing&post_type=shop_order' ); ?>">
			...
			<li class="on-hold-orders">
				<a href="<?php echo admin_url( 'edit.php?s&post_status=wc-on-hold&post_type=shop_order' ); ?>">
