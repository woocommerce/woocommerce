		...
		<div id="coupon_options" class="panel-wrap coupon_data">
			...
			<div id="usage_restriction_coupon_data" class="panel woocommerce_options_panel"><?php
				...
				woocommerce_wp_text_input( array(
					...
					'description'       => __( 'List of allowed emails to check against the customer billing email when an order is placed. Separate email addresses with commas. You can also use an asterisk (*) to match anything. For example "*@gmail.com" would match all gmail addresses.', 'woocommerce' ),
