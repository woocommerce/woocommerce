		...
		<div id="coupon_options" class="panel-wrap coupon_data">
			...
			<div id="usage_restriction_coupon_data" class="panel woocommerce_options_panel">
				...
				<p class="form-field">
					...
					<select class="wc-product-search" multiple="multiple" data-minimum_input_length="<?php echo wc_get_minimum_input_length_for_product_search(); ?>" style="width: 50%;" name="product_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'woocommerce' ); ?>" data-action="woocommerce_json_search_products_and_variations">
						<?php
				...
				<p class="form-field">
					...
					<select class="wc-product-search" multiple="multiple" data-minimum_input_length="<?php echo wc_get_minimum_input_length_for_product_search(); ?>" style="width: 50%;" name="exclude_product_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'woocommerce' ); ?>" data-action="woocommerce_json_search_products_and_variations">
						<?php
