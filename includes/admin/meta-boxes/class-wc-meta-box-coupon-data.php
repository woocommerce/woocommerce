	...
	public static function output( $post ) {
		...
		<div id="coupon_options" class="panel-wrap coupon_data">
			...
			<div id="general_coupon_data" class="panel woocommerce_options_panel"><?php
				...
				// Individual use
				woocommerce_wp_checkbox( array( 'id' => 'enabled', 'label' => __( 'With this option permits to add a coupon without enabled, being able to become Enabled thought API.', 'woocommerce' ), 'description' => __( 'Check this box if the coupon will be enabled to use right now.', 'woocommerce' ) ) );
