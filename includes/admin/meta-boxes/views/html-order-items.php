...
<div class="wc-order-data-row wc-order-refund-items wc-order-data-row-toggle" style="display: none;">
	<table class="wc-order-totals">
		...
		<tr>
			...
			<td class="total">
				<input type="text" class="wc_input_strict_price" id="refund_amount" name="refund_amount" />
				<div class="clear"></div>
			</td>
		</tr>
		<tr>
			...
			<td class="total">
				<input type="text" class="wc_input_strict_price" id="refund_reason" name="refund_reason" />
				<div class="clear"></div>
			</td>
		</tr>
	</table>
