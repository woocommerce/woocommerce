				...
				<article>
					<form action="" method="post">
						<table class="widefat">
							...
							<?php
								$row = '
									<td><select class="wc-product-search" name="item_id" data-minimum_input_length="<?php echo wc_get_minimum_input_length_for_product_search() ?>" data-allow_clear="true" data-display_stock="true" data-placeholder="' . esc_attr__( 'Search for a product&hellip;', 'woocommerce' ) . '"></select></td>
