				...
				<div class="order_data_column_container">
					<div class="order_data_column">
						...
						<p class="form-field form-field-wide">
							...
							?>
							<input type="hidden" class="wc-customer-search" name="customer_user" data-placeholder="<?php _e( 'Guest', 'woocommerce' ); ?>" data-selected="<?php echo esc_attr( $user_string ); ?>" value="<?php echo $user_id; ?>" data-allow_clear="true" />
						</p>
