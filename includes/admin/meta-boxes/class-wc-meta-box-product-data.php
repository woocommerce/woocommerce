		...
		if ( isset( $_POST['variable_post_id'] ) ) {
			...
			for ( $i = 0; $i <= $max_loop; $i ++ ) {
				...
				$errors       = $variation->set_props( array(
					...
					'stock_quantity'    => 'yes' === get_option( 'woocommerce_manage_stock' ) && isset( $_POST['variable_stock'][ $i ] ) ? wc_clean( $_POST['variable_stock'][ $i ] ) : null,
					'backorders'        => 'yes' === get_option( 'woocommerce_manage_stock' ) && isset( $_POST['variable_backorders'][ $i ] ) ? wc_clean( $_POST['variable_backorders'][ $i ] ) : null,
