		...
		if ( isset( $_POST['variable_post_id'] ) ) {
			...
			for ( $i = 0; $i <= $max_loop; $i ++ ) {
				...
				$errors       = $variation->set_props( array(
					...
					'downloads'            => self::prepare_downloads( isset( $_POST['_wc_variation_file_names'][ $i ] ) ? $_POST['_wc_variation_file_names'][ $i ] : array(), isset( $_POST['_wc_variation_file_urls'][ $i ] ) ? $_POST['_wc_variation_file_urls'][ $i ] : array() ),
					'manage_stock'         => isset( $_POST['variable_stock'][ $i ] ),
