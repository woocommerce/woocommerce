	...
	public static function save( $post_id, $post ) {
		...
		$errors = $product->set_props(
			array(
				...
				'shipping_class_ids' => isset( $_POST['product_shipping_class'] ) ? array_unique( array_map( 'intval', $_POST['product_shipping_class'] ) ) : array(),
			...
			for ( $i = 0; $i <= $max_loop; $i++ ) {
				...
				$errors = $variation->set_props(
					array(
						...
						'shipping_class_ids'=> isset( $_POST['variable_shipping_class'][ $i ] ) ? array_unique( array_map( 'intval', $_POST['variable_shipping_class'][ $i ] ) ) : array(),
