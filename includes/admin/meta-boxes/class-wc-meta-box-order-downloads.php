...
class WC_Meta_Box_Order_Downloads {
	...
	public static function output( $post ) {
		...
		<div class="order_download_permissions wc-metaboxes-wrapper">
			...
			<div class="toolbar">
				<p class="buttons">
					<select name="grant_access_id" id="grant_access_id" class="ajax_select2_select_downloadable_products_and_variations" multiple="multiple" data-placeholder="<?php _e( 'Search for a downloadable product&hellip;', 'woocommerce' ) ?>" style="width: 400px"></select>
