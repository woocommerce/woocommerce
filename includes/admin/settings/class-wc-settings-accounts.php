...
class WC_Settings_Accounts extends WC_Settings_Page {
	...
	public function get_settings() {
		...
		$account_settings = array(
			...
			array(
				'desc'          => __( 'When creating an account, automatically generate an account password overwrite', 'woocommerce' ),
				'id'            => 'woocommerce_registration_generate_password_overwrite',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => 'end',
				'autoload'      => false,
