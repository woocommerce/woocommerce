...
class WC_Settings_Accounts extends WC_Settings_Page {
	...
	public function get_settings() {
		...
		$account_settings = array(
			...
			array(
				'desc'            => __( 'When creating an account, allow customers to overwrite automatic password generation by optionally supplying a password', 'woocommerce' ),
				'id'              => 'woocommerce_registration_generate_password_allow_overwrite',
				'default'         => 'yes',
				'type'            => 'checkbox',
				'show_if_checked' => 'yes',
				'checkboxgroup'   => 'end',
