		...
		$settings = apply_filters(
			...
			array(
				...
				array(
					...
					'desc_tip'      => sprintf( esc_html__( 'Do not check this box, If you do not wish to opt-in for WooCommerce.com to track your usage data and we will not know your store exists or not provide you recommendations. %s.', 'woocommerce' ), $tracking_info_text ),
