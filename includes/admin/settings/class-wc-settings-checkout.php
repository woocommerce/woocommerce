	...
	public function get_settings() {
		$settings = apply_filters( 'woocommerce_payment_gateways_settings', array(
			...
			array(
				...
				'desc_tip'        => sprintf( __( 'Force SSL (HTTPS) on the checkout pages (<a href="%s" target="_blank">an SSL Certificate is required</a>).', 'woocommerce' ), esc_url( 'https://docs.woocommerce.com/document/ssl-and-https/#section-3' ) ),
			),
