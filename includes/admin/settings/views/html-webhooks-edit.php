		...
		<tbody>
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_add_help_tip( sprintf( __( 'Friendly name for identifying this webhook, defaults to Webhook created on %s.', 'woocommerce' ), strftime( _x( '%b %d, %Y @ %I:%M %p', 'Webhook created on date parsed by strftime', 'woocommerce' ) ) ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php wc_add_help_tip( __( 'The options are &quot;Active&quot; (delivers payload), &quot;Paused&quot; (does not deliver), or &quot;Disabled&quot; (does not deliver due delivery failures).', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_add_help_tip( __( 'Select when the webhook will fire.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top" id="webhook-action-event-wrap">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_add_help_tip( __( 'Enter the Action that will trigger this webhook.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top" id="webhook-custom-topic-wrap">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_add_help_tip( __( 'Enter the Custom Topic that will trigger this webhook.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_add_help_tip( __( 'URL where the webhook payload is delivered.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_add_help_tip( __( 'The Secret Key is used to generate a hash of the delivered webhook and provided in the request headers. This will default to the current API user\'s consumer secret if not provided.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
