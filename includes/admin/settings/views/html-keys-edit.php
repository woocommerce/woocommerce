		...
		<tbody>
			...
			<tr valign="top">
				...
				<td class="forminp">
					...
					?>
					<select class="wc-customer-search" id="key_user" data-minimum_input_length="<?php wc_get_minimum_input_length_for_customer_search() ?>" data-placeholder="<?php esc_attr_e( 'Search for a user&hellip;', 'woocommerce' ); ?>" data-allow_clear="true">
