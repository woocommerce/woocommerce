...
<div class="wrap woocommerce wc_addons_wrap">
	...
	<?php if ( $sections ) : ?>
		...
		<?php endif; ?>
	<?php else : ?>
		<p><?php printf( __( 'Our catalog of WooCommerce Extensions can be found on WooCommerce.com here: <a href="%s">WooCommerce Extensions Catalog</a>', 'woocommerce' ), esc_url( 'https://woocommerce.com/product-category/woocommerce-extensions/' ) ); ?></p>
	<?php endif; ?>
	...
	<?php if ( 'Storefront' !== $theme['Name'] && 'featured' !== $current_section ) : ?>
		<div class="storefront">
			...
			<p><?php _e( 'We recommend Storefront, the <strong>official</strong> WooCommerce theme.', 'woocommerce' ); ?></p>
