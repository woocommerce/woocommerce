...
<div class="wrap woocommerce wc_addons_wrap">
	...
	<?php if ( $sections ) : ?>
		...
		<br class="clear" />
		<?php if ( $current_section === 'featured' ) : ?>
		...
		<?php endif; ?>
		<?php if ( $current_section !== 'featured' && $addons = WC_Admin_Addons::get_section_data( $current_section ) ) : ?>
			<ul class="products">
	...
	<?php if ( 'Storefront' !== $theme['Name'] && $current_section !== 'featured' ) : ?>
