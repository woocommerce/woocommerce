	...
	<?php
		echo wp_kses_post(
			sprintf(
				...
				__( 'Your store\'s uploads directory (<code>%1$s</code>) is unprotected. We highly recommend securing your uploads directory against indexing. <a href="%2$s">Learn more here.</a>', 'woocommerce' ),
				$uploads['basedir'],
