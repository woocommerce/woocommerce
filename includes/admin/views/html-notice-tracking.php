...
<div id="message" class="updated woocommerce-message woocommerce-tracker">
	<p><?php printf( __( 'Want to help make WooCommerce even more awesome? Allow WooCommerce to collect non-sensitive diagnostic data and usage information, and <a href="%1$s" target="_blank">get %2$s discount on your next WooThemes purchase</a>.', 'woocommerce' ), esc_url( 'https://woocommerce.com/usage-tracking/' ), '20%' ); ?></p>
	<p class="submit">
