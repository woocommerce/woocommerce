...
class WC_Admin_Attributes {
	...
	private static function process_edit_attribute() {
		...
		echo '<div class="updated"><p>' . __( 'Attribute updated successfully', 'woocommerce' ) . '</p><p><a href="'. admin_url( 'edit.php?post_type=product&amp;page=product_attributes' ).'">&larr; ' . __( 'Back to Attributes', 'woocommerce' ) . '</a></p></div>';
