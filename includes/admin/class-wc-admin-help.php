	...
	public function add_tabs() {
		...
		$screen->add_help_tab( array(
			...
			'content'	=>
				...
				'<p><a href="' . esc_url( 'http://docs.woothemes.com/documentation/plugins/woocommerce/' ) . '" class="button button-primary">' . __( 'WooCommerce Documentation', 'woocommerce' ) . '</a> <a href="' . esc_url( 'http://docs.woothemes.com/wc-apidocs/' ) . '" class="button">' . __( 'Developer API Docs', 'woocommerce' ) . '</a></p>'
		...
		$screen->add_help_tab( array(
			...
			'content'	=>
				...
				'<p><a href="' . admin_url('admin.php?page=wc-status') . '" class="button button-primary">' . __( 'System Status', 'woocommerce' ) . '</a> <a href="' . esc_url( 'http://wordpress.org/support/plugin/woocommerce' ) . '" class="button">' . __( 'Community Support', 'woocommerce' ) . '</a> <a href="' . esc_url( 'http://support.woothemes.com' ) . '" class="button">' . __( 'Customer Support', 'woocommerce' ) . '</a></p>'
		...
		$screen->add_help_tab( array(
			...
			'content'	=>
				...
				'<p><a href="' . esc_url( 'https://github.com/woothemes/woocommerce/issues?state=open' ) . '" class="button button-primary">' . __( 'Report a bug', 'woocommerce' ) . '</a> <a href="' . admin_url('admin.php?page=wc-status') . '" class="button">' . __( 'System Status', 'woocommerce' ) . '</a></p>'
