...
class WC_Admin_Meta_Boxes {
	...
	public function add_meta_boxes() {
		...
		foreach ( wc_get_order_types( 'order-meta-boxes' ) as $type ) {
			...
			add_meta_box( 'woocommerce-order-downloads', __( 'Downloadable Product Permissions', 'woocommerce' ) . wc_add_help_tip( __( 'Note: Permissions for order items will automatically be granted when the order status changes to processing/completed.', 'woocommerce' ) ), 'WC_Meta_Box_Order_Downloads::output', $type, 'normal', 'default' );
