 ...
 * My Account.
 */
add_action( 'woocommerce_my_account_orders_endpoint', 'woocommerce_account_orders' );
add_action( 'woocommerce_my_account_view-order_endpoint', 'woocommerce_account_view_order' );
add_action( 'woocommerce_my_account_downloads_endpoint', 'woocommerce_account_downloads' );
add_action( 'woocommerce_my_account_edit-account_endpoint', 'woocommerce_account_edit_account' );
add_action( 'woocommerce_my_account_edit-address_endpoint', 'woocommerce_account_edit_address' );
add_action( 'woocommerce_my_account_add-payment-method_endpoint', 'woocommerce_account_add_payment_method' );
