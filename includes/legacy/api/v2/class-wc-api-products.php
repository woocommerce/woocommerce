...
class WC_API_Products extends WC_API_Resource {
	...
	private function get_product_data( $product ) {
		...
		return array(
			...
			'shipping_classes'   => $product->get_shipping_classes(),
			'shipping_class_ids' => array_map( 'absint', $product->get_shipping_class_ids() ),
	...
	private function get_variation_data( $product ) {
		...
		foreach ( $product->get_children() as $child_id ) {
			...
			$variations[] = array(
				...
				'shipping_classes'  => $variation->get_shipping_classes(),
				'shipping_class_ids'=> array_map( 'absint', $variation->get_shipping_class_ids() ),
