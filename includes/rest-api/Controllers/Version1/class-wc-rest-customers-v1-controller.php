...
class WC_REST_Customers_V1_Controller extends WC_REST_Controller {
	 ...
	 * @return WP_Error|WP_REST_Response
	 *
	 * @throws WC_REST_Exception Throws an error if either the id, customer email are invalid or username is not editable.
	 */
	 ...
	 *
	 * @param WC_Customer     $customer A wc customer.
	 * @param WP_REST_Request $request Request object.
	 */
