...
if ( ! function_exists( 'woocommerce_account_orders' ) ) {
	...
	function woocommerce_account_orders( $current_page ) {
		...
		$customer_orders = wc_get_orders( apply_filters( 'woocommerce_my_account_my_orders_query', array( 'customer' => get_current_user_id(), 'paged' => $current_page, 'paginate' => true ) ) );
