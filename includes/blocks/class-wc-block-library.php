...
class WC_Block_Library {
	...
	public static function init() {
		...
		add_action( 'admin_print_footer_scripts', array( 'WC_Block_Library', 'print_script_wc_settings' ), 1 );
		add_action( 'admin_print_footer_scripts', array( 'WC_Block_Library', 'print_script_block_data' ), 1 );
		add_action( 'wp_print_footer_scripts', array( 'WC_Block_Library', 'print_script_block_data' ), 1 );
		add_action( 'body_class', array( 'WC_Block_Library', 'add_theme_body_class' ), 1 );
	}
	...
	protected static function register_script( $handle, $src, $deps = array(), $has_i18n = true ) {
		...
		$deps_path    = WC_ABSPATH . str_replace( '.js', '.deps.json', $filename );
	...
	public static function register_assets() {
		...
		self::register_style( 'wc-block-style', WC()->plugin_url() . '/assets/css/blocks/style.css', array( 'wp-components' ) );

		// Shared libraries and components across all blocks.
		self::register_script( 'wc-blocks', WC()->plugin_url() . '/assets/js/blocks/blocks.js', array(), false );
		self::register_script( 'wc-vendors', WC()->plugin_url() . '/assets/js/blocks/vendors.js', array(), false );
		self::register_script( 'wc-packages', WC()->plugin_url() . '/assets/js/blocks/packages.js', array(), false );
		self::register_script( 'wc-frontend', WC()->plugin_url() . '/assets/js/blocks/frontend.js', array( 'wc-vendors' ) );

		// Individual blocks.
		self::register_script( 'wc-handpicked-products', WC()->plugin_url() . '/assets/js/blocks/handpicked-products.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-product-best-sellers', WC()->plugin_url() . '/assets/js/blocks/product-best-sellers.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-product-category', WC()->plugin_url() . '/assets/js/blocks/product-category.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-product-new', WC()->plugin_url() . '/assets/js/blocks/product-new.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-product-on-sale', WC()->plugin_url() . '/assets/js/blocks/product-on-sale.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-product-top-rated', WC()->plugin_url() . '/assets/js/blocks/product-top-rated.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-products-attribute', WC()->plugin_url() . '/assets/js/blocks/products-attribute.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-featured-product', WC()->plugin_url() . '/assets/js/blocks/featured-product.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
		self::register_script( 'wc-product-categories', WC()->plugin_url() . '/assets/js/blocks/product-categories.js', array( 'wc-vendors', 'wc-packages', 'wc-blocks' ) );
	}
	...
	public static function register_blocks() {
		require_once dirname( __FILE__ ) . '/class-wc-block-grid-base.php';
	...
	public static function render_product_new( $attributes, $content ) {
		require_once dirname( __FILE__ ) . '/class-wc-block-product-new.php';

		$block = new WC_Block_Product_New( $attributes, $content );
		return $block->render();
	}
	...
	public static function render_product_on_sale( $attributes, $content ) {
		require_once dirname( __FILE__ ) . '/class-wc-block-product-on-sale.php';

		$block = new WC_Block_Product_On_Sale( $attributes, $content );
		return $block->render();
	}
	...
	public static function render_product_category( $attributes, $content ) {
		require_once dirname( __FILE__ ) . '/class-wc-block-product-category.php';

		$block = new WC_Block_Product_Category( $attributes, $content );
		return $block->render();
	}
	...
	public static function render_products_by_attribute( $attributes, $content ) {
		require_once dirname( __FILE__ ) . '/class-wc-block-products-by-attribute.php';

		$block = new WC_Block_Products_By_Attribute( $attributes, $content );
		return $block->render();
	}
	...
	public static function render_product_top_rated( $attributes, $content ) {
		require_once dirname( __FILE__ ) . '/class-wc-block-product-top-rated.php';

		$block = new WC_Block_Product_Top_Rated( $attributes, $content );
		return $block->render();
	}
	...
	public static function render_product_best_sellers( $attributes, $content ) {
		require_once dirname( __FILE__ ) . '/class-wc-block-product-best-sellers.php';

		$block = new WC_Block_Product_Best_Sellers( $attributes, $content );
		return $block->render();
	}
	...
	public static function render_handpicked_products( $attributes, $content ) {
		require_once dirname( __FILE__ ) . '/class-wc-block-handpicked-products.php';

		$block = new WC_Block_Handpicked_Products( $attributes, $content );
		return $block->render();
	}
