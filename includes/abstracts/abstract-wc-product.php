...
class WC_Product {
	...
	public function get_average_rating() {
		...
		if ( false === ( $average_rating = get_transient( $transient_name ) ) ) {
			...
			set_transient( $transient_name, $average_rating, WC_EXPIRE_YEAR_IN_SECONDS );
		}
	...
	public function get_rating_count( $value = null ) {
		...
		if ( false === ( $count = get_transient( $transient_name ) ) ) {
			...
			set_transient( $transient_name, $count, WC_EXPIRE_YEAR_IN_SECONDS );
		}
	...
	public function get_related( $limit = 5 ) {
		...
		if ( false === ( $max_related_posts = get_transient( $max_related_posts_transient_name ) ) ) {
			...
			set_transient( $max_related_posts_transient_name, $max_related_posts, WC_EXPIRE_YEAR_IN_SECONDS );
		}
