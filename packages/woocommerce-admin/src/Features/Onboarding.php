...
class Onboarding {
	...
	public static function get_allowed_industries() {
		return apply_filters(
			...
			array(
				'fashion-apparel-accessories' => __( 'Fashion, apparel, and accessories', 'woocommerce' ),
				'health-beauty'               => __( 'Health and beauty', 'woocommerce' ),
				'art-music-photography'       => __( 'Art, music, and photography', 'woocommerce' ),
				'electronics-computers'       => __( 'Electronics and computers', 'woocommerce' ),
				'food-drink'                  => __( 'Food and drink', 'woocommerce' ),
				'home-furniture-garden'       => __( 'Home, furniture, and garden', 'woocommerce' ),
