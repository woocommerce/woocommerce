...
class OnboardingTasks extends \WC_REST_Data_Controller {
	...
	private static function get_homepage_cover_block( $image ) {
		if ( ! empty( $image['url'] ) && ! empty( $image['id'] ) ) {
			...
			<div class="wp-block-cover has-background-dim" style="background-image:url(' . esc_url( $image['url'] ) . ')"><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"' . __( 'Write title…', 'woocommerce' ) . '","fontSize":"large"} -->
			<p class="has-text-align-center has-large-font-size">' . __( 'Welcome to the store', 'woocommerce' ) . '</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">' . __( 'Write a short welcome message here', 'woocommerce' ) . '</p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-cover has-very-dark-gray-background-color has-background-dim"><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"' . __( 'Write title…', 'woocommerce' ) . '","fontSize":"large"} -->
		<p class="has-text-align-center has-large-font-size">' . __( 'Welcome to the store', 'woocommerce' ) . '</p>
		<!-- /wp:paragraph -->
	...
	public static function create_homepage() {
		...
		if ( ! is_wp_error( $post_id ) ) {
			...
			return array(
				'status'         => 'success',
				'message'        => __( 'Homepage created successfully.', 'woocommerce' ),
				'post_id'        => $post_id,
