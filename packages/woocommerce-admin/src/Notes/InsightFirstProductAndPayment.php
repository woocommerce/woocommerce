...
class InsightFirstProductAndPayment {
	...
	public static function get_note() {
		...
		$note->set_content( __( 'More than 80% of new merchants add the first product and have at least one payment method set up during the first week. We\'re here to help your business succeed! Do you find this type of insight useful?', 'woocommerce' ) );
