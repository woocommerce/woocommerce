...
/******/ 	return __webpack_require__(__webpack_require__.s = "./client/wp-admin-scripts/onboarding-homepage-notice/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!******************************!*\
  !*** ./client/lib/tracks.js ***!
  \******************************/
/*! exports provided: recordEvent, queueRecordEvent, recordPageView */
...
function recordEvent(eventName, eventProperties) {
  tracksDebug('recordevent %s %o', 'wcadmin_' + eventName, eventProperties, {
    _tqk: window._tkq,
    shouldRecord:  false && false
  });

  if (!window.wcTracks || typeof window.wcTracks.recordEvent !== 'function' || "development" === 'development') {
    return false;
  }
...
/***/ "./client/wp-admin-scripts/onboarding-homepage-notice/index.js":
/*!*********************************************************************!*\
  !*** ./client/wp-admin-scripts/onboarding-homepage-notice/index.js ***!
  \*********************************************************************/
/*! no exports provided */
    ...
    Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__["dispatch"])('core/notices').createSuccessNotice(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("🏠 Nice work creating your store's homepage!", 'woocommerce'), {
      ...
      actions: [{
        ...
        onClick: function onClick() {
          Object(lib_tracks__WEBPACK_IMPORTED_MODULE_4__["queueRecordEvent"])('tasklist_appearance_continue_setup', {});
          window.location = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_3__["getAdminLink"])('admin.php?page=wc-admin&task=appearance');
        }
      }]
    });
  });
...
/******/ });
//# sourceMappingURL=onboarding-homepage-notice.min.js.map
