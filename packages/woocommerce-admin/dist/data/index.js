...
function actions_updateInstalledPlugins(installed, added) {
  return {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 6:
          results = _context.sent;
          _context.next = 9;
          return actions_updateActivePlugins(results.plugins);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 6:
          results = _context2.sent;
          _context2.next = 9;
          return actions_updateInstalledPlugins(results);
...
var reducer_plugins = function plugins() {
  ...
  switch (type) {
    ...
    case plugins_action_types.UPDATE_INSTALLED_PLUGINS:
      state = reducer_objectSpread({}, state, {
        installed: added ? Object(external_lodash_["concat"])(state.installed, added) : installed,
        requesting: reducer_objectSpread({}, state.requesting, {
