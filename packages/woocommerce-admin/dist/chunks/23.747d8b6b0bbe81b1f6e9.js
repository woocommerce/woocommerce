...
var LazyDashboardCharts = Object(external_this_wp_element_["lazy"])(function () {
  return Promise.all(/* import() | dashboard-charts */[__webpack_require__.e(2), __webpack_require__.e(1), __webpack_require__.e(25)]).then(__webpack_require__.bind(null, 931));
});
var LazyLeaderboards = Object(external_this_wp_element_["lazy"])(function () {
  return Promise.all(/* import() | leaderboards */[__webpack_require__.e(3), __webpack_require__.e(31)]).then(__webpack_require__.bind(null, 936));
});
var LazyStorePerformance = Object(external_this_wp_element_["lazy"])(function () {
  return __webpack_require__.e(/* import() | store-performance */ 43).then(__webpack_require__.bind(null, 926));
});
...
var customizable_CustomizableDashboard = function CustomizableDashboard(_ref) {
  ...
  var _useUserPreferences = Object(external_this_wc_data_["useUserPreferences"])(),
      ...
      userPrefs = objectWithoutProperties_default()(_useUserPreferences, ["isRequesting", "updateUserPreferences"]);

  var _useState = Object(external_this_wp_element_["useState"])(isRequesting ? false : customizable_mergeSectionsWithDefaults(userPrefs.dashboard_sections)),
  ...
  if (!isRequesting && dashSections === false) {
    setSections(customizable_mergeSectionsWithDefaults(userPrefs.dashboard_sections));
  }

  var sections = dashSections || default_sections;
