...
var table_CouponsReportTable = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(CouponsReportTable, [{
    ...
    value: function getHeadersContent() {
      return [{
        label: Object(external_this_wp_i18n_["__"])('Coupon Code', 'woocommerce'),
        key: 'code',
        required: true,
        isLeftAligned: true,
        isSortable: true
        ...
        label: Object(external_this_wp_i18n_["__"])('Amount Discounted', 'woocommerce'),
        key: 'amount',
        isSortable: true,
        isNumeric: true
      }, {
        label: Object(external_this_wp_i18n_["__"])('Created', 'woocommerce'),
        key: 'created'
      }, {
        label: Object(external_this_wp_i18n_["__"])('Expires', 'woocommerce'),
        key: 'expires'
      }, {
        label: Object(external_this_wp_i18n_["__"])('Type', 'woocommerce'),
        key: 'type'
      }];
    }
  }, {
      ...
      return Object(external_lodash_["map"])(coupons, function (coupon) {
        ...
        return [{
          ...
          display: dateExpires ? Object(external_this_wp_element_["createElement"])(external_this_wc_components_["Date"], {
            date: dateExpires,
            visibleFormat: dateFormat
          }) : Object(external_this_wp_i18n_["__"])('N/A', 'woocommerce'),
          value: dateExpires
        }, {
    ...
    value: function getCouponType(discountType) {
      var couponTypes = {
        percent: Object(external_this_wp_i18n_["__"])('Percentage', 'woocommerce'),
        fixed_cart: Object(external_this_wp_i18n_["__"])('Fixed cart', 'woocommerce'),
        fixed_product: Object(external_this_wp_i18n_["__"])('Fixed product', 'woocommerce')
      };
    ...
    value: function render() {
      ...
      return Object(external_this_wp_element_["createElement"])(report_table["a" /* default */], {
        ...
        title: Object(external_this_wp_i18n_["__"])('Coupons', 'woocommerce'),
...
var coupons_CouponsReport = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(CouponsReport, [{
    ...
    value: function getChartMeta() {
      ...
      var itemsLabel = Object(external_this_wp_i18n_["__"])('%d coupons', 'woocommerce');
