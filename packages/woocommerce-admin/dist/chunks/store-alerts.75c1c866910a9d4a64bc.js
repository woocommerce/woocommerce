...
var style = __webpack_require__(778);
...
function store_alerts_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (store_alerts_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
