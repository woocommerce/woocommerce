(window["__wcAdmin_webpackJsonp"] = window["__wcAdmin_webpackJsonp"] || []).push([["devdocs"],{

/***/ "./client/devdocs/docs.js":
/*!********************************!*\
  !*** ./client/devdocs/docs.js ***!
  \********************************/
...
/* harmony import */ var marked__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! marked */ "./node_modules/marked/src/marked.js");
...
prismjs__WEBPACK_IMPORTED_MODULE_9___default.a.languages.es6 = prismjs__WEBPACK_IMPORTED_MODULE_9___default.a.languages.javascript; // Configure marked to use Prism for code-block highlighting.

marked__WEBPACK_IMPORTED_MODULE_8___default.a.setOptions({
  highlight: function highlight(code, language) {
    var syntax = prismjs__WEBPACK_IMPORTED_MODULE_9___default.a.languages[language];
    return syntax ? prismjs__WEBPACK_IMPORTED_MODULE_9___default.a.highlight(code, syntax) : code;
  }
});

var Docs = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(Docs, _Component);
  ...
  function Docs() {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Docs);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Docs, [{
    ...
    value: function getReadme() {
      ...
      var readme = __webpack_require__("./packages/components/src sync recursive ^\\.\\/.*\\/README\\.md$")("./".concat(filePath, "/README.md")).default;
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
        ...
        dangerouslySetInnerHTML: {
          __html: marked__WEBPACK_IMPORTED_MODULE_8___default()(readme)
        }
      });
    }
  }]);
...
var Example = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(Example, _Component);
  ...
  function Example() {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, Example);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Example, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.getExample();
    }
    ...
    key: "getExample",
    value: function () {
      var _getExample = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                try {
                  exampleComponent = __webpack_require__("./packages/components/src sync recursive ^\\.\\/.*\\/docs\\/example$")("./".concat(this.props.filePath, "/docs/example"));
                } catch (e) {
              ...
              case 3:
                this.setState({
                  example: react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(exampleComponent.default || exampleComponent)
                });
...
/* harmony import */ var _example__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./example */ "./client/devdocs/example.js");
/* harmony import */ var _docs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./docs */ "./client/devdocs/docs.js");
...
/* harmony import */ var _examples_json__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./examples.json */ "./client/devdocs/examples.json");
var _examples_json__WEBPACK_IMPORTED_MODULE_11___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./examples.json */ "./client/devdocs/examples.json", 1);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./style.scss */ "./client/devdocs/style.scss");
...
var getExampleData = function getExampleData(example) {
  var componentName = Object(lodash__WEBPACK_IMPORTED_MODULE_7__["get"])(example, 'component');
  var filePath = Object(lodash__WEBPACK_IMPORTED_MODULE_7__["get"])(example, 'filePath', camelCaseToSlug(componentName));
  return {
...
var _default = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(_default, _Component);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(_default, [{
    ...
    value: function render() {
      ...
      var className = classnames__WEBPACK_IMPORTED_MODULE_6___default()('woocommerce_devdocs', {
        'is-single': component,
        'is-list': !component
      });
      var exampleList = _examples_json__WEBPACK_IMPORTED_MODULE_11__;

      if (component) {
        var example = Object(lodash__WEBPACK_IMPORTED_MODULE_7__["find"])(_examples_json__WEBPACK_IMPORTED_MODULE_11__, function (ex) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
        ...
        var _getExampleData = getExampleData(example),
            componentName = _getExampleData.componentName,
            filePath = _getExampleData.filePath;

        var cardClasses = classnames__WEBPACK_IMPORTED_MODULE_6___default()('woocommerce-devdocs__card', "woocommerce-devdocs__card--".concat(filePath), 'woocommerce-analytics__card');
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["Fragment"], {
          key: componentName
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_10__["Card"], {
          key: "".concat(componentName, "-example"),
          className: cardClasses,
          title: component ? componentName : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_10__["Link"], {
            href: "admin.php?page=wc-admin&path=/devdocs&component=".concat(filePath),
            type: "wc-admin"
          }, componentName),
          action: component ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_10__["Link"], {
            href: '?page=wc-admin&path=/devdocs',
            type: "wc-admin"
          }, "Full list") : null
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_example__WEBPACK_IMPORTED_MODULE_8__["default"], {
          asyncName: componentName,
          component: componentName,
          filePath: filePath
        })), component && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_docs__WEBPACK_IMPORTED_MODULE_9__["default"], {
...
/***/ "./packages/components/src sync recursive ^\\.\\/.*\\/README\\.md$":
/*!***********************************************************!*\
  !*** ./packages/components/src sync ^\.\/.*\/README\.md$ ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./advanced-filters/README.md": "./packages/components/src/advanced-filters/README.md",
	"./animation-slider/README.md": "./packages/components/src/animation-slider/README.md",
	"./calendar/README.md": "./packages/components/src/calendar/README.md",
	"./card/README.md": "./packages/components/src/card/README.md",
	"./chart/README.md": "./packages/components/src/chart/README.md",
	"./chart/d3chart/d3base/README.md": "./packages/components/src/chart/d3chart/d3base/README.md",
	"./compare-filter/README.md": "./packages/components/src/compare-filter/README.md",
	"./count/README.md": "./packages/components/src/count/README.md",
	"./date-range-filter-picker/README.md": "./packages/components/src/date-range-filter-picker/README.md",
	"./date/README.md": "./packages/components/src/date/README.md",
	"./dropdown-button/README.md": "./packages/components/src/dropdown-button/README.md",
	"./ellipsis-menu/README.md": "./packages/components/src/ellipsis-menu/README.md",
	"./empty-content/README.md": "./packages/components/src/empty-content/README.md",
	"./filter-picker/README.md": "./packages/components/src/filter-picker/README.md",
	"./filters/README.md": "./packages/components/src/filters/README.md",
	"./flag/README.md": "./packages/components/src/flag/README.md",
	"./form/README.md": "./packages/components/src/form/README.md",
	"./gravatar/README.md": "./packages/components/src/gravatar/README.md",
	"./higher-order/use-filters/README.md": "./packages/components/src/higher-order/use-filters/README.md",
	"./image-upload/README.md": "./packages/components/src/image-upload/README.md",
	"./link/README.md": "./packages/components/src/link/README.md",
	"./list/README.md": "./packages/components/src/list/README.md",
	"./order-status/README.md": "./packages/components/src/order-status/README.md",
	"./pagination/README.md": "./packages/components/src/pagination/README.md",
	"./pill/README.md": "./packages/components/src/pill/README.md",
	"./plugins/README.md": "./packages/components/src/plugins/README.md",
	"./product-image/README.md": "./packages/components/src/product-image/README.md",
	"./rating/README.md": "./packages/components/src/rating/README.md",
	"./scroll-to/README.md": "./packages/components/src/scroll-to/README.md",
	"./search-list-control/README.md": "./packages/components/src/search-list-control/README.md",
	"./search/README.md": "./packages/components/src/search/README.md",
	"./section-header/README.md": "./packages/components/src/section-header/README.md",
	"./section/README.md": "./packages/components/src/section/README.md",
	"./segmented-selection/README.md": "./packages/components/src/segmented-selection/README.md",
	"./select-control/README.md": "./packages/components/src/select-control/README.md",
	"./spinner/README.md": "./packages/components/src/spinner/README.md",
	"./stepper/README.md": "./packages/components/src/stepper/README.md",
	"./summary/README.md": "./packages/components/src/summary/README.md",
	"./table/README.md": "./packages/components/src/table/README.md",
	"./tag/README.md": "./packages/components/src/tag/README.md",
	"./text-control-with-affixes/README.md": "./packages/components/src/text-control-with-affixes/README.md",
	"./text-control/README.md": "./packages/components/src/text-control/README.md",
	"./timeline/README.md": "./packages/components/src/timeline/README.md",
	"./view-more-list/README.md": "./packages/components/src/view-more-list/README.md",
	"./web-preview/README.md": "./packages/components/src/web-preview/README.md"
};
...
webpackContext.id = "./packages/components/src sync recursive ^\\.\\/.*\\/README\\.md$";

/***/ }),

/***/ "./packages/components/src sync recursive ^\\.\\/.*\\/docs\\/example$":
/*!**************************************************************!*\
  !*** ./packages/components/src sync ^\.\/.*\/docs\/example$ ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./advanced-filters/docs/example": "./packages/components/src/advanced-filters/docs/example.js",
	"./animation-slider/docs/example": "./packages/components/src/animation-slider/docs/example.js",
	"./calendar/docs/example": "./packages/components/src/calendar/docs/example.js",
	"./card/docs/example": "./packages/components/src/card/docs/example.js",
	"./chart/docs/example": "./packages/components/src/chart/docs/example.js",
	"./compare-filter/docs/example": "./packages/components/src/compare-filter/docs/example.js",
	"./count/docs/example": "./packages/components/src/count/docs/example.js",
	"./date-range-filter-picker/docs/example": "./packages/components/src/date-range-filter-picker/docs/example.js",
	"./date/docs/example": "./packages/components/src/date/docs/example.js",
	"./dropdown-button/docs/example": "./packages/components/src/dropdown-button/docs/example.js",
	"./ellipsis-menu/docs/example": "./packages/components/src/ellipsis-menu/docs/example.js",
	"./empty-content/docs/example": "./packages/components/src/empty-content/docs/example.js",
	"./filter-picker/docs/example": "./packages/components/src/filter-picker/docs/example.js",
	"./filters/docs/example": "./packages/components/src/filters/docs/example.js",
	"./flag/docs/example": "./packages/components/src/flag/docs/example.js",
	"./form/docs/example": "./packages/components/src/form/docs/example.js",
	"./gravatar/docs/example": "./packages/components/src/gravatar/docs/example.js",
	"./image-upload/docs/example": "./packages/components/src/image-upload/docs/example.js",
	"./link/docs/example": "./packages/components/src/link/docs/example.js",
	"./list/docs/example": "./packages/components/src/list/docs/example.js",
	"./order-status/docs/example": "./packages/components/src/order-status/docs/example.js",
	"./pagination/docs/example": "./packages/components/src/pagination/docs/example.js",
	"./pill/docs/example": "./packages/components/src/pill/docs/example.js",
	"./product-image/docs/example": "./packages/components/src/product-image/docs/example.js",
	"./rating/docs/example": "./packages/components/src/rating/docs/example.js",
	"./scroll-to/docs/example": "./packages/components/src/scroll-to/docs/example.js",
	"./search-list-control/docs/example": "./packages/components/src/search-list-control/docs/example.js",
	"./search/docs/example": "./packages/components/src/search/docs/example.js",
	"./section-header/docs/example": "./packages/components/src/section-header/docs/example.js",
	"./section/docs/example": "./packages/components/src/section/docs/example.js",
	"./segmented-selection/docs/example": "./packages/components/src/segmented-selection/docs/example.js",
	"./select-control/docs/example": "./packages/components/src/select-control/docs/example.js",
	"./spinner/docs/example": "./packages/components/src/spinner/docs/example.js",
	"./stepper/docs/example": "./packages/components/src/stepper/docs/example.js",
	"./summary/docs/example": "./packages/components/src/summary/docs/example.js",
	"./table/docs/example": "./packages/components/src/table/docs/example.js",
	"./tag/docs/example": "./packages/components/src/tag/docs/example.js",
	"./text-control-with-affixes/docs/example": "./packages/components/src/text-control-with-affixes/docs/example.js",
	"./text-control/docs/example": "./packages/components/src/text-control/docs/example.js",
	"./view-more-list/docs/example": "./packages/components/src/view-more-list/docs/example.js",
	"./web-preview/docs/example": "./packages/components/src/web-preview/docs/example.js"
};
...
webpackContext.resolve = webpackContextResolve;
module.exports = webpackContext;
webpackContext.id = "./packages/components/src sync recursive ^\\.\\/.*\\/docs\\/example$";

/***/ }),

/***/ "./packages/components/src/advanced-filters/README.md":
/*!************************************************************!*\
  !*** ./packages/components/src/advanced-filters/README.md ***!
  \************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/advanced-filters/docs/example.js":
/*!******************************************************************!*\
  !*** ./packages/components/src/advanced-filters/docs/example.js ***!
  \******************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @woocommerce/components */ "@woocommerce/components");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_1__["AdvancedFilters"], {
    ...
    currency: _woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_2__["CURRENCY"]
  });
});

/***/ }),

/***/ "./packages/components/src/animation-slider/README.md":
/*!************************************************************!*\
  !*** ./packages/components/src/animation-slider/README.md ***!
  \************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/animation-slider/docs/example.js":
/*!******************************************************************!*\
  !*** ./packages/components/src/animation-slider/docs/example.js ***!
  \******************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/calendar/README.md":
/*!****************************************************!*\
  !*** ./packages/components/src/calendar/README.md ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/calendar/docs/example.js":
/*!**********************************************************!*\
  !*** ./packages/components/src/calendar/docs/example.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/compose */ "./packages/components/node_modules/@wordpress/compose/build-module/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__["withState"])({
  after: null,
  afterText: '',
  before: null,
  beforeText: '',
...
/***/ "./packages/components/src/card/docs/example.js":
/*!******************************************************!*\
  !*** ./packages/components/src/card/docs/example.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/chart/README.md":
/*!*************************************************!*\
  !*** ./packages/components/src/chart/README.md ***!
  \*************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/chart/d3chart/d3base/README.md":
/*!****************************************************************!*\
  !*** ./packages/components/src/chart/d3chart/d3base/README.md ***!
  \****************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/chart/docs/example.js":
/*!*******************************************************!*\
  !*** ./packages/components/src/chart/docs/example.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/compare-filter/README.md":
/*!**********************************************************!*\
  !*** ./packages/components/src/compare-filter/README.md ***!
  \**********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/compare-filter/docs/example.js":
/*!****************************************************************!*\
  !*** ./packages/components/src/compare-filter/docs/example.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/count/README.md":
/*!*************************************************!*\
  !*** ./packages/components/src/count/README.md ***!
  \*************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/count/docs/example.js":
/*!*******************************************************!*\
  !*** ./packages/components/src/count/docs/example.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/date-range-filter-picker/README.md":
/*!********************************************************************!*\
  !*** ./packages/components/src/date-range-filter-picker/README.md ***!
  \********************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/date-range-filter-picker/docs/example.js":
/*!**************************************************************************!*\
  !*** ./packages/components/src/date-range-filter-picker/docs/example.js ***!
  \**************************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/date/README.md":
/*!************************************************!*\
  !*** ./packages/components/src/date/README.md ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/date/docs/example.js":
/*!******************************************************!*\
  !*** ./packages/components/src/date/docs/example.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/dropdown-button/README.md":
/*!***********************************************************!*\
  !*** ./packages/components/src/dropdown-button/README.md ***!
  \***********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/dropdown-button/docs/example.js":
/*!*****************************************************************!*\
  !*** ./packages/components/src/dropdown-button/docs/example.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/components */ "./packages/components/node_modules/@wordpress/components/build-module/index.js");
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @woocommerce/components */ "@woocommerce/components");
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["Dropdown"], {
    renderToggle: function renderToggle(_ref) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["DropdownButton"], {
        onClick: onToggle,
        isOpen: isOpen,
        labels: ['All Products Sold']
      });
...
/***/ "./packages/components/src/ellipsis-menu/README.md":
/*!*********************************************************!*\
  !*** ./packages/components/src/ellipsis-menu/README.md ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/ellipsis-menu/docs/example.js":
/*!***************************************************************!*\
  !*** ./packages/components/src/ellipsis-menu/docs/example.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/compose */ "./packages/components/node_modules/@wordpress/compose/build-module/index.js");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/components */ "./packages/components/node_modules/@wordpress/components/build-module/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__["withState"])({
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_3__["EllipsisMenu"], {
    label: "Choose which analytics to display",
    renderContent: function renderContent(_ref2) {
      var onToggle = _ref2.onToggle;
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_3__["MenuTitle"], null, "Display Stats"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_3__["MenuItem"], {
        isCheckbox: true,
        isClickable: true,
        checked: showCustomers,
      ...
      }, "Show Customers"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_3__["MenuItem"], {
        isCheckbox: true,
        isClickable: true,
        checked: showOrders,
        onInvoke: function onInvoke() {
      ...
      }, "Show Orders"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_3__["MenuItem"], {
        isClickable: true,
        onInvoke: onToggle
...
/***/ "./packages/components/src/empty-content/README.md":
/*!*********************************************************!*\
  !*** ./packages/components/src/empty-content/README.md ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/empty-content/docs/example.js":
/*!***************************************************************!*\
  !*** ./packages/components/src/empty-content/docs/example.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/filter-picker/README.md":
/*!*********************************************************!*\
  !*** ./packages/components/src/filter-picker/README.md ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/filter-picker/docs/example.js":
/*!***************************************************************!*\
  !*** ./packages/components/src/filter-picker/docs/example.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/filters/README.md":
/*!***************************************************!*\
  !*** ./packages/components/src/filters/README.md ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/filters/docs/example.js":
/*!*********************************************************!*\
  !*** ./packages/components/src/filters/docs/example.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/flag/README.md":
/*!************************************************!*\
  !*** ./packages/components/src/flag/README.md ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/flag/docs/example.js":
/*!******************************************************!*\
  !*** ./packages/components/src/flag/docs/example.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/form/README.md":
/*!************************************************!*\
  !*** ./packages/components/src/form/README.md ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/form/docs/example.js":
/*!******************************************************!*\
  !*** ./packages/components/src/form/docs/example.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_3__["Form"], {
    validate: validate,
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["TextControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      label: 'First Name'
    }, getInputProps('firstName'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["TextControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      label: 'Last Name'
    }, getInputProps('lastName'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["SelectControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      label: "Select",
      options: [{
        label: 'Option 1',
        value: '1'
    ...
    }, getInputProps('select'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["CheckboxControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      label: "Checkbox"
    }, getInputProps('checkbox'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["RadioControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      label: "Radio",
      options: [{
        label: 'Option 1',
        value: '1'
    ...
    }, getInputProps('radio'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      isPrimary: true,
      onClick: handleSubmit,
      disabled: Object.keys(errors).length
...
/***/ "./packages/components/src/gravatar/README.md":
/*!****************************************************!*\
  !*** ./packages/components/src/gravatar/README.md ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/gravatar/docs/example.js":
/*!**********************************************************!*\
  !*** ./packages/components/src/gravatar/docs/example.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/higher-order/use-filters/README.md":
/*!********************************************************************!*\
  !*** ./packages/components/src/higher-order/use-filters/README.md ***!
  \********************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/image-upload/docs/example.js":
/*!**************************************************************!*\
  !*** ./packages/components/src/image-upload/docs/example.js ***!
  \**************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__["withState"])({
  ...
  var setState = _ref.setState,
      logo = _ref.logo;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["ImageUpload"], {
    image: logo,
...
/***/ "./packages/components/src/link/README.md":
/*!************************************************!*\
  !*** ./packages/components/src/link/README.md ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/link/docs/example.js":
/*!******************************************************!*\
  !*** ./packages/components/src/link/docs/example.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/list/README.md":
/*!************************************************!*\
  !*** ./packages/components/src/list/README.md ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/list/docs/example.js":
/*!******************************************************!*\
  !*** ./packages/components/src/list/docs/example.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/order-status/README.md":
/*!********************************************************!*\
  !*** ./packages/components/src/order-status/README.md ***!
  \********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/order-status/docs/example.js":
/*!**************************************************************!*\
  !*** ./packages/components/src/order-status/docs/example.js ***!
  \**************************************************************/
/*! exports provided: default */
...
var orderStatusMap = {
  processing: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Processing Order'),
  pending: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Pending Order'),
  completed: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Completed Order')
};
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["OrderStatus"], {
    order: {
      status: 'processing'
    },
    orderStatusMap: orderStatusMap
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["OrderStatus"], {
    order: {
      status: 'pending'
    },
    orderStatusMap: orderStatusMap
...
/***/ "./packages/components/src/pagination/README.md":
/*!******************************************************!*\
  !*** ./packages/components/src/pagination/README.md ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/pagination/docs/example.js":
/*!************************************************************!*\
  !*** ./packages/components/src/pagination/docs/example.js ***!
  \************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__["withState"])({
  ...
  var page = _ref.page,
      ...
      setState = _ref.setState;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["Pagination"], {
    page: page,
    perPage: perPage,
    total: 500,
...
/***/ "./packages/components/src/pill/README.md":
/*!************************************************!*\
  !*** ./packages/components/src/pill/README.md ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/pill/docs/example.js":
/*!******************************************************!*\
  !*** ./packages/components/src/pill/docs/example.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_1__["Pill"], null, "Content");
});

/***/ }),

/***/ "./packages/components/src/plugins/README.md":
/*!***************************************************!*\
  !*** ./packages/components/src/plugins/README.md ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/product-image/README.md":
/*!*********************************************************!*\
  !*** ./packages/components/src/product-image/README.md ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/product-image/docs/example.js":
/*!***************************************************************!*\
  !*** ./packages/components/src/product-image/docs/example.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/rating/README.md":
/*!**************************************************!*\
  !*** ./packages/components/src/rating/README.md ***!
  \**************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/rating/docs/example.js":
/*!********************************************************!*\
  !*** ./packages/components/src/rating/docs/example.js ***!
  \********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/scroll-to/README.md":
/*!*****************************************************!*\
  !*** ./packages/components/src/scroll-to/README.md ***!
  \*****************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/scroll-to/docs/example.js":
/*!***********************************************************!*\
  !*** ./packages/components/src/scroll-to/docs/example.js ***!
  \***********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/search-list-control/README.md":
/*!***************************************************************!*\
  !*** ./packages/components/src/search-list-control/README.md ***!
  \***************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/search-list-control/docs/example.js":
/*!*********************************************************************!*\
  !*** ./packages/components/src/search-list-control/docs/example.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @woocommerce/components */ "@woocommerce/components");
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_components__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/compose */ "./packages/components/node_modules/@wordpress/compose/build-module/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__["withState"])({
  selected: [],
  loading: true
})(function (_ref) {
...
/***/ "./packages/components/src/search/docs/example.js":
/*!********************************************************!*\
  !*** ./packages/components/src/search/docs/example.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__["withState"])({
  ...
  var selected = _ref.selected,
      ...
      setState = _ref.setState;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["H"], null, "Tags Below Input"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["Section"], {
    component: false
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["Search"], {
    type: "products",
    placeholder: "Search for a product",
    selected: selected,
    onChange: function onChange(items) {
  ...
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["H"], null, "Tags Inline with Input"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["Section"], {
    component: false
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["Search"], {
    type: "products",
    placeholder: "Search for a product",
...
/***/ "./packages/components/src/section-header/README.md":
/*!**********************************************************!*\
  !*** ./packages/components/src/section-header/README.md ***!
  \**********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/section-header/docs/example.js":
/*!****************************************************************!*\
  !*** ./packages/components/src/section-header/docs/example.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/section/README.md":
/*!***************************************************!*\
  !*** ./packages/components/src/section/README.md ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/section/docs/example.js":
/*!*********************************************************!*\
  !*** ./packages/components/src/section/docs/example.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/segmented-selection/README.md":
/*!***************************************************************!*\
  !*** ./packages/components/src/segmented-selection/README.md ***!
  \***************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/segmented-selection/docs/example.js":
/*!*********************************************************************!*\
  !*** ./packages/components/src/segmented-selection/docs/example.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/select-control/README.md":
/*!**********************************************************!*\
  !*** ./packages/components/src/select-control/README.md ***!
  \**********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/select-control/docs/example.js":
/*!****************************************************************!*\
  !*** ./packages/components/src/select-control/docs/example.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/spinner/docs/example.js":
/*!*********************************************************!*\
  !*** ./packages/components/src/spinner/docs/example.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/stepper/README.md":
/*!***************************************************!*\
  !*** ./packages/components/src/stepper/README.md ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/stepper/docs/example.js":
/*!*********************************************************!*\
  !*** ./packages/components/src/stepper/docs/example.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__["withState"])({
  ...
  }, "Toggle Spinner")), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["Stepper"], {
    steps: steps,
    currentStep: currentStep,
    isPending: isPending
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("br", null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_2__["Stepper"], {
    isPending: isPending,
    isVertical: true,
    steps: steps,
    currentStep: currentStep
...
/***/ "./packages/components/src/summary/README.md":
/*!***************************************************!*\
  !*** ./packages/components/src/summary/README.md ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/summary/docs/example.js":
/*!*********************************************************!*\
  !*** ./packages/components/src/summary/docs/example.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/table/docs/example.js":
/*!*******************************************************!*\
  !*** ./packages/components/src/table/docs/example.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/tag/README.md":
/*!***********************************************!*\
  !*** ./packages/components/src/tag/README.md ***!
  \***********************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/tag/docs/example.js":
/*!*****************************************************!*\
  !*** ./packages/components/src/tag/docs/example.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/text-control-with-affixes/README.md":
/*!*********************************************************************!*\
  !*** ./packages/components/src/text-control-with-affixes/README.md ***!
  \*********************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/text-control-with-affixes/docs/example.js":
/*!***************************************************************************!*\
  !*** ./packages/components/src/text-control-with-affixes/docs/example.js ***!
  \***************************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/text-control/README.md":
/*!********************************************************!*\
  !*** ./packages/components/src/text-control/README.md ***!
  \********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/text-control/docs/example.js":
/*!**************************************************************!*\
  !*** ./packages/components/src/text-control/docs/example.js ***!
  \**************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/timeline/README.md":
/*!****************************************************!*\
  !*** ./packages/components/src/timeline/README.md ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/view-more-list/README.md":
/*!**********************************************************!*\
  !*** ./packages/components/src/view-more-list/README.md ***!
  \**********************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/view-more-list/docs/example.js":
/*!****************************************************************!*\
  !*** ./packages/components/src/view-more-list/docs/example.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/web-preview/README.md":
/*!*******************************************************!*\
  !*** ./packages/components/src/web-preview/README.md ***!
  \*******************************************************/
/*! exports provided: default */
...
/***/ "./packages/components/src/web-preview/docs/example.js":
/*!*************************************************************!*\
  !*** ./packages/components/src/web-preview/docs/example.js ***!
  \*************************************************************/
/*! exports provided: default */
...
//# sourceMappingURL=devdocs.5ffdde6555ec3eb56887.min.js.map
