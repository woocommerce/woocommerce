...
var table_TaxesReportTable = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(TaxesReportTable, [{
    ...
    value: function getHeadersContent() {
      return [{
        label: Object(external_this_wp_i18n_["__"])('Tax Code', 'woocommerce'),
        key: 'tax_code',
        required: true,
        isLeftAligned: true,
        isSortable: true
      }, {
        label: Object(external_this_wp_i18n_["__"])('Rate', 'woocommerce'),
        key: 'rate',
        isSortable: true,
        isNumeric: true
      }, {
    ...
    value: function getSummary(totals) {
      ...
      return [{
        label: Object(external_this_wp_i18n_["_n"])('tax code', 'tax codes', taxesCodes, 'woocommerce'),
    ...
    value: function render() {
      ...
      return Object(external_this_wp_element_["createElement"])(report_table["a" /* default */], {
        ...
        title: Object(external_this_wp_i18n_["__"])('Taxes', 'woocommerce'),
...
var taxes_TaxesReport = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(TaxesReport, [{
    ...
    value: function getChartMeta() {
      ...
      var itemsLabel = Object(external_this_wp_i18n_["__"])('%d taxes', 'woocommerce');
...
/* harmony import */ var lib_async_requests__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(750);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(751);
