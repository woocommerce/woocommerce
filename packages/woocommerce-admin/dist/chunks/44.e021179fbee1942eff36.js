...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(765);
...
/* harmony import */ var _woocommerce_data__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(45);
...
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(41);
...
/* harmony import */ var _wordpress_html_entities__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72);
...
/* harmony import */ var _woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(22);
...
var check = __webpack_require__(767);
...
/* harmony default export */ var cart_modal = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select) {
  ...
  var productIds = Object(utils["d" /* getProductIdsForCart */])(profileItems, false, installedPlugins);
  return {
...
var appearance_Appearance = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(Appearance, [{
    ...
    key: "updateLogo",
    value: function () {
      var _updateLogo = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    key: "updateNotice",
    value: function () {
      var _updateNotice = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
...
// CONCATENATED MODULE: ./client/task-list/tasks/connect.js
...
var connect_Connect = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(Connect, [{
    ...
    value: function baseQuery() {
      var query = this.props.query;
      var baseQuery = Object(external_lodash_["omit"])(connect_objectSpread(connect_objectSpread({}, query), {}, {
        page: 'wc-admin'
...
var components_connect = __webpack_require__(764);

// EXTERNAL MODULE: ./client/dashboard/components/settings/general/store-address.js
var store_address = __webpack_require__(781);
...
var form_toggle = __webpack_require__(726);
    ...
    value: function getSteps() {
      ...
      var steps = [{
        ...
        content: Object(external_this_wp_element_["createElement"])(shipping_rates, extends_default()({
          buttonText: pluginsToActivate.length || requiresJetpackConnection ? Object(external_this_wp_i18n_["__"])('Proceed', 'woocommerce') : Object(external_this_wp_i18n_["__"])('Complete task', 'woocommerce'),
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return updateOptions({
                  woocommerce_stripe_settings: stripe_objectSpread(stripe_objectSpread({}, stripeSettings), {}, {
  ...
  createClass_default()(PayPal, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return updateOptions({
                  woocommerce_ppec_paypal_settings: paypal_objectSpread(paypal_objectSpread({}, options.woocommerce_ppec_paypal_settings), {}, {
    ...
    value: function getConnectStep() {
      ...
      if (!autoConnectFailed && connectURL) {
        return paypal_objectSpread(paypal_objectSpread({}, connectStep), {}, {
...
function getPaymentMethods(_ref) {
  ...
  if (window.wcAdminFeatures.wcpay) {
    ...
    var wcPaySettingsLink = Object(external_this_wp_element_["createElement"])(external_this_wc_components_["Link"], {
      ...
      type: "wp-admin"
    }, Object(external_this_wp_i18n_["__"])('Settings', 'woocommerce'));
    methods.push({
      key: 'wcpay',
      ...
      onClick: function onClick(resolve, reject) {
        var errorMessage = Object(external_this_wp_i18n_["__"])('There was an error connecting to WooCommerce Payments. Please try again or connect later in store settings.', 'woocommerce');
...
var payments_Payments = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(Payments, [{
    ...
    key: "completeTask",
    value: function () {
      var _completeTask = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                if (update.success) {
                  ...
                  createNotice('error', Object(external_this_wp_i18n_["__"])('There was a problem updating settings', 'woocommerce'));
                }
    ...
    key: "handleClick",
    value: function () {
      var _handleClick = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(method) {
        var _this2 = this;
...
function getAllTasks(_ref) {
  ...
  var productIds = Object(utils["d" /* getProductIdsForCart */])(profileItems, true, installedPlugins);
  var remainingProductIds = Object(utils["d" /* getProductIdsForCart */])(profileItems, false, installedPlugins);
  ...
  var tasks = [{
    key: 'store_details',
    title: Object(external_this_wp_i18n_["__"])('Store details', 'woocommerce'),
    container: null,
    onClick: function onClick() {
      window.location = Object(client_settings["f" /* getAdminLink */])('admin.php?page=wc-admin&reset_profiler=1');
    },
    completed: profileItems.completed,
    visible: true,
    time: Object(external_this_wp_i18n_["__"])('4 minutes', 'woocommerce')
  }, {
    key: 'purchase',
    ...
    time: Object(external_this_wp_i18n_["__"])('2 minutes', 'woocommerce')
  }, {
    key: 'connect',
    ...
    time: Object(external_this_wp_i18n_["__"])('1 minute', 'woocommerce')
  }, {
    key: 'products',
    title: Object(external_this_wp_i18n_["__"])('Add my products', 'woocommerce'),
    container: Object(external_this_wp_element_["createElement"])(products_Products, null),
    completed: hasProducts,
    visible: true,
    time: Object(external_this_wp_i18n_["__"])('1 minute per product', 'woocommerce')
  }, {
    key: 'appearance',
  ...
  createClass_default()(TaskDashboard, [{
    ...
    value: function renderMenu() {
      ...
      return Object(external_this_wp_element_["createElement"])("div", {
        ...
        renderContent: function renderContent() {
          ...
          }, Object(external_this_wp_i18n_["__"])('Hide this', 'woocommerce')));
        }
      }));
    }
  }, {
    ...
    value: function render() {
      ...
      var listTasks = this.getTasks().map(function (task) {
        ...
        if (!task.completed) {
          task.after = task.time ? Object(external_this_wp_element_["createElement"])("span", {
            className: "woocommerce-task-estimated-time"
          }, task.time) : Object(external_this_wp_element_["createElement"])(icon["a" /* default */], {
      ...
      }), Object(external_this_wp_element_["createElement"])(header["a" /* default */], null, Object(external_this_wp_element_["createElement"])(external_this_wc_components_["H"], null, Object(external_this_wp_i18n_["__"])('Finish setup', 'woocommerce')), this.renderMenu()), Object(external_this_wp_element_["createElement"])(body["a" /* default */], null, Object(external_this_wp_element_["createElement"])(external_this_wc_components_["List"], {
        items: listTasks
      }))), isWelcomeModalOpen && this.renderWelcomeModal())), isCartModalOpen && Object(external_this_wp_element_["createElement"])(cart_modal, {
