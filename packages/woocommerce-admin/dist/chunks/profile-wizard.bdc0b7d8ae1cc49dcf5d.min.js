(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-wizard"],{
...
/***/ "./client/profile-wizard/header.js":
/*!*****************************************!*\
  !*** ./client/profile-wizard/header.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ProfileWizardHeader; });
...
var ProfileWizardHeader = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(ProfileWizardHeader, _Component);

  var _super = _createSuper(ProfileWizardHeader);

  function ProfileWizardHeader() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ProfileWizardHeader);

    return _super.apply(this, arguments);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ProfileWizardHeader, [{
    key: "renderStepper",
    value: function renderStepper() {
      var _this$props = this.props,
          currentStep = _this$props.currentStep,
          steps = _this$props.steps;
      var visibleSteps = Object(lodash__WEBPACK_IMPORTED_MODULE_6__["filter"])(steps, function (step) {
        return !!step.label;
      });
      ...
      visibleSteps.map(function (step, index) {
        ...
        if (!previousStep || previousStep.isComplete) {
          step.onClick = function (key) {
            return Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_7__["updateQueryString"])({
              step: key
            });
          };
        }
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_8__["Stepper"], {
        steps: visibleSteps,
...
/* harmony import */ var _steps_benefits__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./steps/benefits */ "./client/profile-wizard/steps/benefits/index.js");
/* harmony import */ var _steps_business_details__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./steps/business-details */ "./client/profile-wizard/steps/business-details.js");
/* harmony import */ var _steps_industry__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./steps/industry */ "./client/profile-wizard/steps/industry.js");
/* harmony import */ var _steps_product_types__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./steps/product-types */ "./client/profile-wizard/steps/product-types.js");
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./header */ "./client/profile-wizard/header.js");
...
/* harmony import */ var _steps_store_details__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./steps/store-details */ "./client/profile-wizard/steps/store-details.js");
/* harmony import */ var _steps_theme__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./steps/theme */ "./client/profile-wizard/steps/theme/index.js");
/* harmony import */ var wc_api_with_select__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! wc-api/with-select */ "./client/wc-api/with-select.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./style.scss */ "./client/profile-wizard/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_25__);
...
var ProfileWizard = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(ProfileWizard, _Component);

  var _super = _createSuper(ProfileWizard);

  function ProfileWizard(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, ProfileWizard);
    ...
    _this.goToNextStep = _this.goToNextStep.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(ProfileWizard, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      ...
      if (isRequestError) {
        createNotice('error', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('There was a problem finishing the profile wizard.', 'woocommerce'));
      }

      if (prevStep !== step) {
        window.document.documentElement.scrollTop = 0;
        Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_step_view', {
    ...
    value: function componentDidMount() {
      ...
      if (this.activePlugins.includes('woocommerce-services') && this.activePlugins.includes('jetpack') && profileItems.plugins !== 'already-installed') {
        Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('wcadmin_storeprofiler_already_installed_plugins', {});
        updateProfileItems({
    ...
    value: function getSteps() {
      ...
      steps.push({
        key: 'store-details',
        container: _steps_store_details__WEBPACK_IMPORTED_MODULE_22__["default"],
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Store Details', 'woocommerce'),
        isComplete: profileItems.hasOwnProperty('setup_client') && profileItems.setup_client !== null
      });
      steps.push({
        key: 'industry',
        container: _steps_industry__WEBPACK_IMPORTED_MODULE_17__["default"],
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Industry', 'woocommerce'),
        isComplete: profileItems.hasOwnProperty('industry') && profileItems.industry !== null
      });
      steps.push({
        key: 'product-types',
        container: _steps_product_types__WEBPACK_IMPORTED_MODULE_18__["default"],
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Product Types', 'woocommerce'),
        isComplete: profileItems.hasOwnProperty('product_types') && profileItems.product_types !== null
      });
      steps.push({
        key: 'business-details',
        container: _steps_business_details__WEBPACK_IMPORTED_MODULE_16__["default"],
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Business Details', 'woocommerce'),
        isComplete: profileItems.hasOwnProperty('product_count') && profileItems.product_count !== null
      });
      steps.push({
        key: 'theme',
        container: _steps_theme__WEBPACK_IMPORTED_MODULE_23__["default"],
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Theme', 'woocommerce'),
      ...
      if (!this.activePlugins.includes('woocommerce-services') || !this.activePlugins.includes('jetpack')) {
        steps.push({
          key: 'benefits',
          container: _steps_benefits__WEBPACK_IMPORTED_MODULE_15__["default"]
        });
      }
    ...
    key: "goToNextStep",
    value: function () {
      var _goToNextStep = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_step_complete', {
              ...
              case 7:
                return _context.abrupt("return", Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_13__["updateQueryString"])({
                  step: nextStep.key
                }));
    ...
    value: function completeProfiler() {
      ...
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_complete');
    ...
    value: function render() {
      ...
      var container = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_9__["createElement"])(step.container, {
        query: query,
        step: step,
        goToNextStep: this.goToNextStep
      });
      var steps = this.getSteps().map(function (_step) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_11__["pick"])(_step, ['key', 'label', 'isComplete']);
      });
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_9__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_9__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_9__["createElement"])(_header__WEBPACK_IMPORTED_MODULE_19__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(wc_api_with_select__WEBPACK_IMPORTED_MODULE_24__["default"])(function (select) {
  ...
  var _select3 = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["PLUGINS_STORE_NAME"]),
...
}), hydrateSettings ? Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["withSettingsHydration"])('general', {
  general: window.wcSettings.preloadSettings.general
}) : lodash__WEBPACK_IMPORTED_MODULE_11__["identity"], window.wcSettings.plugins ? Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["withPluginsHydration"])(_objectSpread(_objectSpread({}, window.wcSettings.plugins), {}, {
  jetpackStatus: window.wcSettings.dataEndpoints.jetpackStatus
})) : lodash__WEBPACK_IMPORTED_MODULE_11__["identity"])(ProfileWizard));

/***/ }),

/***/ "./client/profile-wizard/steps/benefits/images/management.js":
/*!*******************************************************************!*\
  !*** ./client/profile-wizard/steps/benefits/images/management.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
/***/ "./client/profile-wizard/steps/benefits/images/sales_tax.js":
/*!******************************************************************!*\
  !*** ./client/profile-wizard/steps/benefits/images/sales_tax.js ***!
  \******************************************************************/
/*! exports provided: default */
...
/***/ "./client/profile-wizard/steps/benefits/images/shipping_labels.js":
/*!************************************************************************!*\
  !*** ./client/profile-wizard/steps/benefits/images/shipping_labels.js ***!
  \************************************************************************/
/*! exports provided: default */
...
/***/ "./client/profile-wizard/steps/benefits/images/speed.js":
/*!**************************************************************!*\
  !*** ./client/profile-wizard/steps/benefits/images/speed.js ***!
  \**************************************************************/
/*! exports provided: default */
...
/***/ "./client/profile-wizard/steps/benefits/index.js":
/*!*******************************************************!*\
  !*** ./client/profile-wizard/steps/benefits/index.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/* harmony import */ var dashboard_components_connect__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! dashboard/components/connect */ "./client/dashboard/components/connect/index.js");
/* harmony import */ var lib_notices__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! lib/notices */ "./client/lib/notices/index.js");
/* harmony import */ var _logo__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./logo */ "./client/profile-wizard/steps/benefits/logo.js");
/* harmony import */ var _images_management__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./images/management */ "./client/profile-wizard/steps/benefits/images/management.js");
/* harmony import */ var _images_sales_tax__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./images/sales_tax */ "./client/profile-wizard/steps/benefits/images/sales_tax.js");
/* harmony import */ var _images_shipping_labels__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./images/shipping_labels */ "./client/profile-wizard/steps/benefits/images/shipping_labels.js");
/* harmony import */ var _images_speed__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./images/speed */ "./client/profile-wizard/steps/benefits/images/speed.js");
...
var Benefits = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Benefits, _Component);

  var _super = _createSuper(Benefits);

  function Benefits(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Benefits);
    ...
    Object(lib_tracks__WEBPACK_IMPORTED_MODULE_23__["recordEvent"])('storeprofiler_plugins_to_install', {
      plugins: _this.pluginsToInstall
    });
    _this.startPluginInstall = _this.startPluginInstall.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this));
    _this.skipPluginInstall = _this.skipPluginInstall.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Benefits, [{
    key: "skipPluginInstall",
    value: function () {
      var _skipPluginInstall = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                if (isProfileItemsError) {
                  createNotice('error', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('There was a problem updating your preferences.', 'woocommerce'));
                } else {
                  Object(lib_tracks__WEBPACK_IMPORTED_MODULE_23__["recordEvent"])('storeprofiler_install_plugins', {
                    install: false,
                    plugins: plugins
                  });
                }
    ...
    value: function () {
      var _startPluginInstall = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var _this$props2, createNotice, goToNextStep, installAndActivatePlugins, isJetpackConnected, updateProfileItems, updateOptions, plugins;

        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this$props2 = this.props, createNotice = _this$props2.createNotice, goToNextStep = _this$props2.goToNextStep, installAndActivatePlugins = _this$props2.installAndActivatePlugins, isJetpackConnected = _this$props2.isJetpackConnected, updateProfileItems = _this$props2.updateProfileItems, updateOptions = _this$props2.updateOptions;
                ...
                _context2.next = 5;
                return Promise.all([installAndActivatePlugins(this.pluginsToInstall), updateProfileItems({
                  plugins: plugins
                }), updateOptions({
                  woocommerce_setup_jetpack_opted_in: true
                })]).catch(function (pluginError, profileError) {
                  if (pluginError) {
                    Object(lib_notices__WEBPACK_IMPORTED_MODULE_17__["createNoticesFromResponse"])(pluginError);
                  }
    ...
    value: function renderBenefit(benefit) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
        ...
        key: title
      }, icon, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
      ...
      }, title), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("p", null, description)));
    }
  }, {
    key: "getBenefits",
    value: function getBenefits() {
      return [{
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Store management on the go', 'woocommerce'),
        icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_images_management__WEBPACK_IMPORTED_MODULE_19__["default"], null),
        description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Your store in your pocket. Manage orders, receive sales notifications, and more. Only with a Jetpack connection.', 'woocommerce'),
        visible: !this.isJetpackActive
      }, {
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Automated sales taxes', 'woocommerce'),
        icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_images_sales_tax__WEBPACK_IMPORTED_MODULE_20__["default"], null),
        description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Ensure that the correct rate of tax is charged on all of your orders automatically, and print shipping labels at home.', 'woocommerce'),
        visible: !this.isWcsActive || !this.isJetpackActive
      }, {
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Improved speed & security', 'woocommerce'),
        icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_images_speed__WEBPACK_IMPORTED_MODULE_22__["default"], null),
        description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Automatically block brute force attacks and speed up your store using our powerful, global server network to cache images.', 'woocommerce'),
        visible: !this.isJetpackActive
      }, {
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Print shipping labels at home', 'woocommerce'),
        icon: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_images_shipping_labels__WEBPACK_IMPORTED_MODULE_21__["default"], null),
        description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Save time at the post office by printing shipping labels for your orders at home.', 'woocommerce'),
    ...
    value: function renderBenefits() {
      ...
      }, Object(lodash__WEBPACK_IMPORTED_MODULE_12__["filter"])(this.getBenefits(), function (benefit) {
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          goToNextStep = _this$props3.goToNextStep,
      ...
      var pluginNamesString = this.pluginsToInstall.map(function (pluginSlug) {
        return _woocommerce_data__WEBPACK_IMPORTED_MODULE_15__["pluginNames"][pluginSlug];
      ...
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_logo__WEBPACK_IMPORTED_MODULE_18__["default"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_13__["H"], {
        className: "woocommerce-profile-wizard__header-title"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Enhance your store with %s', 'woocommerce'), pluginNamesString)), this.renderBenefits(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
      ...
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Yes please!', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["Button"], {
        isSecondary: true,
        isBusy: isRequesting && !isInstallAction,
        disabled: isRequesting || isInstallAction,
        className: "woocommerce-profile-wizard__skip",
        onClick: this.skipPluginInstall
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('No thanks', 'woocommerce')), !isJetpackConnected && !isRequesting && !pluginsRemaining.length && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(dashboard_components_connect__WEBPACK_IMPORTED_MODULE_16__["default"], {
        autoConnect: true,
        onConnect: function onConnect() {
          Object(lib_tracks__WEBPACK_IMPORTED_MODULE_23__["recordEvent"])('storeprofiler_jetpack_connect_redirect');
        },
        onError: function onError() {
          return goToNextStep();
        },
        redirectUrl: Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_14__["getAdminLink"])('admin.php?page=wc-admin&reset_profiler=0')
      ...
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('%s %s will be installed & activated for free.', 'woocommerce'), pluginNamesString, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["_n"])('plugin', 'plugins', this.pluginsToInstall.length, 'woocommerce'))));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_11__["withSelect"])(function (select) {
  var _select = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_15__["ONBOARDING_STORE_NAME"]),
  ...
  var _dispatch = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_15__["PLUGINS_STORE_NAME"]),
      installAndActivatePlugins = _dispatch.installAndActivatePlugins;

  var _dispatch2 = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_15__["ONBOARDING_STORE_NAME"]),
      updateProfileItems = _dispatch2.updateProfileItems;

  var _dispatch3 = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_15__["OPTIONS_STORE_NAME"]),
...
/***/ "./client/profile-wizard/steps/benefits/logo.js":
/*!******************************************************!*\
  !*** ./client/profile-wizard/steps/benefits/logo.js ***!
  \******************************************************/
/*! exports provided: default */
...
var Logo = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(Logo, _Component);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Logo, [{
    ...
    value: function render() {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("svg", {
        ...
        fill: "none",
        xmlns: "http://www.w3.org/2000/svg",
        "aria-label": Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('WooCommerce + Jetpack', 'woocommerce'),
        ...
        fill: "#F6F7F7"
      })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("defs", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("clipPath", {
        id: "clip0"
...
/***/ "./client/profile-wizard/steps/business-details.js":
/*!*********************************************************!*\
  !*** ./client/profile-wizard/steps/business-details.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/* harmony import */ var lib_notices__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! lib/notices */ "./client/lib/notices/index.js");
...
var wcAdminAssetUrl = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_15__["getSetting"])('wcAdminAssetUrl', '');

var BusinessDetails = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(BusinessDetails, _Component);
  ...
  function BusinessDetails(props) {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, BusinessDetails);

    _this = _super.call(this);
    var profileItems = Object(lodash__WEBPACK_IMPORTED_MODULE_13__["get"])(props, 'profileItems', {});
    var businessExtensions = Object(lodash__WEBPACK_IMPORTED_MODULE_13__["get"])(profileItems, 'business_extensions', false);
    _this.initialValues = {
    ...
    _this.onContinue = _this.onContinue.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    ...
    _this.getNumberRangeString = _this.getNumberRangeString.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.numberFormat = _this.numberFormat.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(BusinessDetails, [{
    key: "onContinue",
    value: function () {
      var _onContinue = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee(values) {
        var _this2 = this;

        var _this$props, createNotice, goToNextStep, installAndActivatePlugins, updateProfileItems, otherPlatform, otherPlatformName, productCount, revenue, sellingVenues, businessExtensions, getCurrency, _updates, updates, promises;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                Object(lib_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('storeprofiler_store_business_details_continue', {
                ...
                promises = [updateProfileItems(updates).catch(function () {
                  createNotice('error', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('There was a problem updating your business details.', 'woocommerce'));
                  throw new Error();
                })];

                if (businessExtensions.length) {
                  promises.push(installAndActivatePlugins(businessExtensions).then(function (response) {
                    Object(lib_notices__WEBPACK_IMPORTED_MODULE_21__["createNoticesFromResponse"])(response);
                  }).catch(function (error) {
                    _this2.setState({
                      hasInstallActivateError: true
                    });

                    Object(lib_notices__WEBPACK_IMPORTED_MODULE_21__["createNoticesFromResponse"])(error);
                    throw new Error();
                  }));
                }
      ...
      Object.keys(values).forEach(function (name) {
        if (name === 'other_platform') {
          if (!values.other_platform.length && ['other', 'brick-mortar-other'].includes(values.selling_venues)) {
            errors.other_platform = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('This field is required', 'woocommerce');
          }
          ...
          if (!values.other_platform_name && values.other_platform === 'other' && ['other', 'brick-mortar-other'].includes(values.selling_venues)) {
            errors.other_platform_name = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('This field is required', 'woocommerce');
          }
        } else if (name === 'revenue') {
          if (!values.revenue.length && ['other', 'brick-mortar', 'brick-mortar-other', 'other-woocommerce'].includes(values.selling_venues)) {
            errors.revenue = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('This field is required', 'woocommerce');
          }
        } else if (!_this3.extensions.includes(name) && !values[name].length) {
          errors[name] = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('This field is required', 'woocommerce');
        }
      });
      return errors;
    }
    ...
    value: function getBusinessExtensions(values) {
      ...
      return Object(lodash__WEBPACK_IMPORTED_MODULE_13__["keys"])(Object(lodash__WEBPACK_IMPORTED_MODULE_13__["pickBy"])(values)).filter(function (name) {
        return _this4.extensions.includes(name);
      });
    }
  }, {
    key: "convertCurrency",
    value: function convertCurrency(value) {
      var region = Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_19__["getCurrencyRegion"])(this.props.settings.woocommerce_default_country);
    ...
    value: function numberFormat(value) {
      ...
      return Object(_woocommerce_number__WEBPACK_IMPORTED_MODULE_14__["formatValue"])(getCurrency(), 'number', value);
    }
  }, {
    ...
    value: function getNumberRangeString(min) {
      ...
      if (!max) {
        return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["_x"])('%s+', 'store product count or revenue', 'woocommerce'), format(min));
      }

      return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["_x"])('%1$s - %2$s', 'store product count or revenue range', 'woocommerce'), format(min), format(max));
    }
  }, {
    ...
    value: function renderBusinessExtensionHelpText(values) {
      ...
      var extensionsList = extensions.map(function (extension) {
        return _woocommerce_data__WEBPACK_IMPORTED_MODULE_16__["pluginNames"][extension];
      }).join(', ');

      if (isInstallingActivating) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["_n"])('Installing the following plugin: %s', 'Installing the following plugins: %s', extensions.length, 'woocommerce'), extensionsList));
      }

      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["_n"])('The following plugin will be installed for free: %s', 'The following plugins will be installed for free: %s', extensions.length, 'woocommerce'), extensionsList));
    }
  }, {
    ...
    value: function renderBusinessExtensions(values, getInputProps) {
      var extensionBenefits = [{
        ...
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Market on Facebook', 'woocommerce'),
        icon: 'onboarding/fb-woocommerce.png',
        description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Grow your business by targeting the right people and driving sales with Facebook.', 'woocommerce')
      }, {
        slug: 'mailchimp-for-woocommerce',
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Contact customers with Mailchimp', 'woocommerce'),
        icon: 'onboarding/mailchimp.png',
        description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Send targeted campaigns, recover abandoned carts and much more with Mailchimp.', 'woocommerce')
      }, {
        slug: 'kliken-marketing-for-google',
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Drive sales with Google Ads', 'woocommerce'),
        icon: 'onboarding/g-shopping.png',
        description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Get in front of new customers on Google and secure $150 in ads credit with Kliken’s integration.', 'woocommerce')
      }];
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, extensionBenefits.map(function (benefit) {
        ...
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["H"], {
          className: "woocommerce-profile-wizard__benefit-title"
        }, benefit.title), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("p", null, benefit.description)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
          className: "woocommerce-profile-wizard__benefit-toggle"
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["FormToggle"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    ...
    value: function render() {
      ...
      var productCountOptions = [{
        key: '0',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])("I don't have any products yet.", 'woocommerce')
      }, {
        key: '1-10',
      ...
      var revenueOptions = [{
        ...
        Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])("%s (I'm just getting started)", 'woocommerce'), formatCurrency(0))
      }, {
        key: 'up-to-2500',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(
        /* translators: %s: A given revenue amount, e.g., $2500 */
        Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Up to %s', 'woocommerce'), formatCurrency(this.convertCurrency(2500)))
      }, {
        key: '2500-10000',
        ...
        Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('More than %s', 'woocommerce'), formatCurrency(this.convertCurrency(250000)))
      }];
      var sellingVenueOptions = [{
        key: 'no',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('No', 'woocommerce')
      }, {
        key: 'other',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Yes, on another platform', 'woocommerce')
      }, {
        key: 'other-woocommerce',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Yes, I own a different store powered by WooCommerce', 'woocommerce')
      }, {
        key: 'brick-mortar',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Yes, in person at physical stores and/or events', 'woocommerce')
      }, {
        key: 'brick-mortar-other',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Yes, on another platform and in person at physical stores and/or events', 'woocommerce')
      }];
      var otherPlatformOptions = [{
        key: 'shopify',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Shopify', 'woocommerce')
      }, {
        key: 'bigcommerce',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('BigCommerce', 'woocommerce')
      }, {
        key: 'magento',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Magento', 'woocommerce')
      }, {
        key: 'wix',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Wix', 'woocommerce')
      }, {
        key: 'amazon',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Amazon', 'woocommerce')
      }, {
        key: 'ebay',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('eBay', 'woocommerce')
      }, {
        key: 'etsy',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Etsy', 'woocommerce')
      }, {
        key: 'squarespace',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Squarespace', 'woocommerce')
      }, {
        key: 'other',
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Other', 'woocommerce')
      }];
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["Form"], {
        ...
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["H"], {
          className: "woocommerce-profile-wizard__header-title"
        }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Tell us about your business', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])("We'd love to know if you are just getting started or you already have a business in place.", 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["Card"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["SelectControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('How many products do you plan to display?', 'woocommerce'),
          options: productCountOptions,
          required: true
        }, getInputProps('product_count'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["SelectControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Currently selling elsewhere?', 'woocommerce'),
          ...
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])("What's your current annual revenue?", 'woocommerce'),
          options: revenueOptions,
          required: true
        }, getInputProps('revenue'))), ['other', 'brick-mortar-other'].includes(values.selling_venues) && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
          className: "business-competitors"
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["SelectControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Which platform is the store using?', 'woocommerce'),
          options: otherPlatformOptions,
          required: true
        }, getInputProps('other_platform'))), values.other_platform === 'other' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_17__["TextControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('What is the platform name?', 'woocommerce'),
          required: true
        }, getInputProps('other_platform_name'))))), showExtensions && _this5.renderBusinessExtensions(values, getInputProps), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
          className: "woocommerce-profile-wizard__card-actions"
        ...
        }, !hasInstallActivateError ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Continue', 'woocommerce') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Retry', 'woocommerce')), hasInstallActivateError && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["Button"], {
          onClick: function onClick() {
            return goToNextStep();
          }
        }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Continue without installing', 'woocommerce'))))), showExtensions && _this5.renderBusinessExtensionHelpText(values));
      });
    }
  }]);
...
BusinessDetails.contextType = lib_currency_context__WEBPACK_IMPORTED_MODULE_20__["CurrencyContext"];
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_12__["withSelect"])(function (select) {
  var _select = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_16__["SETTINGS_STORE_NAME"]),
      getSettings = _select.getSettings,
      getSettingsError = _select.getSettingsError,
      isGetSettingsRequesting = _select.isGetSettingsRequesting;

  var _select2 = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_16__["ONBOARDING_STORE_NAME"]),
      getProfileItems = _select2.getProfileItems,
      getOnboardingError = _select2.getOnboardingError;
  ...
  var _dispatch = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_16__["ONBOARDING_STORE_NAME"]),
...
/***/ "./client/profile-wizard/steps/industry.js":
/*!*************************************************!*\
  !*** ./client/profile-wizard/steps/industry.js ***!
  \*************************************************/
/*! exports provided: default */
...
var onboarding = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_13__["getSetting"])('onboarding', {});

var Industry = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Industry, _Component);

  var _super = _createSuper(Industry);

  function Industry(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Industry);

    var profileItems = Object(lodash__WEBPACK_IMPORTED_MODULE_11__["get"])(props, 'profileItems', {});
    ...
    var region = Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_16__["getCurrencyRegion"])(locationSettings.woocommerce_default_country);
    ...
    _this.onContinue = _this.onContinue.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this));
    _this.onIndustryChange = _this.onIndustryChange.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this));
    _this.onDetailChange = _this.onDetailChange.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Industry, [{
    key: "onContinue",
    value: function () {
      var _onContinue = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                Object(lib_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('storeprofiler_store_industry_continue', {
              ...
              case 10:
                if (!isError) {
                  ...
                  createNotice('error', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('There was a problem updating your industries.', 'woocommerce'));
                }
    ...
    key: "validateField",
    value: function () {
      var _validateField = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var error;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                error = this.state.selected.length ? null : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Please select at least one industry', 'woocommerce');
                this.setState({
                  error: error
                });
    ...
    value: function onIndustryChange(slug) {
      ...
      this.setState(function (state) {
        ...
        var selectedIndustry = Object(lodash__WEBPACK_IMPORTED_MODULE_11__["find"])(newSelected, {
          slug: slug
        });
        ...
        if (selectedIndustry) {
          ...
          return {
            selected: Object(lodash__WEBPACK_IMPORTED_MODULE_11__["filter"])(state.selected, function (value) {
    ...
    value: function onDetailChange(value, slug) {
      this.setState(function (state) {
        var newSelected = state.selected;
        var newTextInputListContent = state.textInputListContent;
        var industryIndex = Object(lodash__WEBPACK_IMPORTED_MODULE_11__["findIndex"])(newSelected, {
          slug: slug
        });
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["H"], {
        className: "woocommerce-profile-wizard__header-title"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('In which industry does the store operate?', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("p", {
        className: "woocommerce-profile-wizard__intro-paragraph"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Choose any that apply')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["Card"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
        className: "woocommerce-profile-wizard__checkbox-group"
      }, filteredIndustryKeys.map(function (slug) {
        var selectedIndustry = Object(lodash__WEBPACK_IMPORTED_MODULE_11__["find"])(selected, {
          slug: slug
        });
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
          key: "div-".concat(slug)
        ...
        }), industries[slug].use_description && selectedIndustry && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["TextControl"], {
      ...
      }), error && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("span", {
        className: "woocommerce-profile-wizard__error"
      }, error)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["Button"], {
        isPrimary: true,
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(wc_api_with_select__WEBPACK_IMPORTED_MODULE_17__["default"])(function (select) {
  var _select = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["ONBOARDING_STORE_NAME"]),
      getProfileItems = _select.getProfileItems,
      getOnboardingError = _select.getOnboardingError;

  var _select2 = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["SETTINGS_STORE_NAME"]),
  ...
  var _dispatch = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["ONBOARDING_STORE_NAME"]),
      updateProfileItems = _dispatch.updateProfileItems;
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var interpolate_components__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! interpolate-components */ "./node_modules/interpolate-components/lib/index.js");
...
var ProductTypes = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(ProductTypes, _Component);

  var _super = _createSuper(ProductTypes);

  function ProductTypes(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, ProductTypes);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(ProductTypes, [{
    key: "validateField",
    value: function () {
      var _validateField = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var error;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                error = this.state.selected.length ? null : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Please select at least one product type', 'woocommerce');
                this.setState({
                  error: error
                });
    ...
    key: "onContinue",
    value: function () {
      var _onContinue = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                _this$props = this.props, createNotice = _this$props.createNotice, goToNextStep = _this$props.goToNextStep, isError = _this$props.isError, updateProfileItems = _this$props.updateProfileItems;
                Object(lib_tracks__WEBPACK_IMPORTED_MODULE_17__["recordEvent"])('storeprofiler_store_product_type_continue', {
              ...
              case 8:
                if (!isError) {
                  ...
                  createNotice('error', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('There was a problem updating your product types.', 'woocommerce'));
                }
    ...
    value: function onChange(slug) {
      ...
      this.setState(function (state) {
        if (Object(lodash__WEBPACK_IMPORTED_MODULE_11__["includes"])(state.selected, slug)) {
          return {
            selected: Object(lodash__WEBPACK_IMPORTED_MODULE_11__["filter"])(state.selected, function (value) {
              return value !== slug;
            }) || []
    ...
    value: function onLearnMore(slug) {
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_17__["recordEvent"])('storeprofiler_store_product_type_learn_more', {
        product_type: slug
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var _getSetting = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_14__["getSetting"])('onboarding', {}),
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["H"], {
        className: "woocommerce-profile-wizard__header-title"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('What type of products will be listed?', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Choose any that apply')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["Card"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
        className: "woocommerce-profile-wizard__checkbox-group"
      }, Object.keys(productTypes).map(function (slug) {
        var helpText = productTypes[slug].description && interpolate_components__WEBPACK_IMPORTED_MODULE_12___default()({
          mixedString: productTypes[slug].description + (productTypes[slug].more_url ? ' {{moreLink/}}' : ''),
          components: {
            moreLink: productTypes[slug].more_url ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["Link"], {
            ...
            }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Learn more', 'woocommerce')) : ''
          }
        });
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["CheckboxControl"], {
          key: slug,
        ...
        className: "woocommerce-profile-wizard__error"
      }, error)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        isPrimary: true,
        onClick: this.onContinue,
        disabled: !selected.length
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Continue', 'woocommerce'))));
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_9__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_13__["withSelect"])(function (select) {
...
/***/ "./client/profile-wizard/steps/store-details.js":
/*!******************************************************!*\
  !*** ./client/profile-wizard/steps/store-details.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @woocommerce/components */ "@woocommerce/components");
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _woocommerce_currency__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @woocommerce/currency */ "@woocommerce/currency");
/* harmony import */ var _woocommerce_currency__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_currency__WEBPACK_IMPORTED_MODULE_16__);
...
/* harmony import */ var dashboard_components_settings_general_store_address__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! dashboard/components/settings/general/store-address */ "./client/dashboard/components/settings/general/store-address.js");
/* harmony import */ var _usage_modal__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./usage-modal */ "./client/profile-wizard/steps/usage-modal.js");
/* harmony import */ var lib_currency_context__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! lib/currency-context */ "./client/lib/currency-context.js");
...
var StoreDetails = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(StoreDetails, _Component);

  var _super = _createSuper(StoreDetails);

  function StoreDetails(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, StoreDetails);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(StoreDetails, [{
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
    ...
    value: function deriveCurrencySettings(countryState) {
      ...
      var region = Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_18__["getCurrencyRegion"])(countryState);
      var currencyData = Object(_woocommerce_currency__WEBPACK_IMPORTED_MODULE_16__["getCurrencyData"])();
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                Object(lib_tracks__WEBPACK_IMPORTED_MODULE_14__["recordEvent"])('storeprofiler_store_details_continue', {
                  store_country: Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_18__["getCountryCode"])(values.countryState),
              ...
              case 7:
                ...
                region = Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_18__["getCurrencyRegion"])(values.countryState);
                /**
              ...
              case 12:
                if (!isSettingsError && !isProfileItemsError) {
                  ...
                  createNotice('error', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('There was a problem saving your store details.', 'woocommerce'));
                }
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["H"], {
        className: "woocommerce-profile-wizard__header-title"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Where is your store based?', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["H"], {
        className: "woocommerce-profile-wizard__header-subtitle"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('This will help us configure your store and get you started quickly', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["Card"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["Form"], {
        initialValues: this.initialValues,
        onSubmitCallback: this.onSubmit,
        validate: dashboard_components_settings_general_store_address__WEBPACK_IMPORTED_MODULE_19__["validateStoreAddress"]
      }, function (_ref) {
        var getInputProps = _ref.getInputProps,
            handleSubmit = _ref.handleSubmit,
            values = _ref.values,
        ...
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, showUsageModal && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_usage_modal__WEBPACK_IMPORTED_MODULE_20__["default"], {
        ...
        }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(dashboard_components_settings_general_store_address__WEBPACK_IMPORTED_MODULE_19__["StoreAddress"], {
          getInputProps: getInputProps,
          setValue: setValue
        }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
          className: "woocommerce-profile-wizard__client"
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["CheckboxControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])("I'm setting up a store for a client", 'woocommerce')
        }, getInputProps('isClient')))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["Button"], {
          isPrimary: true,
          onClick: handleSubmit,
          disabled: !isValidForm
        }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Continue', 'woocommerce')));
      })));
    }
  }]);
...
StoreDetails.contextType = lib_currency_context__WEBPACK_IMPORTED_MODULE_21__["CurrencyContext"];
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_12__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_13__["withSelect"])(function (select) {
  var _select = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["SETTINGS_STORE_NAME"]),
      getSettings = _select.getSettings,
      getSettingsError = _select.getSettingsError,
      isGetSettingsRequesting = _select.isGetSettingsRequesting;

  var _select2 = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["ONBOARDING_STORE_NAME"]),
      getOnboardingError = _select2.getOnboardingError,
      getProfileItems = _select2.getProfileItems;
  ...
  var _dispatch2 = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["ONBOARDING_STORE_NAME"]),
      updateProfileItems = _dispatch2.updateProfileItems;

  var _dispatch3 = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["SETTINGS_STORE_NAME"]),
...
/***/ "./client/profile-wizard/steps/theme/index.js":
/*!****************************************************!*\
  !*** ./client/profile-wizard/steps/theme/index.js ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./style.scss */ "./client/profile-wizard/steps/theme/style.scss");
...
/* harmony import */ var lib_tracks__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! lib/tracks */ "./client/lib/tracks.js");
/* harmony import */ var _uploader__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./uploader */ "./client/profile-wizard/steps/theme/uploader.js");
/* harmony import */ var _preview__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./preview */ "./client/profile-wizard/steps/theme/preview.js");
/* harmony import */ var dashboard_utils__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! dashboard/utils */ "./client/dashboard/utils.js");
...
var Theme = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(Theme, _Component);
  ...
  function Theme() {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, Theme);
    ...
    _this.handleUploadComplete = _this.handleUploadComplete.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.onChoose = _this.onChoose.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.onClosePreview = _this.onClosePreview.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.onSelectTab = _this.onSelectTab.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.openDemo = _this.openDemo.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.skipStep = _this.skipStep.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Theme, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      var _this$props = this.props,
          isError = _this$props.isError,
      ...
      if (isRequestError) {
        ...
        createNotice('error', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('There was a problem selecting your store theme.', 'woocommerce'));
      }
    }
  }, {
    key: "onChoose",
    value: function onChoose(theme) {
      ...
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_store_theme_choose', {
        theme: slug,
        location: location
      });

      if (slug !== activeTheme && Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_24__["getPriceValue"])(price) <= 0) {
        if (isInstalled) {
    ...
    value: function installTheme(slug) {
      ...
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_10___default()({
        ...
        createNotice('success', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('%s was installed on your site.', 'woocommerce'), response.name));
    ...
    value: function activateTheme(slug) {
      ...
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_10___default()({
        ...
        createNotice('success', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('%s was activated on your site.', 'woocommerce'), response.name));
    ...
    value: function onClosePreview() {
      ...
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_store_theme_demo_close', {
        theme: demo.slug
      });
    ...
    value: function openDemo(theme) {
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_store_theme_live_demo', {
        theme: theme.slug
      });
    ...
    value: function skipStep() {
      ...
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_store_theme_skip_step', {
    ...
    value: function renderTheme(theme) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["Card"], {
      ...
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["H"], {
        className: "woocommerce-profile-wizard__theme-name"
      }, title, !hasSupport && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_14__["Tooltip"], {
        text: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('This theme does not support WooCommerce.', 'woocommerce')
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("span", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(gridicons__WEBPACK_IMPORTED_MODULE_13___default.a, {
        icon: "info",
        role: "img",
        "aria-hidden": "true",
        focusable: "false"
      ...
      }, this.getThemeStatus(theme)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
        className: "woocommerce-profile-wizard__theme-actions"
      }, slug === activeTheme ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_14__["Button"], {
        isPrimary: true,
        onClick: function onClick() {
          return _this4.onChoose(theme, 'card');
        },
        isBusy: chosen === slug
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Continue with my active theme', 'woocommerce')) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_14__["Button"], {
        isSecondary: true,
        onClick: function onClick() {
          return _this4.onChoose(theme, 'card');
        },
        isBusy: chosen === slug
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Choose', 'woocommerce')), demoUrl && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_14__["Button"], {
        isTertiary: true,
        onClick: function onClick() {
          return _this4.openDemo(theme);
        }
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Live demo', 'woocommerce')))));
    }
  }, {
    key: "getThemeStatus",
    value: function getThemeStatus(theme) {
      ...
      if (activeTheme === slug) {
        return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Currently active theme', 'woocommerce');
      }

      if (isInstalled) {
        return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Installed', 'woocommerce');
      } else if (Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_24__["getPriceValue"])(price) <= 0) {
        return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Free', 'woocommerce');
      }

      return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('%s per year', 'woocommerce'), Object(_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_12__["decodeEntities"])(price));
    }
  }, {
    key: "doesActiveThemeSupportWooCommerce",
    value: function doesActiveThemeSupportWooCommerce() {
      var _getSetting5 = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_17__["getSetting"])('onboarding', {}),
    ...
    value: function onSelectTab(tab) {
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_store_theme_navigate', {
        navigation: tab
      });
      this.setState({
        activeTab: tab
    ...
    value: function getPriceValue(string) {
      return Number(Object(_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_12__["decodeEntities"])(string).replace(/[^0-9.-]+/g, ''));
    }
  }, {
    key: "getThemes",
    value: function getThemes() {
      ...
      var _getSetting6 = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_17__["getSetting"])('onboarding', {}),
      ...
      var allThemes = [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(themes.filter(function (theme) {
        return theme && (theme.has_woocommerce_support || theme.slug === activeTheme);
      })), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(uploadedThemes));

      switch (activeTab) {
        case 'paid':
          return allThemes.filter(function (theme) {
            return Object(dashboard_utils__WEBPACK_IMPORTED_MODULE_24__["getPriceValue"])(theme.price) > 0;
          });
    ...
    value: function handleUploadComplete(upload) {
      if (upload.status === 'success' && upload.theme_data) {
        this.setState({
          uploadedThemes: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(this.state.uploadedThemes), [upload.theme_data])
        });
        Object(lib_tracks__WEBPACK_IMPORTED_MODULE_21__["recordEvent"])('storeprofiler_store_theme_upload', {
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["H"], {
        className: "woocommerce-profile-wizard__header-title"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Choose a theme', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["H"], {
        className: "woocommerce-profile-wizard__header-subtitle"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])("Choose how your store appears to customers. And don't worry, you can always switch themes and edit them later.", 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_14__["TabPanel"], {
        className: "woocommerce-profile-wizard__themes-tab-panel",
        activeClass: "is-active",
        onSelect: this.onSelectTab,
        tabs: [{
          name: 'all',
          title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('All themes', 'woocommerce')
        }, {
          name: 'paid',
          title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Paid themes', 'woocommerce')
        }, {
          name: 'free',
          title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Free themes', 'woocommerce')
        }]
      }, function () {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
        ...
        }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_uploader__WEBPACK_IMPORTED_MODULE_22__["default"], {
          onUploadComplete: _this5.handleUploadComplete
        }));
      }), demo && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_preview__WEBPACK_IMPORTED_MODULE_23__["default"], {
        theme: demo,
      ...
      }), activeThemeSupportsWooCommerce && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("p", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_14__["Button"], {
        isLink: true,
        className: "woocommerce-profile-wizard__skip",
        onClick: function onClick() {
          return _this5.skipStep();
        }
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Skip this step', 'woocommerce'))));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_11__["compose"])(Object(wc_api_with_select__WEBPACK_IMPORTED_MODULE_19__["default"])(function (select) {
  var _select = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["ONBOARDING_STORE_NAME"]),
      getProfileItems = _select.getProfileItems,
      getOnboardingError = _select.getOnboardingError,
      isOnboardingRequesting = _select.isOnboardingRequesting;
  ...
  var _dispatch = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["ONBOARDING_STORE_NAME"]),
      updateProfileItems = _dispatch.updateProfileItems;
...
/***/ "./client/profile-wizard/steps/theme/preview.js":
/*!******************************************************!*\
  !*** ./client/profile-wizard/steps/theme/preview.js ***!
  \******************************************************/
/*! exports provided: default */
...
var ThemePreview = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(ThemePreview, _Component);

  var _super = _createSuper(ThemePreview);

  function ThemePreview() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ThemePreview);

    _this = _super.apply(this, arguments);
    _this.state = {
      device: 'desktop'
    };
    _this.handleDeviceClick = _this.handleDeviceClick.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ThemePreview, [{
    key: "handleDeviceClick",
    value: function handleDeviceClick(device) {
      var theme = this.props.theme;
      Object(lib_tracks__WEBPACK_IMPORTED_MODULE_12__["recordEvent"])('storeprofiler_store_theme_demo_device', {
        device: device,
        theme: theme.slug
      });
      this.setState({
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
      ...
      }, "close")), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        ...
        mixedString: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('{{strong}}%s{{/strong}} developed by WooCommerce', 'woocommerce'), title),
        components: {
          strong: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("strong", null)
        }
      })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        ...
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__["Button"], {
          key: device.key,
          className: classnames__WEBPACK_IMPORTED_MODULE_9___default()('woocommerce-theme-preview__device', {
        ...
        isBusy: isBusy
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Choose', 'woocommerce'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_11__["WebPreview"], {
        src: demoUrl,
        title: title,
...
/* harmony default export */ __webpack_exports__["default"] = (ThemePreview);

/***/ }),

/***/ "./client/profile-wizard/steps/theme/style.scss":
/*!******************************************************!*\
  !*** ./client/profile-wizard/steps/theme/style.scss ***!
  \******************************************************/
...
/***/ "./client/profile-wizard/steps/theme/uploader.js":
/*!*******************************************************!*\
  !*** ./client/profile-wizard/steps/theme/uploader.js ***!
  \*******************************************************/
/*! exports provided: default */
...
var ThemeUploader = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(ThemeUploader, _Component);

  var _super = _createSuper(ThemeUploader);

  function ThemeUploader() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ThemeUploader);

    _this = _super.call(this);
    _this.state = {
      isUploading: false
    };
    _this.handleFilesUpload = _this.handleFilesUpload.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this));
    _this.handleFilesDrop = _this.handleFilesDrop.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ThemeUploader, [{
    key: "handleFilesDrop",
    ...
    value: function render() {
      ...
      var classes = classnames__WEBPACK_IMPORTED_MODULE_9___default()('woocommerce-theme-uploader', className, {
        'is-uploading': isUploading
      });
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["Card"], {
        className: classes
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["DropZoneProvider"], null, !isUploading ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["FormFileUpload"], {
        accept: ".zip",
        onChange: this.handleFilesUpload
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(gridicons__WEBPACK_IMPORTED_MODULE_12___default.a, {
        icon: "cloud-upload"
      }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["H"], {
        className: "woocommerce-theme-uploader__title"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Upload a theme', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Drop a theme zip file here to upload', 'woocommerce'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["DropZone"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Drop your theme zip file here', 'woocommerce'),
        onFilesDrop: this.handleFilesDrop
      })) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["Spinner"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_16__["H"], {
        className: "woocommerce-theme-uploader__title"
      }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Uploading theme', 'woocommerce')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Your theme is being uploaded', 'woocommerce')))));
    }
  }]);
...
ThemeUploader.propTypes = {
   ...
   */
  onUploadComplete: prop_types__WEBPACK_IMPORTED_MODULE_14___default.a.func
};
ThemeUploader.defaultProps = {
  onUploadComplete: lodash__WEBPACK_IMPORTED_MODULE_13__["noop"]
};
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_15__["withDispatch"])(function (dispatch) {
  var _dispatch = dispatch('core/notices'),
      createNotice = _dispatch.createNotice;
...
/***/ "./client/profile-wizard/steps/usage-modal.js":
/*!****************************************************!*\
  !*** ./client/profile-wizard/steps/usage-modal.js ***!
  \****************************************************/
/*! exports provided: default */
...
var UsageModal = /*#__PURE__*/function (_Component) {
  ...
  function UsageModal(props) {
    ...
    _this.onTrackingChange = _this.onTrackingChange.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this));
    return _this;
  }
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(UsageModal, [{
    ...
    key: "componentDidUpdate",
    value: function () {
      var _componentDidUpdate = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee(prevProps, prevState) {
    ...
    value: function render() {
      ...
      var trackingMessage = interpolate_components__WEBPACK_IMPORTED_MODULE_11___default()({
        mixedString: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Get improved features and faster fixes by sharing non-sensitive data via {{link}}usage tracking{{/link}} ' + 'that shows us how WooCommerce is used. No personal data is tracked or stored.', 'woocommerce'),
        components: {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["Modal"], {
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Build a better WooCommerce', 'woocommerce'),
      ...
      }, trackingMessage), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
        className: "woocommerce-profile-wizard__tracking"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["CheckboxControl"], {
        className: "woocommerce-profile-wizard__tracking-checkbox",
        checked: allowTracking,
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Yes, count me in!', 'woocommerce'),
        onChange: this.onTrackingChange
      }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["FormToggle"], {
        "aria-hidden": "true",
        checked: allowTracking,
        onChange: this.onTrackingChange,
...
//# sourceMappingURL=profile-wizard.bdc0b7d8ae1cc49dcf5d.min.js.map
