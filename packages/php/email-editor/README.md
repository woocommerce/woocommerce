...
| `woocommerce_email_editor_send_preview_email_personalizer_context` | ``string` $contentStyles, `WP_Post` $post` $personalizerContext | `Array` Personalizer context data                            | Allows modifying the personalizer context data for the send preview email function                                                                                     |
