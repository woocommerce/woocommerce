...
class Table extends Abstract_Block_Renderer {
	...
	protected function render_content( string $block_content, array $parsed_block, Rendering_Context $rendering_context ): string {
		...
		if ( $html->next_tag() ) {
			...
			$block_classes = $this->safe_str_replace( 'has-background', '', $block_classes );
		...
		$classes = $this->safe_str_replace( 'has-background', '', $classes );
	...
	private function process_table_content( string $block_content, array $parsed_block, Rendering_Context $rendering_context, bool $is_striped_table = false ): string {
		...
		while ( $html->next_tag() ) {
			...
			if ( 'TABLE' === $tag_name ) {
				...
				$class_attr = $this->safe_str_replace( 'has-background', '', $class_attr );
	...
	/**
	 * Safely replace strings to ensure type safety for PHPStan.
	 *
	 ...
	 */
	private function safe_str_replace( string $search, string $replace, string $subject ): string {
