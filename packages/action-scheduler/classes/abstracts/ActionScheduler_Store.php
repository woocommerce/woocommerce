...
abstract class ActionScheduler_Store extends ActionScheduler_Store_Deprecated {
	...
	protected function validate_action( ActionScheduler_Action $action ) {
		if ( strlen( json_encode( $action->get_args() ) ) > self::$max_index_length ) {
			throw new InvalidArgumentException( __( 'ActionScheduler_Action::$args too long. To ensure the args column can be indexed, action args should not be more than 191 characters when encoded as JSON.', 'woocommerce' ) );
		}
	}
