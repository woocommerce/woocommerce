		...
		if ( $this->runner->has_maximum_concurrent_batches() ) {
			$this->admin_notices[] = array(
				...
				'message' => sprintf(
					...
					__( 'Maximum simultaneous queues already in progress (%s queues). No additional queues will begin processing until the current queues are complete.', 'woocommerce' ),
