...
declare module '@wordpress/block-editor/components/media-upload' {
	/* eslint-disable @definitelytyped/no-unnecessary-generics */
	import { ComponentType, JSX } from "react";

	import { default as MediaPlaceholder } from "@wordpress/block-editor/components/media-placeholder";
