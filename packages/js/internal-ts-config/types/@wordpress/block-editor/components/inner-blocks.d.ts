...
declare module '@wordpress/block-editor/components/inner-blocks' {
	import { Block } from "@wordpress/blocks";
	import { ComponentType, JSX, ReactElement, Ref } from "react";

	import { EditorTemplateLock } from "@wordpress/block-editor";

	import { Merged, Reserved } from "@wordpress/block-editor/components/use-block-props";
