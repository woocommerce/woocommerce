...
/// <reference path="./store/defaults.d.ts" />
...
declare module '@wordpress/block-editor' {
	...
	export { storeConfig } from "@wordpress/block-editor/store";
	...
	export interface BlockEditorStoreDescriptor extends
	    StoreDescriptor<
	        ReduxStoreConfig<any, typeof import("@wordpress/block-editor/store/actions"), Decurry<typeof import("@wordpress/block-editor/store/selectors")>>
	    >
	{
...
declare module '@wordpress/data' {
	import type { BlockEditorStoreDescriptor } from '@wordpress/block-editor';
