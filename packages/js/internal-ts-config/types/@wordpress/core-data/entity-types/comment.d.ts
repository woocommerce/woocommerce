...
declare module '@wordpress/core-data/build-types/entity-types/comment' {
	/**
	 * Internal dependencies
	 */
	import type { AvatarUrls, Context, ContextualField, OmitNevers, RenderedText } from '@wordpress/core-data/build-types/entity-types/helpers';
