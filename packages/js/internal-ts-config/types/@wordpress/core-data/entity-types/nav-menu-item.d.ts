...
declare module '@wordpress/core-data/build-types/entity-types/nav-menu-item' {
	/**
	 * Internal dependencies
	 */
	import type { RenderedText, Context, ContextualField, OmitNevers } from '@wordpress/core-data/build-types/entity-types/helpers';
	...
	export type NavMenuItemType = 'taxonomy' | 'post_type' | 'post_type_archive' | 'custom';
	export type NavMenuItemStatus = 'publish' | 'future' | 'draft' | 'pending' | 'private';
	...
	export type NavMenuItem<C extends Context = 'edit'> = OmitNevers<_BaseEntityRecords.NavMenuItem<C>>;
}
