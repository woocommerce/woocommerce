...
declare module '@wordpress/core-data/build-types/entity-types/plugin' {
	/**
	 * Internal dependencies
	 */
	import type { Context, ContextualField, RenderedText, OmitNevers } from '@wordpress/core-data/build-types/entity-types/helpers';
