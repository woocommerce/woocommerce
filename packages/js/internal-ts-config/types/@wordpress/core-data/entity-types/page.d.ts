...
declare module '@wordpress/core-data/build-types/entity-types/page' {
	/**
	 * Internal dependencies
	 */
	import type { CommentingStatus, Context, ContextualField, PingStatus, PostStatus, RenderedText, OmitNevers } from '@wordpress/core-data/build-types/entity-types/helpers';
	...
	export type Page<C extends Context = 'edit'> = OmitNevers<_BaseEntityRecords.Page<C>>;
}
