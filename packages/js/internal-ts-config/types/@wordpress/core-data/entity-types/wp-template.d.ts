...
declare module '@wordpress/core-data/build-types/entity-types/wp-template' {
	/**
	 * Internal dependencies
	 */
	import type { Context, PostStatus, RenderedText, OmitNevers, ContextualField } from '@wordpress/core-data/build-types/entity-types/helpers';
