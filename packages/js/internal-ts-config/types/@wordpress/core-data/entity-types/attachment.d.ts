...
declare module '@wordpress/core-data/build-types/entity-types/attachment' {
	/**
	 * Internal dependencies
	 */
	import type { Context, ContextualField, MediaType, PostStatus, RenderedText, OmitNevers, CommentingStatus, PingStatus } from '@wordpress/core-data/build-types/entity-types/helpers';
