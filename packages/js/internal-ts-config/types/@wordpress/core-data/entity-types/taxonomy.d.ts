...
declare module '@wordpress/core-data/build-types/entity-types/taxonomy' {
	/**
	...
	export type Taxonomy<C extends Context = 'edit'> = OmitNevers<_BaseEntityRecords.Taxonomy<C>>;
}
