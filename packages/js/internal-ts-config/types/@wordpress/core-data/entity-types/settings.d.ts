...
declare module '@wordpress/core-data/build-types/entity-types/settings' {
	/**
	 * Internal dependencies
	 */
	import type { CommentingStatus, Context, OmitNevers, PingStatus } from '@wordpress/core-data/build-types/entity-types/helpers';
