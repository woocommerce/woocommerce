...
declare module '@wordpress/core-data/build-types/entity-types/helpers' {
	 ...
	 */
	import type { EntityRecord } from '@wordpress/core-data/build-types/entity-types';
	 ...
	 * ```
	 */
	export type ContextualField<FieldType, AvailableInContexts extends Context, C extends Context> = AvailableInContexts extends C ? FieldType : never;
	/**
	 ...
	 * ```
	 */
	export type OmitNevers<T, Nevers = {
