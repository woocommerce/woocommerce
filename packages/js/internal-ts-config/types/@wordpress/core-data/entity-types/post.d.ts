...
declare module '@wordpress/core-data/build-types/entity-types/post' {
	/**
	 * Internal dependencies
	 */
	import type { CommentingStatus, Context, ContextualField, PingStatus, PostFormat, PostStatus, RenderedText, OmitNevers } from '@wordpress/core-data/build-types/entity-types/helpers';
	...
	export type Post<C extends Context = 'edit'> = OmitNevers<_BaseEntityRecords.Post<C>>;
}
