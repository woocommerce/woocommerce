...
declare module '@wordpress/core-data/build-types/entity-types/theme' {
	/**
	 * Internal dependencies
	 */
	import type { Context, PostFormat, RenderedText, OmitNevers } from '@wordpress/core-data/build-types/entity-types/helpers';
	...
	export type Theme<C extends Context = 'edit'> = OmitNevers<_BaseEntityRecords.Theme<C>>;
}
