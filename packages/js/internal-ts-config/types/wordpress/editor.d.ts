...
declare module '@wordpress/data' {
	...
	export function select(key: 'core/editor'): CurriedSelectorsOf<EditorStoreDescriptor>;
	export function dispatch(key: 'core/editor'): ActionCreatorsOf<EditorConfig>;
	export function resolveSelect(key: 'core/editor'): CurriedAndPromisifiedSelectorsOf<EditorStoreDescriptor>;
	export function useDispatch(key: 'core/editor'): ActionCreatorsOf<EditorConfig>;
}
