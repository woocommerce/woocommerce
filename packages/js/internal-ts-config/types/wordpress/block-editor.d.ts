...
type WithState<Selectors> = {
	[K in keyof Selectors]: Selectors[K] extends (...args: infer A) => infer R
...
declare module '@wordpress/data' {
	...
	export function select(key: 'core/block-editor'): CurriedSelectorsOf<BlockEditorStoreDescriptor>;
	export function dispatch(key: 'core/block-editor'): ActionCreatorsOf<BlockEditorConfig>;
	export function resolveSelect(key: 'core/block-editor'): CurriedAndPromisifiedSelectorsOf<BlockEditorStoreDescriptor>;
	export function useDispatch(key: 'core/block-editor'): ActionCreatorsOf<BlockEditorConfig>;
}
