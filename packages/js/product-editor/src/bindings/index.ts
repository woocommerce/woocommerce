...
export default function registerBlockBindingSources() {
	if ( ! isBlockBindingAPIAvailable() ) {
		/*
		 * Fallback to extending blocks with bound attributes.
		 * This is a custom temporary implementation.
		 * It should be removed once the core once
		 * is available.
		 */
		addFilter(
