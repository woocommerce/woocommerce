 ...
 */
import { EditVariationOptionModal } from './edit-variation-option-modal';
import { EnhancedProductAttribute } from '../../hooks/use-product-attributes';
import {
	getAttributeId,
	getAttributeKey,
	reorderSortableProductAttributePositions,
} from '../attribute-control/utils';
...
export const VariationOptionsControl: React.FC< AttributeControlProps > = ( {
	value,
	onAdd = () => {},
	onChange,
	onEdit = () => {},
	...
	return (
		<div className="woocommerce-variation-option-field">
			<Button
				variant="secondary"
				className="woocommerce-add-variation-option-list-item__add-button"
				onClick={ () => {
					openNewModal();
					recordEvent( 'product_add_variation_options_click' );
				} }
			>
