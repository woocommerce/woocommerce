 ...
 */
import { NewVariationOptionModal } from '../new-variation-option-modal';
...
describe( 'NewVariationOptionModal', () => {
	beforeEach( () => {
		jest.clearAllMocks();
	} );
	...
	it( 'should allow us to remove the added fields', () => {
		...
		const removeButtons = queryAllByLabelText( 'Remove variation option' );
