...
export const EditVariationOptionModal: React.FC< EditAttributeModalProps > = ( {
	title = __( 'Edit variation option', 'woocommerce' ),
	...
	visibleTooltip = __(
		'Show or hide this variation option on the product page',
		'woocommerce'
	),
	cancelAccessibleLabel = __( 'Cancel', 'woocommerce' ),
	cancelLabel = __( 'Cancel', 'woocommerce' ),
	updateAccessibleLabel = __( 'Edit variation option', 'woocommerce' ),
	...
	return (
		<Modal
			...
			className="woocommerce-edit-variation-option-modal"
		>
			<div className="woocommerce-edit-variation-option-modal__body">
				<TextControl
					label={ nameLabel }
				...
				/>
				<p className="woocommerce-edit-variation-option-modal__helper-text">
					{ ! isCustomAttribute
						? globalAttributeHelperMessage
						: customAttributeHelperMessage }
				</p>
				...
				{ /* This field can probably be removed in future */ }
				<div className="woocommerce-edit-variation-option-modal__option-container">
					<CheckboxControl
						onChange={ ( val ) =>
							setEditableAttribute( {
								...( editableAttribute as EnhancedProductAttribute ),
			...
			<div className="woocommerce-edit-variation-option-modal__buttons">
				<Button
					isSecondary
