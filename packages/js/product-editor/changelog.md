...
## [2.0.0](https://www.npmjs.com/package/@woocommerce/product-editor/v/2.0.0) - 2024-02-09 

-   Patch - Corrected build configuration for packages that weren't outputting minified code. [#43716]
-   Patch - Export __experimentalVariationQUickUpdateMenuItem, __experimentalPluginHeaderItemModal, __experimentalPluginHeaderItemPopover [#44285]
-   Minor - Fix header toolbar in iframe modal editor to have block toolbar render correctly with latest Gutenberg and WP version. [#43835]
-   Minor - Fix issue when generating variations for the first time in the new editor. [#43583]
-   Patch - Fix performance issue when modifying product metadata [#43299]
-   Patch - Fix product editor UI misbehaving in custom adminmenu widths (e.g. Calypso) [#44132]
-   Patch - Fix typo that broke the CI pipeline and the build process. [#43148]
-   Patch - Hide the product type selector dropdown when click outside [#43798]
-   Minor - Revert "Show feedback bar only once (#41787)" #43178 [#43178]
-   Minor - Variation quick actions update properly when variation inherits sku of parent; slot fills always deal with arrays [#44017]
-   Patch - [Product Block Editor]: fix e2e test that happens in the text-area block [#44184]
-   Patch - [Product Block Editor]: fix the top area for the dashboard [#44370]
-   Minor - Add a featured product button [#43664]
-   Minor - Add empty state to the linked product list block [#43163]
-   Minor - Add HOC to hide inventory collapsible block when nothing is inside it [#43228]
-   Minor - Add prepublish panel #44331 [#44331]
-   Minor - Add slotFills for header items #43687 [#43687]
-   Minor - Add step buttons for Number block and component [#43045]
-   Minor - Add tooltip attribute to Pricing field #43144 [#43144]
-   Minor - Allow providing recently updated data for the validate function in the useValidation hook [#43320]
-   Minor - Always fallback to the standard product template in case the given product type is variable [#43422]
-   Minor - Create attribute control custom empty state [#44001]
-   Minor - Create linked product list block [#43145]
-   Minor - Create variation empty state when no variable attributes are asigned to the product [#44163]
-   Minor - Expose metadata as object from useProductMetadata hook [#43860]
-   Minor - Fix margin top for none first child nested sections [#43864]
-   Minor - Introduce a product type selection within the new experience [#41823]
-   Minor - Load/save the product template from/to the product meta data [#43120]
-   Minor - Product Editor: Subsection block #43725 [#43725]
-   Minor - Set the product template id also for unsupported product templates [#43341]
-   Minor - track Linked Products feature events [#43828]
-   Minor - Unlink downloads and downloadable product props so they can be managed separately [#44152]
-   Patch - [Product Block Editor]: add CashRegister image component [#43127]
-   Patch - [Product Block Editor]: Add Linked Product sections [#43013]
-   Patch - [Product Block Editor]: add loading for the `Choose products for me` button [#43656]
-   Patch - [Product Block Editor]: add plain and rich text mode to the Textarea field block [#44191]
-   Patch - [Product Block Editor]: add Upsell advice [#43116]
-   Patch - [Product Block Editor]: always show "loading" state when choosing suggested products [#44053]
-   Patch - [Product Block Editor]: exclude the current product from the suggested ones to use in the Linked Product tab [#43662]
-   Patch - [Product Block Editor]: implement `Choose products for me` button [#43520]
-   Patch - [Product Block Editor]: Introduce AdviceCard component [#43082]
-   Patch - [Product Block Editor]: Introduce ButtonWithDropdownMenuProps component [#43103]
-   Patch - [Product Block Editor]: introduce note attribute to Label component [#44198]
-   Patch - [Product Block Editor]: introduce ShoppingBags component [#43042]
-   Patch - [Product Block Editor]: introduce TextArea field block [#44104]
-   Patch - [Product Block Editor]: introduce `<SectionActions />` slot [#43540]
-   Patch - [Product Block Editor]: render empty state for the Cross-sells section [#43143]
-   Patch - [Product Block Editor]: use Label component to render Textarea field block label [#44222]
-   Patch - [Product Block Editor]: use text-area block to handle the variation description field [#44151]
-   Minor - Add isLoading to useProductMetadata hook [#44156]
-   Patch - bump php version in packages/js/*/composer.json [#42020]
-   Major [ **BREAKING CHANGE** ] - Load layout templates via the REST API. Note that layout template modifications must now be hooked up in an action that is called when REST API endpoints are handled, such as `rest_api_init`. [#43589]
-   Minor - Use different delays for initial click and hold when incrementing number on NumberControl [#43479]
-   Minor - Use woocommerce's Tooltip component for Label and checkbox instead of wordpress Tooltip [#43513]
-   Patch - [Product Block Editor]: dismiss AdviceCard by clicking close button [#43124]
-   Patch - [Product Block Editor]: fallback with random products when there isn't related products in the Linked Products tab [#43584]
-   Patch - [Product Block Editor]: improve getting suggested products from linked product section [#44047]
-   Patch - [Product Block Editor]: redefine the app dashboard size [#44166]
-   Patch - [Product Block Editor]: tweak section actions of some blocks #43555 [#43555]
-   Patch - [Product Block Editor]: update advice card instances [#43405]
-   Minor - Add slotFill for variation menus #43441 [#43441]
-   Minor - Modify feedback modal actions #43005 [#43005]
-   Patch - [Product Block Editor]: add className prop to ButtonWithDropdownMenu component [#43136]
-   Patch - [Product Block Editor]: improve and tweak AdviceCard component [#43427]
-   Patch - [Product Block Editor]: show three products by default in the Linked Products tab [#43698]
-   Patch - [Product Block Editor]: tweak styles and layout of AdviceCard component [#43272]
