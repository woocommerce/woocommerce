...
-   Major [ **BREAKING CHANGE** ] - Update @wordpress/* dependencies to wp-6.8 minimum. [#64114]
-   Minor - Update storybook file format in support with Storybook 7 story indexer. [#51168]
-   Minor - Use @woocommerce/sanitize package to sanitize inputUse @woocommerce/sanitize package to sanitize input [#60324]
