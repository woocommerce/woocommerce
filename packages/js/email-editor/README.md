...
| `woocommerce_email_editor_create_coupon_handler`                   | `function` defaultHandler                             | `function` handler                         | Handler for creating new coupons. Allows integrators to customize navigation (e.g., SPA routing instead of window.open)        |
