...
| `woocommerce_email_editor_extension_component`                     | `function` () => null                                 | `function` Component                       | Allows extensions to inject custom React components into the email editor layout                                               |
