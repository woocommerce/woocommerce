...
const getCoreTestsRoot = () => {
	...
	// uses a local file path (packages/js/@woocommerce/e2e-core-tests).
	...
	} else if ( moduleDir.indexOf( 'packages/js/@woocommerce/e2e-core-tests' ) > -1 ) {
		coreTestsPath = moduleDir.split( 'packages/js/@woocommerce/e2e-core-tests' )[ 0 ];
	}
