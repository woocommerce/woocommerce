 ...
 */
export async function isBlockProductEditorEnabled( page ) {
 ...
 * @param {import('@playwright/test').Page} page
 */
export async function toggleBlockProductEditor( action = 'enable', page ) {
	await page.goto( SETTINGS_URL );
 ...
 * @param {import('@playwright/test').Page} page
 */
export async function clickAddNewMenuItem( page ) {
	await page
 ...
 * @param {import('@playwright/test').Page} page
 */
export async function expectOldProductEditor( page ) {
	await expect(
 ...
 * @param {import('@playwright/test').Page} page
 */
export async function expectBlockProductEditor( page ) {
	await expect(
 ...
 * @param {import('@playwright/test').Page} page
 */
export async function clickOnTab( tabName, page ) {
	await page
