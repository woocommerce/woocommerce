...
`type` | One of: 'categories', 'countries', 'coupons', 'customerNames', 'customers', 'downloadIps', 'emails', 'orders', 'products', 'taxes', 'usernames', 'variations', 'custom' | `null` | (required) The object type to be used in searching
