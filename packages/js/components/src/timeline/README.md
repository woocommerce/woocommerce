...
`timezone` | String | `'browser'` | Timezone mode used to render dates and times. Use `'browser'` to render in the user's browser timezone, or `'site'` to render in the WordPress site timezone
