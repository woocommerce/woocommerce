...
-   Patch - Altering styles to correctly target fields within slot fills on product editor. [#39188]
-   Minor - Fix AdvancedFilters backward compatibility [#39188]
-   Patch - Fix collapsible content heading alignment [#39188]
-   Patch - Fix issue were Options tab was not showing up anymore in new product management screen. [#39188]
-   Minor - Fix issue where single item can not be cleared and text can not be selected upon click. [#39188]
-   Minor - Fix issue where width of select control dropdown was not correctly calculated when rendering was delayed. [#39188]
-   Patch - Fix SelectControl and TreeControl styles. [#39188]
-   Minor - Fix SortableItem duplicated id [#39188]
-   Patch - Include CSS for experimental tree control so it renders properly in Storybook. [#39188]
-   Minor - Prevent duplicate registration of core blocks in client [#39188]
-   Minor - Refactor createOrderedChildren [#39188]
-   Patch - Replace isElevated prop with elevation for tour-kit step component [#39188]
-   Minor - Wrap selected items in experimental select control [#39188]
-   Minor - Add 6 basic fields to the product fields registry for use in extensibility within the new Product MVP. [#39188]
-   Patch - Add ability to focus the first step after opening for tourkit [#39188]
-   Minor - Add allowDragging option to ImageGallery to support disabling drag and drop of images. [#39188]
-   Patch - Add an optional "InputProps" to experimental SelectControl component [#39188]
-   Minor - Add callback for the media uploader component when gallery is opened [#39188]
-   Minor - Added LearnMore option as well as made it possible to use this button multiple instances on the page [#39188]
-   Minor - Adding experimental component SlotContext [#39188]
-   Minor - Adding ProductSectionLayout component and changing default order for WooProductSectionItem component. [#39188]
-   Minor - Adding simple DisplayState wrapper and modifying Collapsible component to allow rendering hidden content. [#39188]
-   Minor - Adding the WooProductSectionItem slotfill component. [#39188]
-   Minor - Adding WooProductFieldItem slotfill. [#39188]
-   Minor - Add minFilterQueryLength, individuallySelectParent, and clearOnSelect props. [#39188]
-   Minor - Add new WooProductTabItem component for slot filling tab items. [#39188]
-   Patch - Add onKeyDown and readOnlyWhenClosed options to experimentalSelectControl [#39188]
-   Minor - Add product field store and helper functions for rendering fields from config. [#39188]
-   Minor - Add single selection mode to SelectTree [#39188]
-   Minor - Create SelectTree component that uses TreeControl [#39188]
-   Minor - Expose registerBlocks as registerRichTextEditorBlocks from the rich text editor package [#39188]
-   Minor - Fix dependency versions [#39188]
-   Minor - Make DateTimePickerControl a ForwardedRef component" [#39188]
-   Minor - TreeControl: Fix a bug where items with children were not selected in single mode and fix a bug where navigation between items with tab was not working properly. [#39188]
-   Minor - Add deprecated message to packages moved to product-editor package. [#39188]
-   Minor - Add deprecated message to product slot fill components [#39188]
-   Minor - Apply wccom experimental select control changes [#39188]
-   Minor - Export TreeSelectControl component and add additional props: onInputChange, alwaysShowPlaceholder, includeParent. [#39188]
-   Minor - Move experimental product section components to @woocommerce/product-editor package. [#39188]
-   Patch - Opt out of Reset and Help buttons in DateTimePickerControl, as these will be removed in a future @wordpress/components version. [#39188]
-   Minor - Show comma separated list in ready only mode of select tree control [#39188]
-   Major [ **BREAKING CHANGE** ] - Updated AdvancedFilter to use createInterpolateElement instead of interpolateComponents. [#39188]
-   Minor - Update select tree control dropdown menu for custom slot fill support for display within Modals [#39188]
-   Minor - Updating the product editor fill components to support multiple targets. [#39188]
-   Minor - Updating WooProductFieldItem to uniquely generate IDs with different sections. [#39188]
-   Minor - Add a11y support for the Tree component [#39188]
-   Minor - Add custom rendering logic to the item label [#39188]
-   Minor - Add highlighter to the tree control [#39188]
-   Patch - Add instructions on how to run the tests when using @woocommerce/components [#39188]
-   Minor - Add selection logic to tree control component [#39188]
-   Minor - Add TreeControl expand/collapse functionality. [#39188]
-   Minor - Adjust eslintrc for changes to eslint plugin. [#39188]
-   Minor - Create tree-control component [#39188]
-   Patch - Lint fixes [#39188]
-   Patch - Migrate ellipsis-menu component to TS [#39188]
-   Patch - Migrate Link component to TS [#39188]
-   Patch - Migrate ProductImage component to TS [#39188]
-   Patch - Migrate Rating component to TS [#39188]
-   Patch - Migrate Section component to TS [#39188]
-   Patch - Migrate select control component to TS [#39188]
-   Patch - Migrate Table component to TS [#39188]
-   Patch - Migrate Tag component to TS [#39188]
-   Minor - Sync @wordpress package versions via syncpack. [#39188]
-   Patch - Update eslint to 8.32.0 across the monorepo. [#39188]
-   Minor - Update pnpm monorepo-wide to 8.6.5 [#39188]
-   Minor - Update pnpm to version 8. [#39188]
-   Patch - Update TourKit README to correct primaryButton example and formatting. [#39188]
-   Patch - Update webpack config to use @woocommerce/internal-style-build's parser config [#39188]
-   Patch - Correct spelling errors [#39188]
-   Minor - Improve a11y support to collapsible content component [#39188]
-   Minor - Small tweak to update reference to currencyContext component. [#39188]
-   Patch - Update positioning of DateTimePickerControl's dropdown. [#39188]
-   Minor - Use BaseControl in the SelectTree label [#39188]
