...
/**
 * A number input with explicit +/- spin buttons, per the 10.9 settings UI.
 *
 * @deprecated Retained only for NativeSettingsField compatibility.
 */
	...
	return (
		...
		>
			<div className="wc-settings-ui__number-control">
				{ /* Schema-provided attributes are spread first so they cannot
				     override the controlled props below. */ }
				<input
					{ ...inputAttributes }
