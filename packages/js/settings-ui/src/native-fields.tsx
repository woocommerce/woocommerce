...
/**
 * Render a field with the native renderer shipped in WooCommerce 10.9.
 *
 * @deprecated Migrate registered components to SettingsEditControlProps. This
 * renderer will be removed when Settings UI leaves its experimental flag.
 */
export const NativeSettingsField = ( {
	...
	warn(
		'NativeSettingsField is deprecated. Migrate to the modern Settings UI control contract. This renderer will be removed when Settings UI leaves its experimental feature flag.',
		undefined,
