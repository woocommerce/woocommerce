...
use Generator;
use Automattic\WooCommerce\Internal\Vendor\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use Automattic\WooCommerce\Internal\Vendor\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\Automattic\WooCommerce\Internal\Vendor\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
