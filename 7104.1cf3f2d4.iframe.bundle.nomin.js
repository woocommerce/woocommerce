"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[7104],{

/***/ "../../node_modules/.pnpm/@storybook+addon-docs@10.5._45e94a3c44ee92dcd221500f61a59dd9/node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-6AOWCN3U.js":
...
/* harmony export */ });
/* harmony import */ var _chunk_QQBDHPVZ_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("../../node_modules/.pnpm/@storybook+addon-docs@10.5._45e94a3c44ee92dcd221500f61a59dd9/node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-QQBDHPVZ.js");
/* harmony import */ var _chunk_UAWMPV5J_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../../node_modules/.pnpm/@storybook+addon-docs@10.5._45e94a3c44ee92dcd221500f61a59dd9/node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-UAWMPV5J.js");
...
/* harmony import */ var storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("../../node_modules/.pnpm/storybook@10.5.10_@types+re_e57dec9e0ceed48a12a3cddc58799718/node_modules/storybook/dist/components/index.js");
/* harmony import */ var _storybook_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("../../node_modules/.pnpm/@storybook+icons@2.1.0_react@18.3.1/node_modules/@storybook/icons/dist/index.js");
/* harmony import */ var storybook_theming__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("../../node_modules/.pnpm/storybook@10.5.10_@types+re_e57dec9e0ceed48a12a3cddc58799718/node_modules/storybook/dist/theming/index.js");



// ../../../node_modules/color-name/index.js
var require_color_name = (0,_chunk_UAWMPV5J_js__WEBPACK_IMPORTED_MODULE_0__/* .__commonJS */ .P$)({
...
var require_conversions = (0,_chunk_UAWMPV5J_js__WEBPACK_IMPORTED_MODULE_0__/* .__commonJS */ .P$)({
...
var require_route = (0,_chunk_UAWMPV5J_js__WEBPACK_IMPORTED_MODULE_0__/* .__commonJS */ .P$)({
...
var require_color_convert = (0,_chunk_UAWMPV5J_js__WEBPACK_IMPORTED_MODULE_0__/* .__commonJS */ .P$)({
...
var import_color_convert = (0,_chunk_UAWMPV5J_js__WEBPACK_IMPORTED_MODULE_0__/* .__toESM */ .f1)(require_color_convert(), 1);
...
function i(e2) {
  var t2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(e2), n2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(function(e3) {
...
var s = function(e2, r2, t2) {
  ...
  var a2 = o2.onMove, l2 = o2.onKey, s2 = c(o2, ["onMove", "onKey"]), m2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null), g2 = i(a2), p2 = i(l2), b2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null), _2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(!1), x2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function() {
    var e2 = function(e3) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function() {
    return H2;
  }, [H2]), react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", u({}, s2, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m2, onKeyDown: E2, tabIndex: 0, role: "slider" }));
}), g = function(e2) {
  return e2.filter(Boolean).join(" ");
}, p = function(r2) {
  var t2 = r2.color, n2 = r2.left, o2 = r2.top, a2 = o2 === void 0 ? 0.5 : o2, l2 = g(["react-colorful__pointer", r2.className]);
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: l2, style: { top: 100 * a2 + "%", left: 100 * n2 + "%" } }, react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t2 } }));
}, b = function(e2, r2, t2) {
...
var S = react__WEBPACK_IMPORTED_MODULE_1__.memo(function(r2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: o2 }, react__WEBPACK_IMPORTED_MODULE_1__.createElement(m, { onMove: function(e2) {
    n2({ h: 360 * e2.left });
  }, onKey: function(e2) {
    n2({ h: s(t2 + 360 * e2.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b(t2), "aria-valuemax": "360", "aria-valuemin": "0" }, react__WEBPACK_IMPORTED_MODULE_1__.createElement(p, { className: "react-colorful__hue-pointer", left: t2 / 360, color: q({ h: t2, s: 100, v: 100, a: 1 }) })));
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "react-colorful__saturation", style: o2 }, react__WEBPACK_IMPORTED_MODULE_1__.createElement(m, { onMove: function(e2) {
    n2({ s: 100 * e2.left, v: 100 - 100 * e2.top });
  }, onKey: function(e2) {
    n2({ s: s(t2.s + 100 * e2.left, 0, 100), v: s(t2.v - 100 * e2.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b(t2.s) + "%, Brightness " + b(t2.v) + "%" }, react__WEBPACK_IMPORTED_MODULE_1__.createElement(p, { className: "react-colorful__saturation-pointer", top: 1 - t2.v / 100, left: t2.s / 100, color: q(t2) })));
}), F = function(e2, r2) {
  if (e2 === r2) return !0;
...
function Y(e2, t2, l2) {
  var u2 = i(l2), c2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(function() {
    return e2.toHsva(t2);
  }), s2 = c2[0], f2 = c2[1], v2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)({ color: t2, hsva: s2 });
...
var R, V = typeof window < "u" ? react__WEBPACK_IMPORTED_MODULE_1__.useLayoutEffect : react__WEBPACK_IMPORTED_MODULE_1__.useEffect, $ = function() {
...
var J = /* @__PURE__ */ new Map(), Q = function(e2) {
  ...
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", u({}, s2, { ref: f2, className: m2 }), react__WEBPACK_IMPORTED_MODULE_1__.createElement(T, { hsva: d2, onChange: h2 }), react__WEBPACK_IMPORTED_MODULE_1__.createElement(S, { hue: d2.h, onChange: h2, className: "react-colorful__last-control" }));
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: l2 }, react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), react__WEBPACK_IMPORTED_MODULE_1__.createElement(m, { onMove: function(e2) {
    o2({ a: e2.left });
  }, onKey: function(e2) {
    o2({ a: s(n2.a + e2.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u2 + "%", "aria-valuenow": u2, "aria-valuemin": "0", "aria-valuemax": "100" }, react__WEBPACK_IMPORTED_MODULE_1__.createElement(p, { className: "react-colorful__alpha-pointer", left: n2.a, color: k(n2) })));
}, re = function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", u({}, s2, { ref: f2, className: m2 }), react__WEBPACK_IMPORTED_MODULE_1__.createElement(T, { hsva: d2, onChange: h2 }), react__WEBPACK_IMPORTED_MODULE_1__.createElement(S, { hue: d2.h, onChange: h2 }), react__WEBPACK_IMPORTED_MODULE_1__.createElement(ee, { hsva: d2, onChange: h2, className: "react-colorful__last-control" }));
};
...
var Wrapper = storybook_theming__WEBPACK_IMPORTED_MODULE_2__/* .styled */ .I4.div({
  position: "relative",
  maxWidth: 250
}), TooltipContent = storybook_theming__WEBPACK_IMPORTED_MODULE_2__/* .styled */ .I4.div({
  width: 200,
  margin: 5,
...
}), Swatches = storybook_theming__WEBPACK_IMPORTED_MODULE_2__/* .styled */ .I4.div({
  display: "grid",
  ...
  marginTop: 5,
  width: 200
}), swatchBackground = (isDark) => `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity="0.05" fill="${isDark ? "white" : "black"}"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`, SwatchColor = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_2__/* .styled */ .I4)(storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__/* .Button */ .$n)(
...
), Input = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_2__/* .styled */ .I4)(storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__/* .Form */ .lV.Input)(({ theme }) => ({
  width: "100%",
  paddingLeft: 30,
  paddingRight: 30,
...
})), PopoverTrigger = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_2__/* .styled */ .I4)(SwatchColor)(({ disabled }) => ({
  position: "absolute",
  top: 4,
  left: 4,
  zIndex: 1,
  cursor: disabled ? "not-allowed" : "pointer"
})), CycleColorSpaceButton = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_2__/* .styled */ .I4)(storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__/* .Button */ .$n)(({ theme }) => ({
  position: "absolute",
  zIndex: 1,
  top: 6,
  right: 7,
  ...
  let [value, setValue] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(initialValue || ""), [color, setColor] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(() => parseValue(value)), [colorSpace, setColorSpace] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(color?.colorSpace || "hex" /* HEX */);
  ...
  }, [presetColors, selectedColors, maxPresetColors]), addPreset = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
    (color) => {
  ...
  let debouncedOnChange = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
    initialValue,
    debouncedOnChange
  ), { presets, addPreset } = usePresets(presetColors ?? [], color, colorSpace, maxPresetColors), Picker = ColorPicker[colorSpace], readOnly = !!argType?.table?.readonly, controlId = (0,_chunk_QQBDHPVZ_js__WEBPACK_IMPORTED_MODULE_4__/* .getControlId */ .Z)(name, storyId, controlsId);
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement(Wrapper, null, react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), react__WEBPACK_IMPORTED_MODULE_1__.createElement(
    Input,
    {
      id: controlId,
      value,
    ...
    storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__/* .PopoverProvider */ .pb,
    {
      ariaLabel: "Color picker",
      defaultVisible: startOpen,
      visible: readOnly ? !1 : void 0,
      onVisibleChange: () => color && addPreset(color),
      popover: react__WEBPACK_IMPORTED_MODULE_1__.createElement(TooltipContent, null, react__WEBPACK_IMPORTED_MODULE_1__.createElement(
        Picker,
        {
      ...
      ), presets.length > 0 && react__WEBPACK_IMPORTED_MODULE_1__.createElement(Swatches, null, presets.map((preset, index) => react__WEBPACK_IMPORTED_MODULE_1__.createElement(
        SwatchColor,
        {
  ...
  ), value ? react__WEBPACK_IMPORTED_MODULE_1__.createElement(
    ...
    react__WEBPACK_IMPORTED_MODULE_1__.createElement(_storybook_icons__WEBPACK_IMPORTED_MODULE_5__/* .MarkupIcon */ .QDE, null)
  ) : null);
