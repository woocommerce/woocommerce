...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/pages/IntroOptIn.tsx
...
var IntroOptIn = function IntroOptIn(_ref) {
  ...
  return (0,react.createElement)("div", {
    ...
    skipText: (0,build_module.__)('Skip guided setup', 'woocommerce'),
    ...
    subTitle: (0,esm/* default */.A)({
      ...
      components: {
        br: (0,react.createElement)("br", null)
      }
    })
  ...
  }, (0,build_module.__)('Set up my store', 'woocommerce')), ((_window$wcAdminFeatur = window.wcAdminFeatures) === null || _window$wcAdminFeatur === void 0 ? void 0 : _window$wcAdminFeatur.blueprint) && (0,react.createElement)(build_module_button/* default */.A, {
    className: "woocommerce-profiler-setup-store__button",
    variant: "tertiary",
    onClick: function onClick() {
      return sendEvent({
  ...
  }, (0,build_module.__)('Builder setup', 'woocommerce')), (0,react.createElement)("div", {
...
try {
    ...
    // @ts-ignore
    IntroOptIn.__docgenInfo = { "description": "", "displayName": "IntroOptIn", "props": { "sendEvent": { "defaultValue": null, "description": "", "name": "sendEvent", "required": true, "type": { "name": "(event: IntroOptInEvent) => void" } }, "navigationProgress": { "defaultValue": null, "description": "", "name": "navigationProgress", "required": true, "type": { "name": "number" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../plugins/woocommerce-admin/client/core-profiler/pages/IntroOptIn.tsx#IntroOptIn"] = { docgenInfo: IntroOptIn.__docgenInfo, name: "IntroOptIn", path: "../../plugins/woocommerce-admin/client/core-profiler/pages/IntroOptIn.tsx#IntroOptIn" };
}
catch (__react_docgen_typescript_loader_error) { }
...
;// CONCATENATED MODULE: ../../plugins/woocommerce-admin/client/core-profiler/stories/IntroOptIn.story.tsx
...
var Basic = function Basic() {
  return (0,react.createElement)(IntroOptIn, {
...
Basic.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "() => <IntroOptIn sendEvent={() => {}} navigationProgress={20} />",
