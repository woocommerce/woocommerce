...
TimelineItem.__docgenInfo = {
  ...
  "props": {
      ...
      "type": {
        ...
        "value": {
          "date": {
            "name": "instanceOf",
            "value": "Date",
            "description": "Date for the timeline item.",
            "required": true
          },
          "icon": {
            "name": "element",
          ...
          "headline": {
            ...
            "description": "Headline displayed for the list item.",
            "required": true
          },
          "body": {
            "name": "arrayOf",
            ...
            "description": "Body displayed for the list item.",
            "required": false
          },
          "hideTimestamp": {
            "name": "bool",
            "description": "Allows users to toggle the timestamp on or off.",
            "required": false
          }
        }
      },
    ...
    "timezone": {
      ...
      "description": "Defines whether item dates should be displayed in the browser timezone or the WordPress site timezone.",
      "type": {
        "name": "enum",
        "value": [{
          "value": "'browser'",
    ...
    "clockFormat": {
      "description": "The PHP clock format string used to format times, see php.net/date.",
      "type": {
        "name": "string"
      },
      "required": false
...
const TimelineGroup = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("li", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("p", {
      ...
      children: group.items.sort(sortByDateUsing(orderBy)).map(itemsToTimelineItem)
    }), /*#__PURE__*/(0,jsx_runtime.jsx)("hr", {})]
  });
};
/* harmony default export */ const timeline_group = (TimelineGroup);
;
TimelineGroup.__docgenInfo = {
  "description": "",
  "methods": [],
  "displayName": "TimelineGroup",
  "props": {
    "group": {
      "defaultValue": {
        "value": "{ title: '', items: [] }",
    ...
    "orderBy": {
      ...
      "description": "Defines how items should be ordered.",
      "type": {
        "name": "enum",
        "value": [{
          "value": "'asc'",
...
Timeline.__docgenInfo = {
  ...
  "props": {
    ...
    "groupBy": {
      ...
      "description": "Defines how items should be grouped together.",
      "type": {
        "name": "enum",
        "value": [{
          "value": "'day'",
    ...
    "orderBy": {
      ...
      "description": "Defines how groups should be ordered.",
      "type": {
        "name": "enum",
        "value": [{
          "value": "'asc'",
    ...
    "dateFormat": {
      "defaultValue": {
        "value": "__( 'F j, Y', 'woocommerce' )",
        "computed": true
      },
      "description": "The PHP date format string used to format dates, see php.net/date.",
      "type": {
        "name": "string"
      },
      "required": false
    ...
    "timezone": {
      ...
      "description": "Defines whether dates are grouped and displayed using the browser timezone or the WordPress site timezone.",
      "type": {
        "name": "enum",
        "value": [{
          "value": "'browser'",
