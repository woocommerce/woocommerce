...
function woocommerce_admin_install_notice() {
	...
	<div id="message" class="updated woocommerce-message wc-connect">
		<div class="squeezer">
			<h4><?php _e( '<strong>Welcome to WooCommerce</strong> &ndash; You\'re almost ready to start selling :)', 'woocommerce' ); ?></h4>
...
function woocommerce_admin_installed_notice() {
	...
	<div id="message" class="updated woocommerce-message wc-connect">
		<div class="squeezer">
			<h4><?php _e( '<strong>WooCommerce has been installed</strong> &ndash; You\'re ready to start selling :)', 'woocommerce' ); ?></h4>
