...
function woocommerce_prevent_admin_access() {
	if ( get_option('woocommerce_lock_down_admin') == 'yes' && ! is_ajax() && ( ! current_user_can('manage_woocommerce') || ! current_user_can(' manage_woocommerce_orders') || ! current_user_can(' manage_woocommerce_orders') || ! current_user_can(' manage_woocommerce_tab_manager') || ! current_user_can(' manage_woocommerce_coupons ') || ! current_user_can('manage_woocommerce_products') || ! current_user_can('view_woocommerce_reports') ) ) {
