...
;
date_Date.__docgenInfo = {
  "description": "Use the `Date` component to display accessible dates or times.\n\n@param {Object} props\n@param {Object} props.date\n@param {string} props.machineFormat\n@param {string} props.screenReaderFormat\n@param {string} props.visibleFormat\n@return {Object} -",
  "methods": [],
  "displayName": "Date",
  "props": {
    "machineFormat": {
      ...
      "description": "Date format used in the `datetime` prop of the `time` element.",
      "type": {
        "name": "string"
      },
      "required": false
    ...
    "screenReaderFormat": {
      ...
      "description": "Date format used for screen readers.",
      "type": {
        "name": "string"
      },
      "required": false
    ...
    "visibleFormat": {
      ...
      "description": "Date format displayed in the page.",
      "type": {
        "name": "string"
      },
      "required": false
    ...
    "date": {
      "description": "Date to use in the component.",
      "type": {
        "name": "union",
        "value": [{
          "name": "string"
