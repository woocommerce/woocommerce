...
The release lead is assigned by rotation (see [Release Schedule](/docs/contribution/releases/schedule)). The Product DRI is confirmed per cycle on the tracking issue.
