...
We strongly recommend you review the current [WooCommerce setup experience](woocommerce.com/documentation/plugins/woocommerce/getting-started/) to get familiar with the user experience and taxonomy.

We also recommend you review the [WordPress core guidelines](https://developer.wordpress.org/plugins/wordpress-org/detailed-plugin-guidelines/) to ensure your product isn't breaking any rules, and review [this helpful resource](woocommerce.com/document/grammar-punctuation-style-guide/) on content style.
