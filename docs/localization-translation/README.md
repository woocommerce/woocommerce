...
2. Choose `woocommerce.pot` and PoEdit will show the catalog properties window.<br>
...
4. Save your `.po` file. Name it based on what you are translating to, i.e., a GB translation is saved as `woocommerce-en_GB.po`. Now the strings are listed.<br>
