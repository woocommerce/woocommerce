...
- If your pricing model is based on a standard, tiered monthly subscription, we require you to implement the [SaaS Billing API](/docs/woo-marketplace/billing-api-saas/). API keys and sandbox access are granted manually after products are submitted for Marketplace consideration.
...
- Themes must adhere to [theme development](/docs/theming/block-theme-development/theming-woo-blocks/), [design](/docs/user-experience-guidelines/ux-guidelines-themes/), and [UX guidelines](/docs/user-experience-guidelines/ux-guidelines-themes/).
...
:::info
**All new extension submissions must be HPOS-compatible.** View our [HPOS recipe book](/docs/hpos-extension-recipe-book/) for ways to support HPOS in your product.
:::
