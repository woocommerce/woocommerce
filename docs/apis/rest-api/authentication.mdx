...
![WooCommerce REST API keys settings](resources-endpoints/images/woocommerce-api-keys-settings.png)
...
![Creating a new REST API key](resources-endpoints/images/woocommerce-creating-api-keys.png)
...
![Generated REST API key](resources-endpoints/images/woocommerce-api-key-generated.png)
...
![Authentication Endpoint flow](resources-endpoints/images/woocommerce-auth-endpoint-flow.png)
...
![Authentication Endpoint example](resources-endpoints/images/woocommerce-auth-endpoint-example.png)
