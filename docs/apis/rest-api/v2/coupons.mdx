...
| `auto_apply`                  | boolean   | If true, this coupon is applied to the cart automatically when its conditions are met, and cannot be removed manually. Default is `false`. |
