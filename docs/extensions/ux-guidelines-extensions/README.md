...
## Extension guideline topics

-   [Navigation](/docs/extensions/ux-guidelines-extensions/navigation/)
-   [Onboarding](/docs/extensions/ux-guidelines-extensions/onboarding/)
-   [Task List and Inbox](/docs/extensions/ux-guidelines-extensions/task-list-and-inbox/)
-   [Notices](/docs/extensions/ux-guidelines-extensions/notices/)
-   [Settings](/docs/extensions/ux-guidelines-extensions/settings/)
-   [Colors](/docs/extensions/ux-guidelines-extensions/colors/)
-   [Accessibility](/docs/extensions/ux-guidelines-extensions/accessibility/)
-   [Testing](/docs/extensions/ux-guidelines-extensions/testing/)
