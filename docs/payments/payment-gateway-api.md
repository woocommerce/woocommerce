...
It is also important that your gateway class extends the WooCommerce base gateway class, so you have access to important methods and the [settings API](woocommerce.com/document/settings-api/ "woocommerce.com/document/settings-api/"):
...
Use this method to set `$this->form_fields` - these are options you'll show in admin on your gateway settings page and make use of the [WC Settings API](woocommerce.com/document/settings-api/ "woocommerce.com/document/settings-api/").
...
For more information, see [WC_API - The WooCommerce API Callback](woocommerce.com/document/wc_api-the-woocommerce-api-callback/).
