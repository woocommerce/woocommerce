...
To link to non-markdown files in WooCommerce's monorepo, you should use the full link (for example, `https://github.com/woocommerce/woocommerce/blob/trunk/plugins/woocommerce-blocks/packages/prices/utils/price.ts`).
