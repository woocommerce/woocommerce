...
For specific details on commands and their usage, refer to the [command reference](/docs/wc-cli/commands/). The [how-to guide](/docs/wc-cli/using-wc-cli/) provides a practical approach to common tasks, ideal for those new to WC-CLI or looking for quick solutions.
