...
$states['PH'] = array(
	...
	'MOA' => __( 'Moalboal', 'woocommerce' ),
	'DAN' => __( 'Danao City', 'woocommerce' ),
	'BOG' => __( 'Bogo', 'woocommerce' ),
	'LAP' => __( 'Lapu Lapu', 'woocommerce' ),
	'MAN' => __( 'Mandaue', 'woocommerce' ),
	'TOL' => __( 'Toledo', 'woocommerce' ),
	'CAR' => __( 'Car Car', 'woocommerce' ),
	'ALE' => __( 'Alegria', 'woocommerce' ),
