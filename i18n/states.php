...
return array(
	...
	'BJ' => array( // Benin states.
		'bjal' => __( 'Alibori', 'woocommerce' ),
		'bjat' => __( 'Atacora', 'woocommerce' ),
		'bjatl' => __( 'Atlantique', 'woocommerce' ),
		'bjbor' => __( 'Borgou', 'woocommerce' ),
		'bjcol' => __( 'Collines', 'woocommerce' ),
		'bjcouf' => __( 'Couffo', 'woocommerce' ),
		'bjdong' => __( 'Donga', 'woocommerce' ),
		'bjlit' => __( 'Littoral', 'woocommerce' ),
		'bjmo' => __( 'Mono', 'woocommerce' ),
		'bjoue' => __( 'Oueme', 'woocommerce' ),
		'bjpla' => __( 'Plateau', 'woocommerce' ),
		'bjzo' => __( 'Zou', 'woocommerce' ),
	),
