...
return array(
	...
	'PT' => array( // Portugal states.
		...
		'pt02'  => __( 'Beja', 'woocommerce' ),
		'pt03'  => __( 'Braga', 'woocommerce' ),
		'pt04'  => __( 'Bragança', 'woocommerce' ),
		'pt05'  => __( 'Castelo Branco', 'woocommerce' ),
		'pt06'  => __( 'Coimbra', 'woocommerce' ),
		'pt07'  => __( 'Évora', 'woocommerce' ),
		'pt08'  => __( 'Faro', 'woocommerce' ),
		'pt09'  => __( 'Guarda', 'woocommerce' ),
		'pt10'  => __( 'Leiria', 'woocommerce' ),
		'pt11'  => __( 'Lisbon', 'woocommerce' ),
		'pt12'  => __( 'Portalegre', 'woocommerce' ),
		'pt13'  => __( 'Porto', 'woocommerce' ),
		'pt14'  => __( 'Santarém', 'woocommerce' ),
		'pt15'  => __( 'Setúbal', 'woocommerce' ),
		'pt16'  => __( 'Viana do Castelo', 'woocommerce' ),
		'pt17'  => __( 'Vila Real', 'woocommerce' ),
		'pt18'  => __( 'Viseu', 'woocommerce' ),
		'pt20'  => __( 'Azores', 'woocommerce' ),
		'pt30'  => __( 'Madeira', 'woocommerce' ),
	),
