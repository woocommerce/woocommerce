...
return array(
	...
	'RS' => array(),
	'RU' => array( // Russia
		'RU-AD' => __( "Adygeya, Respublika", 'woocommerce' ),
		'RU-AL' => __( "Altay, Respublika", 'woocommerce' ),
		'RU-BA' => __( "Bashkortostan, Respublika", 'woocommerce' ),
		'RU-BU' => __( "Buryatiya, Respublika", 'woocommerce' ),
		'RU-CE' => __( "Chechenskaya Respublika", 'woocommerce' ),
		'RU-CU' => __( "Chuvashskaya Respublika", 'woocommerce' ),
		'RU-DA' => __( "Dagestan, Respublika", 'woocommerce' ),
		'RU-IN' => __( "Ingushetiya, Respublika", 'woocommerce' ),
		'RU-KB' => __( "Kabardino-Balkarskaya Respublika", 'woocommerce' ),
		'RU-KL' => __( "Kalmykiya, Respublika", 'woocommerce' ),
		'RU-KC' => __( "Karachayevo-Cherkesskaya Respublika", 'woocommerce' ),
		'RU-KR' => __( "Kareliya, Respublika", 'woocommerce' ),
		'RU-KK' => __( "Khakasiya, Respublika", 'woocommerce' ),
		'RU-KO' => __( "Komi, Respublika", 'woocommerce' ),
		'RU-ME' => __( "Mariy El, Respublika", 'woocommerce' ),
		'RU-MO' => __( "Mordoviya, Respublika", 'woocommerce' ),
		'RU-SA' => __( "Saha, Respublika", 'woocommerce' ),
		'RU-SE' => __( "Severnaya Osetiya, Respublika", 'woocommerce' ),
		'RU-TA' => __( "Tatarstan, Respublika", 'woocommerce' ),
		'RU-TY' => __( "Tyva, Respublika", 'woocommerce' ),
		'RU-UD' => __( "Udmurtskaya Respublika", 'woocommerce' ),
		'RU-ALT' => __( "Altayskiy kray", 'woocommerce' ),
		'RU-KAM' => __( "Kamchatskiy kray", 'woocommerce' ),
		'RU-KHA' => __( "Khabarovskiy kray", 'woocommerce' ),
		'RU-KDA' => __( "Krasnodarskiy kray", 'woocommerce' ),
		'RU-KYA' => __( "Krasnoyarskiy kray", 'woocommerce' ),
		'RU-PER' => __( "Permskiy kray", 'woocommerce' ),
		'RU-PRI' => __( "Primorskiy kray", 'woocommerce' ),
		'RU-STA' => __( "Stavropol'skiy kray", 'woocommerce' ),
		'RU-ZAB' => __( "Zabaykal'skiy kray", 'woocommerce' ),
		'RU-AMU' => __( "Amurskaya oblast'", 'woocommerce' ),
		'RU-ARK' => __( "Arkhangel'skaya oblast'", 'woocommerce' ),
		'RU-AST' => __( "Astrakhanskaya oblast'", 'woocommerce' ),
		'RU-BEL' => __( "Belgorodskaya oblast'", 'woocommerce' ),
		'RU-BRY' => __( "Bryanskaya oblast'", 'woocommerce' ),
		'RU-CHE' => __( "Chelyabinskaya oblast'", 'woocommerce' ),
		'RU-IRK' => __( "Irkutskaya oblast'", 'woocommerce' ),
		'RU-IVA' => __( "Ivanovskaya oblast'", 'woocommerce' ),
		'RU-KGD' => __( "Kaliningradskaya oblast'", 'woocommerce' ),
		'RU-KLU' => __( "Kaluzhskaya oblast'", 'woocommerce' ),
		'RU-KEM' => __( "Kemerovskaya oblast'", 'woocommerce' ),
		'RU-KIR' => __( "Kirovskaya oblast'", 'woocommerce' ),
		'RU-KOS' => __( "Kostromskaya oblast'", 'woocommerce' ),
		'RU-KGN' => __( "Kurganskaya oblast'", 'woocommerce' ),
		'RU-KRS' => __( "Kurskaya oblast'", 'woocommerce' ),
		'RU-LEN' => __( "Leningradskaya oblast'", 'woocommerce' ),
		'RU-LIP' => __( "Lipetskaya oblast'", 'woocommerce' ),
		'RU-MAG' => __( "Magadanskaya oblast'", 'woocommerce' ),
		'RU-MOS' => __( "Moskovskaya oblast'", 'woocommerce' ),
		'RU-MUR' => __( "Murmanskaya oblast'", 'woocommerce' ),
		'RU-NIZ' => __( "Nizhegorodskaya oblast'", 'woocommerce' ),
		'RU-NGR' => __( "Novgorodskaya oblast'", 'woocommerce' ),
		'RU-NVS' => __( "Novosibirskaya oblast'", 'woocommerce' ),
		'RU-OMS' => __( "Omskaya oblast'", 'woocommerce' ),
		'RU-ORE' => __( "Orenburgskaya oblast'", 'woocommerce' ),
		'RU-ORL' => __( "Orlovskaya oblast'", 'woocommerce' ),
		'RU-PNZ' => __( "Penzenskaya oblast'", 'woocommerce' ),
		'RU-PSK' => __( "Pskovskaya oblast'", 'woocommerce' ),
		'RU-ROS' => __( "Rostovskaya oblast'", 'woocommerce' ),
		'RU-RYA' => __( "Ryazanskaya oblast'", 'woocommerce' ),
		'RU-SAK' => __( "Sakhalinskaya oblast'", 'woocommerce' ),
		'RU-SAM' => __( "Samarskaya oblast'", 'woocommerce' ),
		'RU-SAR' => __( "Saratovskaya oblast'", 'woocommerce' ),
		'RU-SMO' => __( "Smolenskaya oblast'", 'woocommerce' ),
		'RU-SVE' => __( "Sverdlovskaya oblast'", 'woocommerce' ),
		'RU-TAM' => __( "Tambovskaya oblast'", 'woocommerce' ),
		'RU-TOM' => __( "Tomskaya oblast'", 'woocommerce' ),
		'RU-TUL' => __( "Tul'skaya oblast'", 'woocommerce' ),
		'RU-TVE' => __( "Tverskaya oblast'", 'woocommerce' ),
		'RU-TYU' => __( "Tyumenskaya oblast'", 'woocommerce' ),
		'RU-ULY' => __( "Ul'yanovskaya oblast'", 'woocommerce' ),
		'RU-VLA' => __( "Vladimirskaya oblast'", 'woocommerce' ),
		'RU-VGG' => __( "Volgogradskaya oblast'", 'woocommerce' ),
		'RU-VLG' => __( "Vologodskaya oblast'", 'woocommerce' ),
		'RU-VOR' => __( "Voronezhskaya oblast'", 'woocommerce' ),
		'RU-YAR' => __( "Yaroslavskaya oblast'", 'woocommerce' ),
		'RU-MOW' => __( "Moskva	Moskva", 'woocommerce' ),
		'RU-SPE' => __( "Sankt-Peterburg", 'woocommerce' ),
		'RU-YEV' => __( "Yevreyskaya avtonomnaya oblast'", 'woocommerce' ),
		'RU-CHU' => __( "Chukotskiy avtonomnyy okrug", 'woocommerce' ),
		'RU-KHM' => __( "Khanty-Mansiyskiy avtonomnyy okrug", 'woocommerce' ),
		'RU-NEN' => __( "Nenetskiy avtonomnyy okrug", 'woocommerce' ),
		'RU-YAN' => __( "Yamalo-Nenetskiy avtonomnyy okrug", 'woocommerce' ),
	),
	'SG' => array(),
	'SK' => array(),
	'SI' => array(),
