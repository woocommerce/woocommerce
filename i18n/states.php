...
return array(
	...
	'KW' => array(),
	'LA' => array(
		'laat' => __( 'Attapeu', 'woocommerce' ),
		'labk' => __( 'Bokeo', 'woocommerce' ),
		'labl' => __( 'Bolikhamsai', 'woocommerce' ),
		'lach' => __( 'Champasak', 'woocommerce' ),
		'laho' => __( 'Houaphanh', 'woocommerce' ),
		'lakh' => __( 'Khammouane', 'woocommerce' ),
		'lalm' => __( 'Luang Namtha', 'woocommerce' ),
		'lalp' => __( 'Luang Prabang', 'woocommerce' ),
		'laou' => __( 'Oudomxay', 'woocommerce' ),
		'laph' => __( 'Phongsaly', 'woocommerce' ),
		'lasl' => __( 'Salavan', 'woocommerce' ),
		'lasv' => __( 'Savannakhet', 'woocommerce' ),
		'lavi' => __( 'Vientiane Province', 'woocommerce' ),
		'lavt' => __( 'Vientiane', 'woocommerce' ),
		'laxa' => __( 'Sainyabuli', 'woocommerce' ),
		'laxe' => __( 'Sekong', 'woocommerce' ),
		'laxi' => __( 'Xiangkhouang', 'woocommerce' ),
		'laxs' => __( 'Xaisomboun', 'woocommerce' ),
	),
	'LB' => array(),
