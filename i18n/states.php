...
return array(
	...
	'UA' => array( // Ukraine districts. Ref: https://en.wikipedia.org/wiki/ISO_3166-2:UA, https://www.iso.org/obp/ui/#iso:code:3166:UA.
		...
		'UA-77' => __( 'Chernivetska oblast', 'woocommerce' ),
		'UA-12' => __( 'Dnipropetrovska oblast', 'woocommerce' ),
		'UA-14' => __( 'Donetska oblast', 'woocommerce' ),
		'UA-26' => __( 'Ivano-Frankivska oblast', 'woocommerce' ),
		'UA-63' => __( 'Kharkivska oblast', 'woocommerce' ),
		'UA-65' => __( 'Khersonska oblast', 'woocommerce' ),
		'UA-68' => __( 'Khmelnytska oblast', 'woocommerce' ),
		'UA-35' => __( 'Kirovohradska oblast', 'woocommerce' ),
		'UA-30' => __( 'Kyiv', 'woocommerce' ),
		'UA-32' => __( 'Kyivska oblast', 'woocommerce' ),
		'UA-09' => __( 'Luhanska oblast', 'woocommerce' ),
		'UA-46' => __( 'Lvivska oblast', 'woocommerce' ),
		'UA-48' => __( 'Mykolaivska oblast', 'woocommerce' ),
		'UA-51' => __( 'Odeska oblast', 'woocommerce' ),
		'UA-53' => __( 'Poltavska oblast', 'woocommerce' ),
		'UA-56' => __( 'Rivnenska oblast', 'woocommerce' ),
		'UA-40' => __( 'Sevastopol', 'woocommerce' ),
		'UA-59' => __( 'Sumska oblast', 'woocommerce' ),
		'UA-61' => __( 'Ternopilska oblast', 'woocommerce' ),
		'UA-05' => __( 'Vinnytska oblast', 'woocommerce' ),
		'UA-07' => __( 'Volynska oblast', 'woocommerce' ),
		'UA-21' => __( 'Zakarpatska oblast', 'woocommerce' ),
		'UA-23' => __( 'Zaporizka oblast', 'woocommerce' ),
		'UA-18' => __( 'Zhytomyrska oblast', 'woocommerce' ),
	),
