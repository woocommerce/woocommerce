...
return array(
	...
	'BW' => array( // Botswana districts.
		'GC' => __( 'Gaborone City', 'woocommerce' ),
		'FC' => __( 'Francistown City', 'woocommerce' ),
		'LT' => __( 'Lobatse Town', 'woocommerce' ),
		'ST' => __( 'Selebi-Phikwe Town', 'woocommerce' ),
		'JT' => __( 'Jwaneng Town', 'woocommerce' ),
		'OT' => __( 'Orapa Town', 'woocommerce' ),
		'SW' => __( 'Sowa Township	', 'woocommerce' ),
		'SD' => __( 'Southern District', 'woocommerce' ),
		'SE' => __( 'South-East District', 'woocommerce' ),
		'KD' => __( 'Kweneng District', 'woocommerce' ),
		'KG' => __( 'Kgatleng District	', 'woocommerce' ),
		'CD' => __( 'Central District', 'woocommerce' ),
		'NE' => __( 'North-East District', 'woocommerce' ),
		'ND' => __( 'Ngamiland District', 'woocommerce' ),
		'CE' => __( 'Chobe District', 'woocommerce' ),
		'GZ' => __( 'Ghanzi District', 'woocommerce' ),
		'KL' => __( 'Kgalagadi District', 'woocommerce' ),
	),
