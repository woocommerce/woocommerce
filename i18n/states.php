...
return array(
	...
	'CL' => array (//Chile's Provinces. Ref: https://en.wikipedia.org/wiki/ISO_3166-2:CL
    	'CL-AP' => __('Región de Arica y Parinacota', 'woocommerce'),
        'CL-TA' => __('Región de Tarapacá', 'woocommerce'),
        'CL-AN' => __('Región de Antofagasta', 'woocommerce'),
        'CL-AT' => __('Región de Atacama', 'woocommerce'),
        'CL-CO' => __('Región de Coquimbo', 'woocommerce'),
        'CL-VS' => __('Región de Valparaíso', 'woocommerce'),
        'CL-RM' => __('Región de Metropolitana de Santiago', 'woocommerce'),
        'CL-LI' => __('Región de Libertador General Bernardo O`Higgins', 'woocommerce'),
        'CL-ML' => __('Región de Maule', 'woocommerce'),
        'CL-NB' => __('Región de Ñuble', 'woocommerce'),
        'CL-BI' => __('Región de Biobío', 'woocommerce'),
        'CL-AR' => __('Región de Araucanía', 'woocommerce'),
        'CL-LR' => __('Región de Los Ríos', 'woocommerce'),
        'CL-LL' => __('Región de Los Lagos', 'woocommerce'),
        'CL-AI' => __('Región de Aysén del General Carlos Ibáñez del Campo', 'woocommerce'),
        'CL-MA' => __('Región de Magallanes y la Antártica Chilena', 'woocommerce'),
    ),
);
