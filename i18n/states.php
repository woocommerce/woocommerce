...
return array(
	...
	'RS' => array( // Serbia districts. Ref: http://www.statoids.com/urs.html
		'RS.BG' => _x( 'Belgrade', 'district', 'woocommerce' ),
		'RS.BO' => _x( 'Bor', 'district', 'woocommerce' ),
		'RS.BR' => _x( 'Braničevo', 'district', 'woocommerce' ),
		'RS.SD' => _x( 'Central Banat', 'district', 'woocommerce' ),
		'RS.PD' => _x( 'Danube', 'district', 'woocommerce' ),
		'RS.JA' => _x( 'Jablanica', 'district', 'woocommerce' ),
		'RS.KB' => _x( 'Kolubara', 'district', 'woocommerce' ),
		'RS.MA' => _x( 'Mačva', 'district', 'woocommerce' ),
		'RS.MR' => _x( 'Morava', 'district', 'woocommerce' ),
		'RS.NS' => _x( 'Nišava', 'district', 'woocommerce' ),
		'RS.SC' => _x( 'North Bačka', 'district', 'woocommerce' ),
		'RS.SN' => _x( 'North Banat', 'district', 'woocommerce' ),
		'RS.PC' => _x( 'Pčinja', 'district', 'woocommerce' ),
		'RS.PI' => _x( 'Pirot', 'district', 'woocommerce' ),
		'RS.PM' => _x( 'Pomoravlje', 'district', 'woocommerce' ),
		'RS.RN' => _x( 'Rasina', 'district', 'woocommerce' ),
		'RS.RS' => _x( 'Raška', 'district', 'woocommerce' ),
		'RS.JC' => _x( 'South Bačka', 'district', 'woocommerce' ),
		'RS.JN' => _x( 'South Banat', 'district', 'woocommerce' ),
		'RS.SM' => _x( 'Srem', 'district', 'woocommerce' ),
		'RS.SU' => _x( 'Šumadija', 'district', 'woocommerce' ),
		'RS.TO' => _x( 'Toplica', 'district', 'woocommerce' ),
		'RS.ZC' => _x( 'West Bačka', 'district', 'woocommerce' ),
		'RS.ZJ' => _x( 'Zaječar', 'district', 'woocommerce' ),
		'RS.ZL' => _x( 'Zlatibor', 'district', 'woocommerce' ),
	),
	'SE' => array(),
