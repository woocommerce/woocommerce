...
return array(
	...
	'BJ' => array( // Benin states.
		...
		'BJ-02' => __( 'ABOMEY-CALAVI', 'woocommerce' ),
		'BJ-03' => __( 'ADJA-OUERE', 'woocommerce' ),
		'BJ-04' => __( 'ADJARRA', 'woocommerce' ),
		'BJ-05' => __( 'ADJOHOUN', 'woocommerce' ),
		'BJ-06' => __( 'AGBANGNIZOUN', 'woocommerce' ),
		'BJ-07' => __( 'AGUEGUES ', 'woocommerce' ),
		'BJ-07' => __( 'AKPRO-MISSERETE', 'woocommerce' ),
		'BJ-08' => __( 'ALLADA', 'woocommerce' ),
		'BJ-09' => __( 'APLAHOUE', 'woocommerce' ),
		'BJ-10' => __( 'ATHIEME', 'woocommerce' ),
		'BJ-11' => __( 'AVRANKOU', 'woocommerce' ),
		'BJ-12' => __( 'BANIKOARA', 'woocommerce' ),
		'BJ-13' => __( 'BANTE', 'woocommerce' ),
		'BJ-14' => __( 'BASSILA', 'woocommerce' ),
		'BJ-15' => __( 'BEMBEREKE', 'woocommerce' ),
		'BJ-16' => __( 'BOHICON', 'woocommerce' ),
		'BJ-17' => __( 'BONOU', 'woocommerce' ),
		'BJ-18' => __( 'BOPA', 'woocommerce' ),
		'BJ-19' => __( 'BOUKOUMBE', 'woocommerce' ),
		'BJ-20' => __( 'COBLY', 'woocommerce' ),
		'BJ-21' => __( 'COME', 'woocommerce' ),
		'BJ-22' => __( 'COPARGO', 'woocommerce' ),
		'BJ-23' => __( 'COTONOU', 'woocommerce' ),
		'BJ-24' => __( 'COVE', 'woocommerce' ),
		'BJ-25' => __( 'DANGBO', 'woocommerce' ),
		'BJ-26' => __( 'DASSA-ZOUME', 'woocommerce' ),
		'BJ-27' => __( 'DJAKOTOMEY', 'woocommerce' ),
		'BJ-28' => __( 'DJIDJA', 'woocommerce' ),
		'BJ-29' => __( 'DJOUGOU', 'woocommerce' ),
		'BJ-30' => __( 'DOGBO', 'woocommerce' ),
		'BJ-31' => __( 'GLAZOUE', 'woocommerce' ),
		'BJ-32' => __( 'GOGOUNOU', 'woocommerce' ),
		'BJ-33' => __( 'GRAND-POPO', 'woocommerce' ),
		'BJ-34' => __( 'HOUEYOGBE', 'woocommerce' ),
		'BJ-35' => __( 'IFANGNI', 'woocommerce' ),
		'BJ-36' => __( 'KALALE', 'woocommerce' ),
		'BJ-37' => __( 'KANDI', 'woocommerce' ),
		'BJ-38' => __( 'KARIMAMA', 'woocommerce' ),
		'BJ-39' => __( 'KEROU', 'woocommerce' ),
		'BJ-40' => __( 'KETOU', 'woocommerce' ),
		'BJ-41' => __( 'KLOUEKANMEY', 'woocommerce' ),
		'BJ-42' => __( 'KOUANDE', 'woocommerce' ),
		'BJ-43' => __( 'KPOMASSE', 'woocommerce' ),
		'BJ-44' => __( 'LALO', 'woocommerce' ),
		'BJ-45' => __( 'LOKOSSA', 'woocommerce' ),
		'BJ-46' => __( 'MALANVILLE', 'woocommerce' ),
		'BJ-47' => __( 'MATERI', 'woocommerce' ),
		'BJ-48' => __( "N'DALI", 'woocommerce' ),
		'BJ-49' => __( 'NATITINGOU', 'woocommerce' ),
		'BJ-50' => __( 'NIKKI', 'woocommerce' ),
		'BJ-51' => __( 'OUAKE', 'woocommerce' ),
		'BJ-52' => __( 'OUASSA-PEHUNCO', 'woocommerce' ),
		'BJ-53' => __( 'OUESSE', 'woocommerce' ),
		'BJ-54' => __( 'OUIDAH', 'woocommerce' ),
		'BJ-55' => __( 'OUINHI', 'woocommerce' ),
		'BJ-56' => __( 'PARAKOU', 'woocommerce' ),
		'BJ-57' => __( 'PERERE', 'woocommerce' ),
		'BJ-58' => __( 'POBE', 'woocommerce' ),
		'BJ-59' => __( 'PORTO-NOVO', 'woocommerce' ),
		'BJ-60' => __( 'SAKETE', 'woocommerce' ),
		'BJ-61' => __( 'SAVALOU', 'woocommerce' ),
		'BJ-62' => __( 'SAVE', 'woocommerce' ),
		'BJ-63' => __( 'SEGBANA', 'woocommerce' ),
		'BJ-64' => __( 'SEME-PODJI', 'woocommerce' ),
		'BJ-65' => __( 'SINENDE', 'woocommerce' ),
		'BJ-66' => __( 'SO-AVA', 'woocommerce' ),
		'BJ-67' => __( 'TANGUIETA', 'woocommerce' ),
		'BJ-68' => __( 'TCHAOUROU', 'woocommerce' ),
		'BJ-69' => __( 'TOFFO', 'woocommerce' ),
		'BJ-70' => __( 'TORI-BOSSITO', 'woocommerce' ),
		'BJ-71' => __( 'TOUKOUNTOUNA', 'woocommerce' ),
		'BJ-72' => __( 'TOVIKLIN', 'woocommerce' ),
		'BJ-73' => __( 'ZA-KPOTA', 'woocommerce' ),
		'BJ-74' => __( 'ZAGNANADO', 'woocommerce' ),
		'BJ-75' => __( 'ZE', 'woocommerce' ),
		'BJ-76' => __( 'ZOGBODOMEY', 'woocommerce' ),
	),
