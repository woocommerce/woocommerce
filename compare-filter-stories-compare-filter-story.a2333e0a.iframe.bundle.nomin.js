...
class CompareFilter extends react.Component {
  ...
  getSearchProps() {
    ...
    const legacySearchProps = (0,lodash.omitBy)({
      type,
      autocompleter,
      placeholder: labels.placeholder
    }, lodash.isUndefined);
    if (Object.keys(legacySearchProps).length > 0) {
      (0,deprecated_build_module/* default */.A)('Passing `type`, `autocompleter`, or `labels.placeholder` to CompareFilter', {
        since: '14.2.0',
        version: '15.0.0',
...
CompareFilter.__docgenInfo = {
  ...
  "props": {
    ...
    "searchProps": {
      ...
      "description": "Props forwarded to the `Search` component, except `selected` and `onChange`.",
      "type": {
        "name": "shape",
        "value": {
          "type": {
          ...
          "autocompleter": {
            "name": "object",
            "description": "The custom autocompleter to use when `type` is `'custom'`.",
            "required": false
          },
          "placeholder": {
            "name": "string",
