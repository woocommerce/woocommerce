				...
				form.xhr                      = $.ajax( {
					...
					success: function( variation ) {
						if ( variation ) {
							...
							form.$form.find( '.single_variation' ).after( '<div class="wc-no-matching-variations woocommerce-notice">' + wc_add_to_cart_variation_params.i18n_no_matching_variations_text + '</div>' );
